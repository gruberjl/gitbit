  ...
  return (
    <Grid container>
      ...
      {Object.values(question.answerOptions).map((answerOption) => (
        <Grid container item xs={12} style={(showAnswers && testAnswers[answerOption.id].isCorrect ? correctAnswerStyle : answerStyle)} key={answerOption.id}>
