          ...
          <Container className="blog-article">
            <Grid container>
              <Grid item>
                ...
                <Typography variant="body1" gutterBottom>Microsoft Teams is a communication platform much like Slack that combines one on one &amp; team chat, video meetings, and file storage. Teams also has a number of application integrations that can be used to expand your Teams experience. The service integrates with the Microsoft 365 subscription office suite and can integrate with non-Microsoft products. Microsoft Teams is a competitor to Slack and is the upgrade path from Skype.</Typography>
                ...
                <Typography variant="body1" gutterBottom>You can quickly ask a question to an entire team and get a fast response from the first available colleague, share a file with your team and keep it in a secure location where new team members can access the file, the possibilities are endless.</Typography>
                <section>
                  <div>
                    <div>
