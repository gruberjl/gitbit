              ...
              <Grid item>
                ...
                <div>
                  <div>
                    ...
                    <Typography variant="body1" gutterBottom>I know, cerifitications aren’t really a feature, but they’re important! Teams is Tier C-compliant at launch. This includes the following standards: ISO 27001, ISO 27018, SSAE16 SOC 1 and SOC 2, HIPAA, and EU Model Clauses (EUMC). Within the Microsoft compliance framework, Microsoft classifies Office 365 applications and services into four categories. Each category is defined by specific compliance commitments that must be met for an Office 365 service, or a related Microsoft service, to be listed in that category. Services in compliance categories C and D that have industry-leading compliance commitments are enabled by default (but don't hold me to this. Double check on the Microsoft website). Services in categories A and B come with controls to turn on or turn off these services for an entire organization. Details can be found in the <a href="https://docs.microsoft.com/en-us/microsoftteams/security-compliance-overview" rel="noopener">Compliance Framework for Industry Standards and Regulations</a>. Microsoft Teams also supports Cloud Security Alliance compliance.</Typography>
