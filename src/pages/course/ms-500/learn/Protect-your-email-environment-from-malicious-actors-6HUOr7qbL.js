              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>Email is one of the most targeted attack vectors in your environment, and there are many moving pieces. There are spam and phishing attacks. And there isn't one size fits in terms of how they attack. They can use malware, attachments, and links. Anyway, if you're reading about the MS-500 then I'm sure you're aware of the security issues related to email. So without wasting a lot of time let's jump into the defenses.</p>
                    ...
                    <div id="ld-7740-2760" /><h2>Anti-spam</h2>
                    ...
                    <div ><img src="https://i.ibb.co/yP4FgXv/Anti-spam-inbound-policy-Default.png" alt="Anti-spam inbound policy (Default)" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/hF9wf0j/information-i.png" alt="Information I" height="auto" width="auto" /></div>
                    ...
                    <p />
                    <div ><img src="https://i.ibb.co/4KMB8dW/connection-filter-settings.png" alt="connection filter settings" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/mXw10nR/Anti-spam-outbound-policy-Default.png" alt="Anti-spam outbound policy" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/tKrgbvt/create-a-new-safe-attachment-policy.png" alt="Create a new safe attachment policy" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/jMBdS0g/protect-all-domains-from-unsafe-attachments.png" alt="Add all your domains to the domains list in your safe attachments policy" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/zncV4XL/configure-the-safe-attachment-policy.png" alt="Configure the safe attachment policy" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/VVBFQsk/Safe-Attachments-unknown-malware-response.png" alt="Safe Attachments unknown malware response" height="auto" width="auto" /></div>
                    <ul>
                    ...
                    <div ><img src="https://i.ibb.co/V9y9b8z/start-a-message-trace.png" alt="Start a message trace" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/p14jV0N/Message-trace-results.png" alt="View message trace results" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Df0KQVp/Reports.png" alt="Threat protection status report" height="auto" width="auto" /></div>
                    <h2>Safe links</h2>
                    ...
                    <div ><img src="https://i.ibb.co/xGx3RSY/block-URL-in-Microsoft-365.png" alt="How to block a URL in Microsoft 365" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Dw9Hb9L/Track-when-users-click-protected-links.png" alt="Enable tracking when a user clicks a protected URL" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/S5tCBZ7/anti-malware-settings.png" alt="Anti-malware settings" height="auto" width="auto" /></div>
                    <p />
                  </div>
