              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>You will see questions about Microsoft Intune, configuration profiles, and compliance policies. You won't see any questions about how to set up a device in Intune but I thought it was important for you to see so I've created a lesson. If you already set up Intune to work with Windows devices or are only concerned about passing the MS-500 feel free to skip this lesson.</p>
                    ...
                    <div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>How to configure auto-enrollment</h2>
                    ...
                    <div ><img src="https://i.ibb.co/1XbTJ8n/Auto-enroll-Windows-in-Intune.png" alt="Auto-enroll Windows devices in Intune" height="520" width="1818" style="aspect-ratio: auto 1818 / 520; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/gjXKgrp/Open-Settings-on-Windows-computer.png" alt="How to open settings on a Windows computer" height="286" width="278" style="aspect-ratio: auto 278 / 286; height: auto;" /></div>
                    <p>2. Click Accounts.</p>
                    <div ><img src="https://i.ibb.co/fqpJV7z/accounts-button.png" alt="Accounts" height="104" width="228" style="aspect-ratio: auto 228 / 104; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/3vL0pvV/Connect-Windows-10-to-Azure-AD.png" alt="Connect your Windows 10 device to Intune" height="644" width="1116" style="aspect-ratio: auto 1116 / 644; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/WDXKVjW/configure-device-options.png" alt="Configure device options" height="620" width="880" style="aspect-ratio: auto 880 / 620; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/C0B6mNX/enter-your-global-admin-credentials.png" alt="Enter your global admin credentials" height="620" width="880" style="aspect-ratio: auto 880 / 620; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/1r2tRWm/Windows-10-or-later-domain-joined-devices.png" alt="Windows 10 or later domain-joined devices" height="620" width="880" style="aspect-ratio: auto 880 / 620; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/x7QWR3b/SCP-Configuration.png" alt="SCP Configuration" height="619" width="1294" style="aspect-ratio: auto 1294 / 619; height: auto;" /></div>
