            ...
            <Grid container spacing={2}>
              <Grid item lg={9}>
                <main>
                  ...
                  <div><div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>What is Microsoft Sentinel?</h2>
                    ...
                    <div ><img src="https://i.ibb.co/Jpv7RWG/Create-Microsoft-Sentinel.png" alt="Create Microsoft Sentinel" height="295" width="683" style="aspect-ratio: auto 683 / 295; height: auto;" /></div>
                    <p>3. Click <strong>Create a new workspace</strong>.</p>
                    <div ><img src="https://i.ibb.co/2NQ77Jm/Create-a-new-workspace.png" alt="Create a new workspace" height="213" width="534" style="aspect-ratio: auto 534 / 213; height: auto;" /></div>
                    <p>4. Click <strong>Create new</strong>. Set the name to <strong>Sentinel</strong>. Click <strong>OK</strong>.</p>
                    <div ><img src="https://i.ibb.co/S6Bz6JQ/resource-group.png" alt="Resource group" height="365" width="715" style="aspect-ratio: auto 715 / 365; height: auto;" /></div>
                    <p>5. Set the instance name to <strong>Sentinel-Instance</strong>. Click <strong>Review + Create</strong>.</p>
                    <div ><img src="https://i.ibb.co/W57XtNB/Set-the-instance-name-and-click-Create.png" alt="Set the instance name and click Create" height="410" width="706" style="aspect-ratio: auto 706 / 410; height: auto;" /></div>
                    <p>6. Click <strong>Create</strong>.</p>
                    <p>7. Click the <strong>Sentinel-Instance</strong>. Click <strong>Add</strong>.</p>
                    <div ><img src="https://i.ibb.co/84btgtP/Add-sentinel-to-a-workspace.png" alt="Add Microsoft Sentinel to a workspace" height="256" width="312" style="aspect-ratio: auto 312 / 256; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/NmbWCnR/Microsoft-Sentinel-Office-365-Data-connector.png" alt="Microsoft Sentinel | Data connectors" height="932" width="1921" style="aspect-ratio: auto 1921 / 932; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/TcTDchS/Configure-Office-365-data-connector.png" alt="Configure Office 365 data connector" height="270" width="646" style="aspect-ratio: auto 646 / 270; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/7nbczX9/Microsoft-Sentinel-Azure-AD-Data-connector.png" alt="Microsoft Sentinel Azure AD Data connector" height="894" width="1917" style="aspect-ratio: auto 1917 / 894; height: auto;" /></div>
                    <p>2. Click all the checkboxes under Configuration. Click <strong>Apply Changes</strong>.</p>
                    <div ><img src="https://i.ibb.co/177NHcx/Configure-Azure-AD-data-connector.png" alt="Configure Azure AD data connector" height="623" width="463" style="aspect-ratio: auto 463 / 623; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/cv0Ld6t/open-diagnostic-settings.png" alt="Open diagnostic settings" height="613" width="1181" style="aspect-ratio: auto 1181 / 613; height: auto;" /></div>
                    <p>2. Click your <strong>workspace</strong>. Click <strong>Add diagnostic setting</strong>.</p>
                    <div ><img src="https://i.ibb.co/Qfmk0dH/Add-diagnostic-setting.png" alt="Add diagnostic setting" height="424" width="923" style="aspect-ratio: auto 923 / 424; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/zZrV7Vj/Create-diagnostic-settings.png" alt="Create diagnostic settings" height="563" width="1020" style="aspect-ratio: auto 1020 / 563; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/rGhcRPT/Open-Security-Extensions.png" alt="Open Security Extensions" height="469" width="315" style="aspect-ratio: auto 315 / 469; height: auto;" /></div>
                    <p>2. Click <strong>SIEM agents</strong> &gt; <strong>Add SIEM agent</strong> &gt; <strong>Azure Sentinel</strong>.</p>
                    <div ><img src="https://i.ibb.co/j3GHGvz/Add-SIEM-agent-Microsoft-Sentinel.png" alt="Add SIEM agent Microsoft Sentinel" height="314" width="442" style="aspect-ratio: auto 442 / 314; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/ZdMXtWM/Create-Microsoft-Sentinel-rule.png" alt="Create Microsoft Sentinel rule" height="885" width="1917" style="aspect-ratio: auto 1917 / 885; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/qN9XsKj/Add-Workbook.png" alt="Add workbook to Microsoft Sentinel" height="459" width="1027" style="aspect-ratio: auto 1027 / 459; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/hmwQPVW/Save-your-new-workbook.png" alt="Save your new workbook" height="312" width="892" style="aspect-ratio: auto 892 / 312; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/ssNQGdy/View-saved-workbook.png" alt="View saved workbook" height="816" width="1396" style="aspect-ratio: auto 1396 / 816; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/LCT6PrC/Create-a-playbook.png" alt="Create a playbook" height="887" width="1674" style="aspect-ratio: auto 1674 / 887; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/bNDYmjx/Setup-connections.png" alt="Setup the connections" height="787" width="1373" style="aspect-ratio: auto 1373 / 787; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/xDnBWSx/Create-a-playbook-basic-settings.png" alt="Create a playbook: Basic Settings" height="693" width="606" style="aspect-ratio: auto 606 / 693; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/H2dDH2V/Send-an-email-V2-Office-365-Outlook.png" alt="Send an email (V2) Office 365 Outlook" height="447" width="614" style="aspect-ratio: auto 614 / 447; height: auto;" /></div>
                    <p>7. Click <strong>Sign in</strong>. In the box that opens sign in to your account.</p>
                    <div ><img src="https://i.ibb.co/rFXc9Tf/Sign-in-Office-365-Outlook.png" alt="Sign in to Office 365 Outlook" height="139" width="604" style="aspect-ratio: auto 604 / 139; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/jfjXBqq/View-Microsoft-Sentinel-Logs.png" alt="View Microsoft Sentinel Logs" height="446" width="1192" style="aspect-ratio: auto 1192 / 446; height: auto;" /></div>
