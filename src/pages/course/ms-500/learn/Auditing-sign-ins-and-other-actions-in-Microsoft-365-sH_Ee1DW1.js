              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>So now we have Microsoft 365 fairly secure. There's one more question you should be asking yourself. How do we audit/monitor the user's actions? Before we jump into the logs there's something you should know. There are a couple of places for auditing but we'll keep it simple and stick to the two most common. First, let's take a look at sign-in logs. Next, we'll jump into auditing the Active Directory account auditing. Finally, we'll jump into auditing all actions.</p>
                    <div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>Sign-in logs</h2>
                    ...
                    <div ><img src="https://i.ibb.co/gSn6PVP/sign-in-logs.png" alt="Sign-in logs" height="605" width="495" style="aspect-ratio: auto 495 / 605; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/F8FqcGJ/sign-in-logs-for-user.png" alt="Sign-in logs for user" height="528" width="716" style="aspect-ratio: auto 716 / 528; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/DDHPKTV/activity-details.png" alt="activity details" height="804" width="678" style="aspect-ratio: auto 678 / 804; height: auto;" /></div>
                    <h4>Location</h4>
                    ...
                    <div ><img src="https://i.ibb.co/QY6q69M/location-tab.png" alt="Location tab" height="290" width="680" style="aspect-ratio: auto 680 / 290; height: auto;" /></div>
                    <h4>Device info</h4>
                    ...
                    <div ><img src="https://i.ibb.co/gZQ2vnG/device-info-tab.png" alt="Device info tab" height="314" width="667" style="aspect-ratio: auto 667 / 314; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/85LXdWW/Authentication-Details.png" alt="Authentication Details" height="218" width="836" style="aspect-ratio: auto 836 / 218; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/2tCsbnf/conditional-access-policy-sign-in-logs.png" alt="conditional access policy sign-in logs" height="267" width="838" style="aspect-ratio: auto 838 / 267; height: auto;" /></div>
                    <h4>Report only</h4>
                    ...
                    <div ><img src="https://i.ibb.co/7GmvDjZ/view-audit-logs.png" alt="View audit logs" height="666" width="1332" style="aspect-ratio: auto 1332 / 666; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/BqMw3jZ/Start-recording-user-and-admin-activity.png" alt="Start recording user and admin activity" height="391" width="1005" style="aspect-ratio: auto 1005 / 391; height: auto;" /></div>
