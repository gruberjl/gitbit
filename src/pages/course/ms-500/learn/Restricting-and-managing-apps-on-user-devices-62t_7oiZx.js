              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>Now that we have devices set up in Intune and secure how do we start deploying, managing, and securing apps? Let's start by deploying an app to an Android device.</p>
                    <div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>How to deploy an app to an Android device</h2>
                    ...
                    <div ><img src="https://i.ibb.co/PCVRKDf/Add-an-Android-app-to-Intune.png" alt="Add an Android app to Intune" height="545" width="1457" style="aspect-ratio: auto 1457 / 545; height: auto;" /></div>
                    <p>2. Search for the app you want to deploy, for example, <strong>Outlook</strong>. Click on the <strong>app icon</strong>.</p>
                    <div ><img src="https://i.ibb.co/56RM4mY/select-outlook-in-the-app-selection.png" alt="Select outlook in the app selection" height="454" width="586" style="aspect-ratio: auto 586 / 454; height: auto;" /></div>
                    <p>3. Click <strong>Approve </strong>&gt; <strong>Approve</strong> &gt; <strong>Done </strong>&gt; <strong>Sync</strong>.</p>
                    <div ><img src="https://i.ibb.co/VvzLtY2/approve-the-app.png" alt="Approve the app" height="751" width="1055" style="aspect-ratio: auto 1055 / 751; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Q69pRsR/Assign-the-app.png" alt="Assign the app" height="684" width="1661" style="aspect-ratio: auto 1661 / 684; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Ny4rpWg/Assign-to-all-users.png" alt="Assign to all users" height="283" width="395" style="aspect-ratio: auto 395 / 283; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/98k1njW/Create-an-app-configuration-policy.png" alt="Create an app configuration policy" height="409" width="635" style="aspect-ratio: auto 635 / 409; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/WPv7R5g/Set-up-App-Configuration-policy-Basics.png" alt="Set up App Configuration policy Basics" height="598" width="1231" style="aspect-ratio: auto 1231 / 598; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/BsXT1tZ/Create-app-configuration-policy-Settings.png" alt="Create app configuration policy - Settings" height="555" width="766" style="aspect-ratio: auto 766 / 555; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/7nmGbsm/create-an-app-protection-policy.png" alt="Create an app protection policy" height="426" width="653" style="aspect-ratio: auto 653 / 426; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/qFPWBbn/Create-App-protection-policy-Apps.png" alt="Create App protection policy - Apps" height="291" width="761" style="aspect-ratio: auto 761 / 291; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/cy9zXyZ/App-protection-policy-Data-protection.png" alt="App protection policy - Data protection" height="641" width="1224" style="aspect-ratio: auto 1224 / 641; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/b6KtMZt/conditional-access-policy.png" alt="Conditional access policy" height="660" width="323" style="aspect-ratio: auto 323 / 660; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/7GtPn4V/set-owa-mailbox-policy.png" alt="Set OWA Mailbox policy" height="681" width="1225" style="aspect-ratio: auto 1225 / 681; height: auto;" /></div>
