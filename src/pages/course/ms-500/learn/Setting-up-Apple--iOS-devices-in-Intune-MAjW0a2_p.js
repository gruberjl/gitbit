              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>You will see questions about Microsoft Intune, configuration profiles, and compliance policies. You won't see any questions about how to set up a device in Intune but I thought it was important for you to see so I've created a lesson. If you already set up Intune to work with iOS devices or are only concerned about passing the MS-500 feel free to skip this lesson.</p>
                    <div id="ld-7740-2760" /><h2>Configure Apple enrollment</h2>
                    ...
                    <div ><img src="https://i.ibb.co/X7Ffb2B/Setup-Apple-Enrollment-in-Intune.png" alt="Setup Apple enrollment in Intune" height="auto" width="auto" /></div>
                    <p>2. Create an Apple ID and then sign in. Click Create a certificate. Click I have read and agree. Click Accept.</p>
                    <div ><img src="https://i.ibb.co/jMDfY10/Create-Apple-Push-certificate.png" alt="Create Apple push certificate" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/HgHqfqy/Upload-your-CSR.png" alt="Upload your CSR" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/hBJXV0P/upload-certificate-to-Intune.png" alt="Upload certificate to Intune" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/PZmq1Vc/install-Intune-app-on-i-OS.png" alt="Install Intune on iOS" height="auto" width="auto" /></div>
                    <p>2. Click <strong>Sign in</strong>. Sign in using your Microsoft 365 credentials.</p>
                    <div ><img src="https://i.ibb.co/XZJFp5F/sign-in-to-i-OS-intune.png" alt="Sign in to Intune on iOS" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/ydtgWDF/Allow-notifications-in-Intune-i-OS.png" alt="Allow notifications in Intune iOS" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/HXSn57B/Begin-registering-device-in-Intune.png" alt="Begin registering device in Intune" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Wc1y8Tf/downlaod-the-profile-on-i-OS.png" alt="Download the profile on iOS" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/TR07fNy/Begin-installing-management-profile.png" alt="Begin installing management profile" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/wRJJGbd/Install-management-profile-on-i-OS.png" alt="Install management profile on iOS" height="auto" width="auto" /></div>
                    <p>8. Open the <strong>Comp Portal</strong> app. Click <strong>Done</strong>.</p>
                    <div ><img src="https://i.ibb.co/dP7cFQK/Finish-setting-up-Intune-on-i-OS.png" alt="Finish setting up Intune on iOS" height="auto" width="auto" /></div>
                    <p />
                  </div>
