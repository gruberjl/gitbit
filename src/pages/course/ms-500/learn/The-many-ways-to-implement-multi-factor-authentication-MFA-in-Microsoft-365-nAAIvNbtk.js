              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>There are five, count it five, separate ways to configure multifactor authentication in Microsoft 365. In this article, we will go over three of them because one of them is no longer supported and one of them uses third-party tools that are out of scope for the MS-500.</p>
                    <div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>Security Defaults</h2>
                    ...
                    <div ><img src="https://i.ibb.co/P1P0wNY/microsoft-365-manage-security-defaults.png" alt="Microsoft 365 security defaults" height="962" width="1905" style="aspect-ratio: auto 1905 / 962; height: auto;" /></div>
                    <h2>Per-user MFA</h2>
                    ...
                    <div ><img src="https://i.ibb.co/RjswM6n/per-user-mfa.png" alt="Microsoft 365 Per-User MFA" height="386" width="931" style="aspect-ratio: auto 931 / 386; height: auto;" /></div>
                    <p>2. Click the check box next to a user you want to enable MFA for. Click <strong>Enable</strong>.</p>
                    <div ><img src="https://i.ibb.co/PZm5KmW/enable-per-user-mfa.png" alt="Enable per-user MFA" height="603" width="934" style="aspect-ratio: auto 934 / 603; height: auto;" /></div>
                    <p>3. Click <strong>enable multi-factor auth</strong>.</p>
                    <div ><img src="https://i.ibb.co/S7V5dtG/enable-per-user-mfa-last-button.png" alt="Enable multi-factor auth" height="251" width="659" style="aspect-ratio: auto 659 / 251; height: auto;" /></div>
                    <h3>Understanding MFA Status</h3>
                    <div ><img src="https://i.ibb.co/HTFhBzB/MFA-Status.png" alt="MFA Status in Microsoft 365" height="623" width="711" style="aspect-ratio: auto 711 / 623; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/gz1c3d2/per-user-mfa-settings.png" alt="Per-User MFA Settings" height="843" width="855" style="aspect-ratio: auto 855 / 843; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/qxDcS5y/name-conditional-access-policy.png" alt="Name the conditional access Policy Require MFA" height="276" width="296" style="aspect-ratio: auto 296 / 276; height: auto;" /></div>
                    <p>3. Click <strong>0 users or workload identities selected</strong>. Click <strong>All users</strong>.</p>
                    <div ><img src="https://i.ibb.co/12YyXpS/Set-Conditional-access-policy-to-all-users.png" alt="Set Conditional access policy to all users" height="671" width="576" style="aspect-ratio: auto 576 / 671; height: auto;" /></div>
                    <p>4. Click <strong>No cloud apps, actions, or authentication contexts selected</strong>. Click <strong>All cloud apps</strong>.</p>
                    <div ><img src="https://i.ibb.co/T0vZjsW/conditional-access-policy-all-cloud-apps.png" alt="Conditional access policy all cloud apps" height="684" width="585" style="aspect-ratio: auto 585 / 684; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/mcCvKFG/conditional-access-policy-requiring-mfa.png" alt="Conditional access policy requiring MFA" height="808" width="612" style="aspect-ratio: auto 612 / 808; height: auto;" /></div>
                    <h2>MFA Server</h2>
                    ...
                    <div ><img src="https://i.ibb.co/gRrD5Pb/MFA-Enabled.png" alt="MFA Enabled More information required" height="634" width="652" style="aspect-ratio: auto 652 / 634; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/MsS22gP/install-the-authenticator-app.png" alt="Install the authentication app" height="723" width="822" style="aspect-ratio: auto 822 / 723; height: auto;" /></div>
                    <p>3. Once in the app click <strong>I agree </strong>&gt; <strong>Scan a QR code</strong> &gt; <strong>While using the app</strong>.</p>
                    <div ><img src="https://i.ibb.co/vDYhfBd/Setup-authenticator-app.png" alt="Setup the authenticator app" height="942" width="1702" style="aspect-ratio: auto 1702 / 942; height: auto;" /></div>
                    <p>3. Then go back to the sign-in page and click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/xDMnv45/keep-your-account-secure-page.png" alt="Keep you account secure page" height="634" width="652" style="aspect-ratio: auto 652 / 634; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/gT5QZKt/scan-qr-code.png" alt="Scan the QR code with your phone" height="680" width="652" style="aspect-ratio: auto 652 / 680; height: auto;" /></div>
                    <p>4. Approve the sign-in request on your phone.</p>
                    <div ><img src="https://i.ibb.co/YhvggFT/approve-sign-in.png" alt="Approve the sign in" height="1059" width="639" style="aspect-ratio: auto 639 / 1059; height: auto;" /></div>
                    <p>5. Once you see the Notification approved message click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/VjsxsJ4/notification-approved.png" alt="Notification approved" height="634" width="652" style="aspect-ratio: auto 652 / 634; height: auto;" /></div>
                    <p>6. on the Phone page, enter your cell phone number and click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/St4Fkrz/enter-phone-number-to-recieve-text-message.png" alt="Enter phone number to receive text message" height="634" width="652" style="aspect-ratio: auto 652 / 634; height: auto;" /></div>
                    <p>7. Enter the code texted to you in the space provided. Click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/W6c37x4/enter-code-received-in-text-message.png" alt="Enter the code you received in the text message" height="634" width="652" style="aspect-ratio: auto 652 / 634; height: auto;" /></div>
                    <p>8. Once you see SMS verified. Click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/wQ44kFB/SMS-verified.png" alt="SMS verified" height="634" width="652" style="aspect-ratio: auto 652 / 634; height: auto;" /></div>
                    <p>9. On the success page click <strong>Done</strong>.</p>
                    <div ><img src="https://i.ibb.co/TbQvJDf/Click-done.png" alt="Click done" height="634" width="652" style="aspect-ratio: auto 652 / 634; height: auto;" /></div>
                    <p />
                  </div>
