              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>So far, we have looked at securing Microsoft 365, Microsoft servers, and third-party devices like firewalls, but we haven't looked at how to secure Windows 10, Android, Apple iOS, and Macs. Securing client devices is exactly where Microsoft Intune comes into play. If you haven<span >'t used SCCM, don't worry; I'll explain Microsoft Intune and most of its components throughout the next lessons.</span>&nbsp;</p>
                    <div ><img src="https://i.ibb.co/Fq3N8BX/Endpoint-Manager-Admin-Center.png" alt="Endpoint Manager admin center" height="auto" width="auto" /></div>
                    ...
                    <p />
                    <div ><img src="https://i.ibb.co/q9Dj65h/endpoint-manager.png" alt="How to open the Endpoint Manager admin center" height="auto" width="auto" /></div>
                    <h2>Inventory</h2>
                    ...
                    <div ><img src="https://i.ibb.co/5FGSPWH/device-clean-up-rules.png" alt="Intune automatically clean-up stale devices" height="auto" width="auto" /></div>
                    <h2>Configuration profiles</h2>
                    <div ><img src="https://i.ibb.co/7tQMTkT/configuration-profiles.png" alt="Microsoft Intune configuration profile" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/NV1pCKG/compliance-policy.png" alt="Microsoft Intune compliance policy" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Lk6g8Cg/app-deployment.png" alt="App deployment" height="auto" width="auto" /></div>
                    ...
                    <h2>Push updates</h2>
                    <div ><img src="https://i.ibb.co/hB8Ysj9/Intune-Updates.png" alt="Intune Update rings" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/FYLwR5d/Autopilot.png" alt="Autopilot" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/ZLBHqzr/limit-device-enrollments-Intune.png" alt="Limit the number of devices a user can enroll in Intune" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/qNbcrJf/limit-enrollments-in-Intune.png" alt="Limit enrollments in Intune" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/zh1KVXP/Azure-AD-Devices.png" alt="Azure AD Devices" height="auto" width="auto" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Dfh1hxF/set-Azure-AD-device-limits.png" alt="Set Azure AD Device limits" height="auto" width="auto" /></div>
                    <p />
                  </div>
