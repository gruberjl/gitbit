              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>Compliance policies are a great way to verify a device is configured and secure as you expect. You don't need a compliance policy for every setting in a configuration profile but you will want one to verify certain settings like passwords and encryption or verify the machine risk level. Let's jump in and take a look.</p>
                    <div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>Creating a Windows compliance policy</h2>
                    ...
                    <div ><img src="https://i.ibb.co/N3Qk57v/Create-a-compliance-policy.png" alt="Create a compliance policy" height="534" width="1586" style="aspect-ratio: auto 1586 / 534; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/dJwctST/Windows-10-Compliance-Policy-Settings.png" alt="Windows 10 Compliance Policy Setting Encryption" height="451" width="770" style="aspect-ratio: auto 770 / 451; height: auto;" /></div>
                    <p>4. Set the <strong>Schedule (days after noncompliance)</strong> to <strong>5</strong>. Click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/hggb1G1/Mark-device-noncompliant.png" alt="Mark device noncompliant" height="425" width="784" style="aspect-ratio: auto 784 / 425; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/9cmqh7d/Compliance-Policy-Chart.png" alt="Compliance Policy Chart" height="148" width="401" style="aspect-ratio: auto 401 / 148; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/3vgnWJR/actions-for-noncompliance.png" alt="Actions for noncompliance" height="333" width="768" style="aspect-ratio: auto 768 / 333; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/58CHC5j/Mark-devices-with-no-compliance-policy-assigned.png" alt="Mark devices with no compliance policy assigned" height="426" width="1570" style="aspect-ratio: auto 1570 / 426; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Ln5Y4sS/Add-all-users-to-conditional-access-policy.png" alt="Add all user to conditional access policy" height="659" width="612" style="aspect-ratio: auto 612 / 659; height: auto;" /></div>
                    <p />
                    ...
                    <div ><img src="https://i.ibb.co/7jJpRvY/exclude-break-glass-account-from-conditional-access-policy.png" alt="Exclude break glass account from conditional access policy" height="628" width="907" style="aspect-ratio: auto 907 / 628; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/jzcgHBf/Set-cloud-apps.png" alt="Set cloud apps" height="479" width="1071" style="aspect-ratio: auto 1071 / 479; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/JBZX8g5/require-device-to-be-marked-as-compliant.png" alt="Require device to be marked as compliant" height="763" width="634" style="aspect-ratio: auto 634 / 763; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/3CL8NQx/quarantine-mobile-devices.png" alt="Configure Microsoft 365 to quarantine mobile devices" height="683" width="1455" style="aspect-ratio: auto 1455 / 683; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/dB7PCN5/Your-device-is-temporarily-blocked-from-accessing-content-via-Exchange-Active-Sync-because-the-devic.png" alt="Your device is temporarily blocked from accessing content via Exchange ActiveSync because the device has been quarantined" height="577" width="1055" style="aspect-ratio: auto 1055 / 577; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/89KnxVW/Allow-device-through-quarantine.png" alt="Allow device through quarantine" height="534" width="1475" style="aspect-ratio: auto 1475 / 534; height: auto;" /></div>
                    <p />
                  </div>
