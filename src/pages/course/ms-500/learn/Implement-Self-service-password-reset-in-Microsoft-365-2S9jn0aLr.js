              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>Self-service password reset (SSPR) is a possibility you're used to with other websites you log on to. For example, Gmail has a self-service password reset. In short, self-service password reset means a user that forgot their password can reset it without contacting an administrator. The user can authorize themselves in another fashion whether it's a text message using the Microsoft authenticator app or a phone call.</p>
                    ...
                    <div ><img src="https://i.ibb.co/bmn5HNg/view-current-ad-connect-settings.png" alt="View current AD connect settings" height="644" width="1003" style="aspect-ratio: auto 1003 / 644; height: auto;" /></div>
                    <p>3. Take note of the account listed under <strong>Synchronized Directories</strong> &gt; <strong>Account</strong>.</p>
                    <div ><img src="https://i.ibb.co/LkCDyjm/MSOL-account.png" alt="MSOL Account" height="619" width="880" style="aspect-ratio: auto 880 / 619; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/p4RPcvB/enable-advanced-features.png" alt="Enable Advanced features" height="528" width="752" style="aspect-ratio: auto 752 / 528; height: auto;" /></div>
                    <p>7. Right-click the root domain &gt; <strong>Properties</strong>.</p>
                    <div ><img src="https://i.ibb.co/HHD24wp/open-ad-properties.png" alt="Open AD properties" height="385" width="347" style="aspect-ratio: auto 347 / 385; height: auto;" /></div>
                    <p>8. Click the <strong>Security</strong> tab &gt; <strong>Advanced</strong>.</p>
                    <div ><img src="https://i.ibb.co/4fpNryL/open-advanced-properties-in-ad.png" alt="Open advanced properties" height="453" width="398" style="aspect-ratio: auto 398 / 453; height: auto;" /></div>
                    <p>9. Click <strong>Add</strong>.</p>
                    <div ><img src="https://i.ibb.co/XVNpVjD/Add-Permissions.png" alt="Add permissions in AD" height="520" width="763" style="aspect-ratio: auto 763 / 520; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/TT4PC9t/select-a-principal-ad.png" alt="Select a principal" height="588" width="910" style="aspect-ratio: auto 910 / 588; height: auto;" /></div>
                    <p>11. Click the <strong>Applies to</strong> drop-down and select <strong>Descendant User Objects</strong>.</p>
                    <div ><img src="https://i.ibb.co/YTznr3c/descendant-user-objects.png" alt="Select Descendant User Objects" height="550" width="368" style="aspect-ratio: auto 368 / 550; height: auto;" /></div>
                    <p>12. Click <strong>Reset password</strong> (located under Permissions).</p>
                    <div ><img src="https://i.ibb.co/ch4C20T/reset-password.png" alt="Reset password permissions" height="596" width="913" style="aspect-ratio: auto 913 / 596; height: auto;" /></div>
                    <p>13. Find and check <strong>Write lockoutTime</strong>.</p>
                    <div ><img src="https://i.ibb.co/JqLvsnC/write-lockouttime.png" alt="Write lockoutTime" height="588" width="911" style="aspect-ratio: auto 911 / 588; height: auto;" /></div>
                    <p>14. Find and check <strong>Write pwdLastSet</strong>.</p>
                    <div ><img src="https://i.ibb.co/X3jDPmt/write-pwd-Last-Set.png" alt="Write pwdLastSet" height="591" width="910" style="aspect-ratio: auto 910 / 591; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/yBsDWSF/unexpire-password.png" alt="Unexpire password" height="588" width="911" style="aspect-ratio: auto 911 / 588; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/SJvpG6h/customize-syncronization-options.png" alt="Customize synchronization options" height="615" width="875" style="aspect-ratio: auto 875 / 615; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/X3bdwkd/ad-connect-enter-global-admin-credentials.png" alt="AD Connect enter your global admin credentials" height="617" width="876" style="aspect-ratio: auto 876 / 617; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/dkbsv38/enable-password-writeback-in-ad-connect.png" alt="Enable password write-back in AD Connect" height="621" width="877" style="aspect-ratio: auto 877 / 621; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/BnySDH5/password-reset-options-in-microsoft-365.png" alt="Password reset options in Microsoft 365" height="600" width="467" style="aspect-ratio: auto 467 / 600; height: auto;" /></div>
                    <p>2. Click <strong>All </strong>to enable SSPR for everyone. Click <strong>Save</strong>.</p>
                    <div ><img src="https://i.ibb.co/nLP24yX/enable-sspr.png" alt="Enable SSPR" height="253" width="514" style="aspect-ratio: auto 514 / 253; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/58y9JVg/write-back-passwords-to-on-premises-directory.png" alt="Write-back on-premises integration" height="596" width="715" style="aspect-ratio: auto 715 / 596; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/cJLFytw/manage-user-feature-settings.png" alt="Microsoft 365 manage user feature settings" height="905" width="758" style="aspect-ratio: auto 758 / 905; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/61QhNtN/enable-combined-features.png" alt="Microsoft 365 enabled combined features" height="310" width="470" style="aspect-ratio: auto 470 / 310; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Tvwz6YJ/microsoft-365-password-reset-authentication-methods.png" alt="Microsoft 365 password reset authentication methods" height="716" width="964" style="aspect-ratio: auto 964 / 716; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/mX8t7P0/cant-access-your-account.png" alt="Can't access your account? Microsoft 365" height="346" width="448" style="aspect-ratio: auto 448 / 346; height: auto;" /></div>
                    <p>3. Click <strong>Work or school account</strong>.</p>
                    <div ><img src="https://i.ibb.co/DYBGr63/which-type-of-account-do-you-need-help-with.png" alt="Which type of account do you need help with?" height="404" width="446" style="aspect-ratio: auto 446 / 404; height: auto;" /></div>
                    <p>4. Enter your username in the space provided. Fill out the CAPTCHA in the space provided. Click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/V3qmVYF/get-back-into-your-account.png" alt="Get back into your account" height="449" width="651" style="aspect-ratio: auto 651 / 449; height: auto;" /></div>
                    <p>5. Enter your phone number in the space provided. Click <strong>Text</strong>.</p>
                    <div ><img src="https://i.ibb.co/FHym3Rx/get-back-into-your-account-text.png" alt="Get back into your account text message" height="374" width="685" style="aspect-ratio: auto 685 / 374; height: auto;" /></div>
                    <p>6. Enter the code texted to you. Click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/xYsJ3gy/enter-the-code-texted-to-you.png" alt="Enter the code texted to you" height="349" width="667" style="aspect-ratio: auto 667 / 349; height: auto;" /></div>
                    <p>7. Enter your new password twice. Click <strong>Finish</strong>.</p>
                    <div ><img src="https://i.ibb.co/T0TR946/choose-a-new-password.png" alt="Choose a new password in SSPR for Microsoft 365" height="283" width="377" style="aspect-ratio: auto 377 / 283; height: auto;" /></div>
