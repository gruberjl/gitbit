              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>Managing devices using Intune is typically done through configuration policies. Configuration policies are like group policies but more. If you don't know group policy, don't worry, I'll explain without the example.</p>
                    ...
                    <div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>Create a Windows 10 Device Configuration profile to set Telemetry data</h2>
                    ...
                    <div ><img src="https://i.ibb.co/YkcdP2T/Create-a-configuration-profile.png" alt="Create a configuration profile" height="638" width="1900" style="aspect-ratio: auto 1900 / 638; height: auto;" /></div>
                    <p>2. <strong>Name </strong>the profile "<strong>Disable telemetry</strong>" Click <strong>Next</strong>.</p>
                    <div ><img src="https://i.ibb.co/kQXPK8N/name-the-configuration-profile.png" alt="Name the configuration profile" height="464" width="766" style="aspect-ratio: auto 766 / 464; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Y0C3Tbw/Disable-Telemetry-on-Windows-10-through-Intune.png" alt="Disable Telemetry on Windows 10 through Intune" height="467" width="760" style="aspect-ratio: auto 760 / 467; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Df0QCPN/set-the-assignments.png" alt="Set the assignments in Intune" height="467" width="731" style="aspect-ratio: auto 731 / 467; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/X3X4qWz/Device-restrictions-assignments.png" alt="Device restrictions assignments" height="517" width="730" style="aspect-ratio: auto 730 / 517; height: auto;" /></div>
                    <p />
                    ...
                    <div ><img src="https://i.ibb.co/PDcFc1G/Enable-Smart-Screen.png" alt="Create an Attack surface reduction policy" height="502" width="1449" style="aspect-ratio: auto 1449 / 502; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/pQHYhXN/Enable-Smart-Screen.png" alt="Enable SmartScreen" height="282" width="711" style="aspect-ratio: auto 711 / 282; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/HPQ2m8t/Create-an-endpoint-protection-profile.png" alt="Create an endpoint protection profile in Intune" height="771" width="1585" style="aspect-ratio: auto 1585 / 771; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/2h9ntxm/Enable-Attack-Surface-Reduction-Policies.png" alt="Enable Attack Surface Reduction Policies" height="702" width="735" style="aspect-ratio: auto 735 / 702; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/wcJ13dL/Enable-Folder-Protection.png" alt="Enable Folder Protection" height="485" width="751" style="aspect-ratio: auto 751 / 485; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/9TfVy5z/Enable-Network-Protection.png" alt="Enable Network protection" height="351" width="761" style="aspect-ratio: auto 761 / 351; height: auto;" /></div>
