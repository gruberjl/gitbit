              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>With Microsoft 365 access to your data is in motion unlike it has been before. Users can access your organization's data from personal devices and can even invite guests to collaborate. With this free-flowing access, productivity receives a big boost but so do the challenges around security. How do we make sure there aren't stale user accounts that have access to your environment that is no longer in use? Let's take another example. Let's say you have a user on the IT help desk. He has limited administrative rights to your Microsoft 365 tenant just like he's supposed to. Then he gets a transfer/promotion. Now he's in marketing. How do you make sure his administrative access has been removed?</p>
                    ...
                    <div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>What licenses are required?</h2>
                    ...
                    <div ><img src="https://i.ibb.co/Xsxvz6Z/new-access-review.png" alt="New access review" height="584" width="1001" style="aspect-ratio: auto 1001 / 584; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/vVKtWPh/access-review-review-type3.png" alt="Access Review set the review type" height="578" width="1141" style="aspect-ratio: auto 1141 / 578; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/8z2hzWH/access-review-reviews.png" alt="Access review reviews" height="562" width="522" style="aspect-ratio: auto 522 / 562; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/QXMkkv8/access-review-settings.png" alt="set the access review settings" height="805" width="691" style="aspect-ratio: auto 691 / 805; height: auto;" /></div>
                    <p>5. Give your access review a helpful name then click <strong>Create</strong>.</p>
                    <div ><img src="https://i.ibb.co/2N1VQMQ/review-access-review-settings.png" alt="Review access review settings" height="808" width="519" style="aspect-ratio: auto 519 / 808; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/qMnYy61/action-required-access-review-email.png" alt="Action required access review email" height="796" width="1277" style="aspect-ratio: auto 1277 / 796; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/vX5Vxms/Approve-users.png" alt="Approve users in access review" height="572" width="994" style="aspect-ratio: auto 994 / 572; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/qNpQSRW/deny-users.png" alt="Deny users group access using access review" height="566" width="1000" style="aspect-ratio: auto 1000 / 566; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/yPtV1h3/access-azure-ad-privileged-identity-management.png" alt="Access Azure AD Privileged Identity Management" height="454" width="1228" style="aspect-ratio: auto 1228 / 454; height: auto;" /></div>
                    <p>2. Click <strong>Azure AD roles</strong> &gt; <strong>Access reviews</strong> &gt; <strong>New</strong>.</p>
                    <div ><img src="https://i.ibb.co/SfjV9P0/access-review-for-roles.png" alt="Access review for roles" height="521" width="614" style="aspect-ratio: auto 614 / 521; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/kBM9K3f/setup-access-review-for-admin-roles.png" alt="Setup access rights for admin roles" height="830" width="1183" style="aspect-ratio: auto 1183 / 830; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/kBM9K3f/setup-access-review-for-admin-roles.png" alt="upon completion settings in access review" height="830" width="1183" style="aspect-ratio: auto 1183 / 830; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/ggTMpH5/Access-review-approve-role.png" alt="Approve access review for role" height="653" width="849" style="aspect-ratio: auto 849 / 653; height: auto;" /></div>
                    <p />
                  </div>
