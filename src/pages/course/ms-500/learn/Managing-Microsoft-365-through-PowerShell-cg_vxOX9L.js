            ...
            <Grid container spacing={2}>
              <Grid item lg={9}>
                <main>
                  ...
                  <div><div id="ld-7740-2760" style={{height: this.state.decideHeight, overflow: 'hidden'}} /><h2>What's PowerShell?</h2>
                    ...
                    <p />
                    <div ><img src="https://i.ibb.co/31fXgzV/Power-Shell.png" alt="Access PowerShell" height="680" width="833" style="aspect-ratio: auto 833 / 680; height: auto;" /></div>
                    ...
                    <img src="https://i.ibb.co/4WfH7pW/powershell-as-admin.png" alt="Open PowerShell as an admin" height="681" width="827" style="aspect-ratio: auto 827 / 681; height: auto;" />
                    <p>3. When prompted click <strong>Yes</strong>.</p>
                    <img src="https://i.ibb.co/tYJ6H9X/Power-Shell-Allow-this-app.png" alt="PowerShell Allow open as admin" height="316" width="458" style="aspect-ratio: auto 458 / 316; height: auto;" />
                    ...
                    <img src="https://i.ibb.co/qyMttBg/install-nuget.png" alt="Install NuGet" height="191" width="859" style="aspect-ratio: auto 859 / 191; height: auto;" />
                    ...
                    <img src="https://i.ibb.co/HV13YF6/install-microsoft-365-powershell-modules.png" alt="Install Microsoft 365 PowerShell Modules" height="132" width="857" style="aspect-ratio: auto 857 / 132; height: auto;" />
                    ...
                    <p />
                    <img src="https://i.ibb.co/1mnGG2H/set-executionpolicy.png" alt="Set-ExecutionPolicy RemoteSigned" height="120" width="831" style="aspect-ratio: auto 831 / 120; height: auto;" />
                    ...
                    <img src="https://i.ibb.co/hdMWybz/connect-to-microsoft-365.png" alt="Connect to Microsoft 365 PowerShell - Enter Username" height="541" width="568" style="aspect-ratio: auto 568 / 541; height: auto;" />
                    <p>3. Then enter your password and click Sign in.</p>
                    <img src="https://i.ibb.co/0VgpjZ3/connect-to-microsoft-365-enter-password.png" alt="Microsoft 365 PowerShell Sign in Enter Password" height="541" width="568" style="aspect-ratio: auto 568 / 541; height: auto;" />
                    ...
                    <img src="https://i.ibb.co/4Rs6bkV/get-help-get-msoluser.png" alt="P&#123;owerShell command Get-Help Get-MsolUser" height="649" width="859" style="aspect-ratio: auto 859 / 649; height: auto;" />
                    <p>To see an example of running the commands you can run "<strong>Get-Help &lt;the-command&gt; -Examples</strong>"</p>
                    <img src="https://i.ibb.co/HdW0MVN/get-help-get-msoluser-examples.png" alt="PowerShell running Get-Help Get-MsolUser -Example" height="564" width="841" style="aspect-ratio: auto 841 / 564; height: auto;" />
                    ...
                    <div ><img src="https://i.ibb.co/xMS0rB1/sharepoint-admin-center.png" alt="Open SharePoint admin center" height="1038" width="1357" style="aspect-ratio: auto 1357 / 1038; height: auto;" /></div>
                    <p>3. Copy the SharePoint URL. Everything before the _layouts.</p>
                    <img src="https://i.ibb.co/BKbHN2x/Share-Point-url.png" alt="Copy the SharePoint URL" height="387" width="866" style="aspect-ratio: auto 866 / 387; height: auto;" />
                    ...
                    <img src="https://i.ibb.co/pPgzDsj/connect-to-sharepoint-online-using-powershell.png" alt="Connect the SharePoint Online using PowerShell" height="76" width="859" style="aspect-ratio: auto 859 / 76; height: auto;" />
