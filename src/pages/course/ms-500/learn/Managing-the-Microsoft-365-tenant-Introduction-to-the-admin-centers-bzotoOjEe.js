...
<p><span >The Microsoft Defender for Identity admin center can be accessed by going to </span><a href="https://portal.atp.azure.com/" target="_blank"><span >https://portal.atp.azure.com/</span></a><span > and logging in with your admin credentials.</span></p>
...
<p>The Defender for Cloud Apps admin center can be accessed by going to <a href="https://portal.cloudappsecurity.com" target="_blank">https://portal.cloudappsecurity.com</a>. From the Defender for Cloud Apps admin center, you can manage unsanctioned cloud applications. From the Defender for Cloud Apps admin center you can perform the following:</p>
<ul>
...
<p>The Microsoft Purview Compliance admin center, also known as, Puview admin center or Microsoft 365 Compliance admin center, can be accessed by going to <a href="https://compliance.microsoft.com/homepage" target="_blank">https://compliance.microsoft.com/homepage</a>. The Purview admin center is where you can manage the compliance of your tenant. You can classify data, set retention policies, and recover data. From the Purview admin center you can perform the following:</p>
<ul>
...
<p>The Microsoft 365 Defender admin center can be accessed by going to <a href="https://security.microsoft.com/" target="_blank">https://security.microsoft.com/</a>. The Defender admin center is used to get visibility, investigate, and manage the security of your Microsoft 365 tenant. From it you can perform the following:</p>
<ul>
