              ...
              <Grid item lg={9}>
                <main>
                  ...
                  <div><p>"Microsoft Defender for Cloud Apps is a Cloud Access Security Broker (CASB) that operates on multiple clouds. It provides rich visibility, control over data travel, and sophisticated analytics to identify and combat cyber threats across all your cloud services." - <a href="https://docs.microsoft.com/en-us/defender-cloud-apps/" target="_blank" rel="noreferrer">Microsoft</a></p>
                    ...
                    <div ><img src="https://i.ibb.co/wdyzFt9/open-microsoft-defender-for-cloud-apps.png" alt="Open Microsoft Defender for Cloud Apps Admin Center" height="488" width="1222" style="aspect-ratio: auto 1222 / 488; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/DwMCTLt/Enable-Microsoft-Defender-for-Identity-data-integration.png" alt="Enable Microsoft Defender for Identity data integration" height="271" width="1076" style="aspect-ratio: auto 1076 / 271; height: auto;" /></div>
                    <p>2. If you see Deploy Microsoft Defender for Identity click the link.</p>
                    <div ><img src="https://i.ibb.co/88DsRRM/Deploy-Microsoft-Defender-for-Identity.png" alt="Deploy Microsoft Defender for Identity" height="650" width="1186" style="aspect-ratio: auto 1186 / 650; height: auto;" /></div>
                    <p>3. Click <strong>Create</strong>.</p>
                    <div ><img src="https://i.ibb.co/fq6jbYc/Create-Microsoft-Defender-for-Identity-instance.png" alt="Create Microsoft Defender for Identity instance" height="415" width="533" style="aspect-ratio: auto 533 / 415; height: auto;" /></div>
                    <p>4. Click <strong>Provide a username and password</strong>.</p>
                    <div ><img src="https://i.ibb.co/JBGdSfr/provide-a-username-and-password.png" alt="Provide a username and password" height="167" width="751" style="aspect-ratio: auto 751 / 167; height: auto;" /></div>
                    <p>5. Enter your on-premises credentials in the space provided. Click Save.</p>
                    <div ><img src="https://i.ibb.co/HHK2qWz/enter-onpremises-credentials.png" alt="Enter on-premises credentials" height="524" width="1143" style="aspect-ratio: auto 1143 / 524; height: auto;" /></div>
                    <p>6. Click <strong>Download Sensore Setup</strong> at the top of the screen.</p>
                    <div ><img src="https://i.ibb.co/svLKv8H/download-sensor-setup.png" alt="Download the sensor setup" height="166" width="763" style="aspect-ratio: auto 763 / 166; height: auto;" /></div>
                    <p>7. Click <strong>Download </strong>then <strong>copy </strong>the access key.</p>
                    <div ><img src="https://i.ibb.co/kM8dshr/Download-sensor-and-copy-access-key.png" alt="Download the sensor then copy the key" height="102" width="700" style="aspect-ratio: auto 700 / 102; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/c888GgC/enter-access-key.png" alt="Enter the sensor access key" height="480" width="780" style="aspect-ratio: auto 780 / 480; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/D7mLYH2/cloud-apps-settings.png" alt="Click the gear then click Settings" height="461" width="403" style="aspect-ratio: auto 403 / 461; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/RYMnJLT/Configure-Microsoft-Defender-for-Identity-sensors.png" alt="Configure Microsoft Defender for Identity sensors" height="804" width="719" style="aspect-ratio: auto 719 / 804; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/C21rd1c/file-policy-alert.png" alt="Microsoft Defender for Cloud Apps email alert" height="669" width="603" style="aspect-ratio: auto 603 / 669; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/7g7LvFg/office-365-cloud-apps-settings.png" alt="Open the Microsoft Defender for Cloud Apps connected apps settings" height="607" width="1420" style="aspect-ratio: auto 1420 / 607; height: auto;" /></div>
                    <p>2. Click all the <strong>Office 365 components</strong> checkboxes. Click <strong>Connect</strong>.</p>
                    <div ><img src="https://i.ibb.co/PGyBPSP/defender-for-cloud-apps-office-365-components.png" alt="Microsoft Defender for Cloud Apps Office 365 components" height="598" width="637" style="aspect-ratio: auto 637 / 598; height: auto;" /></div>
                    <p>3. Close the Connect Office 365 window. Click Control &gt; Policies &gt; Create policy &gt; File policy.</p>
                    <div ><img src="https://i.ibb.co/nLDD0JR/create-file-policy.png" alt="Create file policy" height="622" width="650" style="aspect-ratio: auto 650 / 622; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/wL49NXB/create-file-policy-set-name.png" alt="Create a file policy. Set the name and remove the filters" height="614" width="659" style="aspect-ratio: auto 659 / 614; height: auto;" /></div>
                    <p>5. Click <strong>Select a filter</strong>. Select <strong>File name</strong>.</p>
                    <div ><img src="https://i.ibb.co/5LjdDSK/Filter-by-file-name.png" alt="Filter by file name" height="389" width="367" style="aspect-ratio: auto 367 / 389; height: auto;" /></div>
                    <p>6. Click <strong>equals</strong>. Select <strong>contains words</strong>. Set the File name field to <strong>File</strong>.</p>
                    <div ><img src="https://i.ibb.co/tLQ6q3r/set-filter-match-to-contains-words.png" alt="Set file filter match to contain the words File" height="113" width="304" style="aspect-ratio: auto 304 / 113; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/q9cjDjz/set-alert.png" alt="Set alert to email" height="613" width="1552" style="aspect-ratio: auto 1552 / 613; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/W0DDsqx/policy-meta-information.png" alt="Cloud App Policy Meta-Information" height="250" width="647" style="aspect-ratio: auto 647 / 250; height: auto;" /></div>
                    <h3>Filters</h3>
                    ...
                    <div ><img src="https://i.ibb.co/qxr2D8p/filter.png" alt="Cloud app policy filters" height="196" width="689" style="aspect-ratio: auto 689 / 196; height: auto;" /></div>
                    <h3>Actions</h3>
                    ...
                    <div ><img src="https://i.ibb.co/WPYhm63/Actions.png" alt="Microsoft Defender for Cloud Apps Actions" height="204" width="447" style="aspect-ratio: auto 447 / 204; height: auto;" /></div>
                    <h3>Alerts</h3>
                    ...
                    <div ><img src="https://i.ibb.co/VH7H7kw/Alerts.png" alt="Microsoft Defender for cloud apps Alerts" height="328" width="448" style="aspect-ratio: auto 448 / 328; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/XXJLWvv/create-new-conditional-access-policy.png" alt="Create new conditional access policy" height="114" width="275" style="aspect-ratio: auto 275 / 114; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/s368MwG/conditional-access-policy-all-users.png" alt="Conditional access policy all users" height="649" width="580" style="aspect-ratio: auto 580 / 649; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/q5shGXd/conditional-access-policy-set-exchange-online.png" alt="Set Exchange Online as the app in the conditional apps" height="741" width="1025" style="aspect-ratio: auto 1025 / 741; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/3zwTtWD/session-controls.png" alt="Session controls" height="733" width="610" style="aspect-ratio: auto 610 / 733; height: auto;" /></div>
                    <p>5. Set the Enable policy to <strong>On</strong>. Click <strong>Create</strong>.</p>
                    <div ><img src="https://i.ibb.co/ckcDbJn/enable-the-conditional-access-policy.png" alt="Enable the conditional access policy" height="103" width="237" style="aspect-ratio: auto 237 / 103; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/mCq773W/edit-connected-app.png" alt="Edit connected apps" height="509" width="1407" style="aspect-ratio: auto 1407 / 509; height: auto;" /></div>
                    <p>2. Click <strong>Use with Conditional Access App Control</strong>. Click <strong>Save</strong>.</p>
                    <div ><img src="https://i.ibb.co/Fzk45vy/use-with-conditional-access-app-control.png" alt="Use with conditional access app control" height="370" width="653" style="aspect-ratio: auto 653 / 370; height: auto;" /></div>
                    <h3>Create session policy</h3>
                    <p>1. Click Control &gt; Policies &gt; Create policy &gt; Session policy.</p>
                    <div ><img src="https://i.ibb.co/b1C33jn/create-session-policy.png" alt="Create session policy" height="481" width="658" style="aspect-ratio: auto 658 / 481; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/Lp85jht/session-policy-block-activities.png" alt="Session Policy block activities" height="718" width="855" style="aspect-ratio: auto 855 / 718; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/R24dxgR/select-apps-select-activity.png" alt="Select apps and select activiities" height="389" width="295" style="aspect-ratio: auto 295 / 389; height: auto;" /></div>
                    <p>4. Scroll down to the actions section. Click <strong>Block</strong>. Click <strong>Create</strong>.</p>
                    <div ><img src="https://i.ibb.co/yg2Z6Jf/block-session-policy.png" alt="Set the session policy to block" height="878" width="1480" style="aspect-ratio: auto 1480 / 878; height: auto;" /></div>
                    ...
                    <div ><img src="https://i.ibb.co/bbrpv8C/cloud-app-activity-log.png" alt="Cloud app activity log" height="755" width="1892" style="aspect-ratio: auto 1892 / 755; height: auto;" /></div>
                    <p />
                  </div>
