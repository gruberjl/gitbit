...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"key":"jsce","inlineStyleRanges":[],"entityRanges":[],"text":"Only global administrators and privileged role administrators can approve the admin role assignments.","depth":0,"type":"unstyled","data":{}},{"entityRanges":[{"key":0,"offset":0,"length":124}],"type":"unstyled","inlineStyleRanges":[],"key":"4ru2o","depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s "}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}},"question":{"blocks":[{"text":"your organization has a Microsoft 365 tenant with the following users.","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"key":"2u085"},{"entityRanges":[{"key":0,"offset":0,"length":1}],"key":"7nj32","data":{},"type":"atomic","depth":0,"inlineStyleRanges":[],"text":" "},{"key":"q8g8","text":"Your organization has implemented Azure Active Directory (Azure AD) Privileged Identity Management (PIM).","entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{}},{"key":"9t9i0","inlineStyleRanges":[],"type":"unstyled","text":"From PIM, you see the Application Administrator role has the following users.","entityRanges":[],"depth":0,"data":{}},{"inlineStyleRanges":[],"type":"atomic","key":"4e1ch","depth":0,"data":{},"entityRanges":[{"offset":0,"key":1,"length":1}],"text":" "},{"type":"unstyled","inlineStyleRanges":[],"text":"PIM is configured to use the following settings for users with the Application Administrator role assigned.","data":{},"entityRanges":[],"depth":0,"key":"dqtr5"},{"inlineStyleRanges":[],"text":"Require approval to activate: Yes","data":{},"entityRanges":[],"key":"fs7s9","depth":0,"type":"unordered-list-item"},{"key":"aqgof","text":"Approvers: None","inlineStyleRanges":[],"depth":0,"data":{},"type":"unordered-list-item","entityRanges":[]},{"entityRanges":[],"text":"Check the box next to each true statement.","type":"unstyled","depth":0,"inlineStyleRanges":[],"key":"bpudn","data":{}}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"height":"auto","alignment":"left","src":"https://i.ibb.co/Cs1cMM8/Chart5.png","width":"auto","alt":"Name Role Chart"}},"1":{"data":{"height":"auto","alt":"Name Assignment Type Chart","width":"auto","alignment":"left","src":"https://i.ibb.co/FVBbzdZ/Chart6.png"},"type":"IMAGE","mutability":"MUTABLE"}}},"answers":[{"isCorrectAnswer":true,"value":"When UserB submits a request to activate the role, User1 can approve the request."},{"value":"When UserB submits a request to activate the role, User2 can approve the request.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"When UserC submits a request to activate the role, User3 can approve the request."}],"id":"i2EPEDfe7"},
      previousQuestionId: '',
      nextQuestionId: '',
