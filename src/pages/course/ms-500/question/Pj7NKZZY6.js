...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {references: {entityMap: {0: {type: 'LINK', mutability: 'MUTABLE', data: {url: 'https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO', targetOption: '_blank'}}, 1: {data: {url: 'https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry', targetOption: '_blank'}, type: 'LINK', mutability: 'MUTABLE'}}, blocks: [{text: 'Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.', type: 'unstyled', inlineStyleRanges: [], entityRanges: [], key: '7sspj', depth: 0, data: {}}, {entityRanges: [{length: 87, offset: 0, key: 0}], depth: 0, inlineStyleRanges: [], key: 'e8kfh', text: 'https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO', type: 'unstyled', data: {}}, {text: 'https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry', data: {}, inlineStyleRanges: [], type: 'unstyled', depth: 0, entityRanges: [{offset: 0, key: 1, length: 94}], key: 'e14v9'}]}, question: {entityMap: {}, blocks: [{key: 'k7l7', data: {}, text: 'You have a Microsoft 365 subscription.', inlineStyleRanges: [], type: 'unstyled', depth: 0, entityRanges: []}, {entityRanges: [], data: {}, key: '2u8na', text: 'All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.', type: 'unstyled', depth: 0, inlineStyleRanges: []}, {inlineStyleRanges: [], text: 'You plan to view only security-related Windows telemetry data.', entityRanges: [], depth: 0, type: 'unstyled', key: 'ftuo9', data: {}}, {entityRanges: [], type: 'unstyled', depth: 0, key: 'ce2sa', inlineStyleRanges: [], text: 'You need to ensure that only Windows security data is sent to Microsoft.', data: {}}, {key: 'arrfp', entityRanges: [], type: 'unstyled', data: {}, depth: 0, text: 'What should you create from the Intune admin center?', inlineStyleRanges: []}]}, answers: [{value: 'A device configuration profile that has device restrictions configured', isCorrectAnswer: true}, {isCorrectAnswer: false, value: 'A device configuration profile that has the Endpoint Protection settings configured'}, {isCorrectAnswer: false, value: 'A device configuration policy that has the System Security settings configured'}, {value: 'A device compliance policy that has the Device Health settings configured', isCorrectAnswer: false}], id: 'Pj7NKZZY6'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
