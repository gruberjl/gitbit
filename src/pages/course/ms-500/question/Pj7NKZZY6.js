...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"A device configuration profile that has device restrictions configured","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"A device configuration profile that has the Endpoint Protection settings configured"},{"isCorrectAnswer":false,"value":"A device configuration policy that has the System Security settings configured"},{"isCorrectAnswer":false,"value":"A device compliance policy that has the Device Health settings configured"}],"id":"Pj7NKZZY6","question":{"entityMap":{},"blocks":[{"entityRanges":[],"text":"You have a Microsoft 365 subscription.","data":{},"key":"k7l7","depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"data":{},"key":"2u8na","inlineStyleRanges":[],"text":"All computers run Windows 10 Enterprise and are managed by using Microsoft Intune.","entityRanges":[],"type":"unstyled"},{"text":"You plan to view only security-related Windows telemetry data.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"key":"ftuo9","depth":0,"data":{}},{"key":"ce2sa","text":"You need to ensure that only Windows security data is sent to Microsoft.","entityRanges":[],"data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled"},{"key":"arrfp","depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"text":"What should you create from the Intune admin center?"}]},"references":{"blocks":[{"inlineStyleRanges":[],"data":{},"entityRanges":[],"text":"Go to Microsoft Endpoint Manager admin center > Devices > Windows > Configuration profiles. Click Create profile. Set the platform to Windows 10 and later. Set the profile type to templates. Select Device restriction under Template name. Click Create.","depth":0,"type":"unstyled","key":"7sspj"},{"entityRanges":[{"length":87,"offset":0,"key":0}],"inlineStyleRanges":[],"type":"unstyled","data":{},"depth":0,"key":"e8kfh","text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"},{"data":{},"type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"length":94,"offset":0,"key":1}],"depth":0,"text":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","key":"e14v9"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"}},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/intune/device-restrictions-windows-10#reporting-and-telemetry","targetOption":"_blank"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: 'Pj7NKZZY6',
      questionIdx: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/Pj7NKZZY6',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
