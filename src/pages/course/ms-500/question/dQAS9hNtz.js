...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'When a member of the Intune Endpoint Protection group opens a site that\'s flagged as dangerous, the webpage will open without warning'}, {isCorrectAnswer: false, value: 'When a member of the Intune Endpoint Protection group opens a site that\'s flagged as dangerous, the webpage will be blocked from opening'}, {isCorrectAnswer: true, value: 'When a member of the Intune Endpoint Protection group opens a site that\'s flagged as dangerous, the user will receive a security warning'}, {isCorrectAnswer: true, value: 'When a member of the group opens a site that\'s flagged as dangerous, the webpage will open without warning'}, {isCorrectAnswer: false, value: 'When a member of the Intune Help Desk Operators group opens a site that\'s flagged as dangerous, the webpage will be blocked from opening'}, {isCorrectAnswer: false, value: 'When a member of the Intune Help Desk Operators group opens a site that\'s flagged as dangerous, the user will receive a security warning'}], canonical: 'https://www.gitbit.org/course/ms-500/test/protecting-user-devices-using-intune-bzzocmdmd/question/create-an-attack-surface--xooagjtsu', id: 'dQAS9hNtz', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'asi2d', text: 'You have a Microsoft 365 tenant with Defender for Endpoint. Intune is set up and installed on your Windows 10 devices.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '22bt7', text: 'You open the Microsoft Endpoint Manager admin center and create an attack surface reduction policy. The policy is shown in the image below.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: 'dn69q', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '8i6ka', text: 'Check the box next to each statement that\'s true.', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'Endpoint security settings', height: 'auto', src: 'https://i.ibb.co/vqt40MF/endpoint-security.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'a5td0', text: 'The Intune EndPoint Protection group is included in the policy so SmartScreen will be enabled and display a warning.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'eqvfi', text: 'The Intune Help Desk Operators group is excluded from the policy so SmartScreen will be disabled so no warning will be displayed.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 87, offset: 0}], inlineStyleRanges: [], key: '1p6g1', text: 'https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
