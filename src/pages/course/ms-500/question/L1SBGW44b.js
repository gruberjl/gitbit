...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'Disable the delayed updates option for the Microsoft Defender for Identity sensors.'}, {isCorrectAnswer: false, value: 'Enable auditing in the Office 365 Security & Compliance center.'}, {isCorrectAnswer: false, value: 'Enable the delayed updates option for the Microsoft Defender for Identity sensors.'}, {isCorrectAnswer: true, value: 'Integrate the third-party SIEM solution with Microsoft Defender for identity.'}], canonical: 'https://www.gitbit.org/course/ms-500/test/microsoft-defender-1hidrpsrl/question/you-need-to-configure-the-n-qqpm0wy', id: 'L1SBGW44b', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '9bi1q', text: 'Your organization has an on-premises Active Directory domain that runs Windows Server 2022 servers and has advanced auditing enabled. Your organization is already collecting the servers\' security logs using a third-party SIEM solution.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '7e2p1', text: 'Your organization has purchased a Microsoft 365 tenant and your manager has asked you to deploy Microsoft Defender for identity by using standalone sensors.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'ckv72', text: 'You need to configure the Defender for Identity standalone sensor to detect when certain sensitive groups are updated and any time malicious services are created.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '5jeqb', text: 'How can you fulfill your manager\'s request?', type: 'unstyled'}], entityMap: {}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '5ild6', text: 'You\'ll need to integrate a SIEM and Defender for Identity when you\'re using a third-party SIEM solution and you want Defender for Identity to detect when sensitive groups are modified and when malicious services are created. In short, anytime you want Defender for Identity to alert when the SIEM solution picks up an issue.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 90, offset: 0}], inlineStyleRanges: [], key: 'bkm9o', text: 'https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 92, offset: 0}], inlineStyleRanges: [], key: '6vb60', text: 'https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding ', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-event-forwarding'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
