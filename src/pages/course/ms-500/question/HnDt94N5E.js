...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com"}}},"blocks":[{"text":"To block URLs: Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Tenant Allow/Block List > URLs > Block. Add the URL to the \"Add URLs with wildcards\" section. Set the Remove block entry after to the number of days to block the URL. Click Add.","depth":0,"type":"unstyled","entityRanges":[],"data":{},"key":"c5kns","inlineStyleRanges":[]},{"key":"b5702","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"text":"To set up tracking: Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Safe links > Global settings. Disable Do not track when users click protected links in Office 365 apps. Click Save.","type":"unstyled"},{"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","depth":0,"inlineStyleRanges":[],"key":"5s5au","data":{},"type":"unstyled","entityRanges":[{"length":105,"key":0,"offset":0}]},{"text":"https://www.iorad.com/player/1797489/MS-500---Block-access-to-a-domain-named-fabrikam-com","type":"unstyled","inlineStyleRanges":[],"key":"bpoog","depth":0,"entityRanges":[{"key":1,"length":89,"offset":0}],"data":{}}]},"question":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"text":"You've been tasked with updating the safe links policy. Your manager gives you the following 2 requirements:","key":"2p2s2","type":"unstyled","depth":0,"data":{}},{"entityRanges":[],"inlineStyleRanges":[],"key":"93qsd","data":{},"type":"unordered-list-item","text":"Block any access to the GitBit.org domain","depth":0},{"inlineStyleRanges":[],"entityRanges":[],"text":"Track user clicks on any links to gitbit.org.","key":"8b4p7","data":{},"type":"unordered-list-item","depth":0},{"entityRanges":[],"key":"42lo8","depth":0,"type":"unstyled","data":{},"text":"What steps need to be completed to fulfill the requirements?","inlineStyleRanges":[]}],"entityMap":{}},"answers":[{"value":"Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Tenant Allow/Block List > URLs > Block. Add the URL to the \"Add URLs with wildcards\" section. Set the Remove block entry after to the number of days to block the URL. Click Add.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, go to safe links > add the link to the blocked list."},{"isCorrectAnswer":false,"value":"From the Microsoft Compliance admin center go to Data Loss Prevention > add the link to the blocked list."},{"value":"Go to Microsoft 365 Defender admin center > Policies & rules > Threat policies > Safe links > Global settings. Uncheck Do not track when users click protected links in Office 365 apps","isCorrectAnswer":true}],"id":"HnDt94N5E"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/HnDt94N5E',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
