...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Open Microsoft 365 admin center. Go to Users > Active Users > Multi-factor authentication. Click the user. Click Enable.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Open Azure AD admin center. Go to Users > Active Users > Multi-factor authentication. Click the user. Click Enable."},{"value":"Open Endpoint admin center. Go to Users > Active Users > Multi-factor authentication. Click the user. Click Enable.","isCorrectAnswer":false}],"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1797275/MS-500---How-to-enable-MFA-for-a-single-user"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"entityRanges":[{"offset":0,"key":0,"length":128}],"depth":0,"key":"68vch","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk","data":{},"type":"unstyled"},{"entityRanges":[{"length":81,"key":1,"offset":0}],"type":"unstyled","text":"https://www.iorad.com/player/1797275/MS-500---How-to-enable-MFA-for-a-single-user","data":{},"depth":0,"inlineStyleRanges":[],"key":"7g1qc"},{"key":"8hnp0","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[],"type":"ordered-list-item","text":"Open the Microsoft 365 admin center."},{"data":{},"text":"Go to Users > Active Users > Multi-factor authentication.","depth":0,"key":"c1782","entityRanges":[],"inlineStyleRanges":[],"type":"ordered-list-item"},{"data":{},"key":"63mac","type":"ordered-list-item","text":"Click the user.","inlineStyleRanges":[],"entityRanges":[],"depth":0},{"inlineStyleRanges":[],"data":{},"text":"Click Enable / enforce.","entityRanges":[],"type":"ordered-list-item","key":"fc25c","depth":0}]},"question":{"entityMap":{},"blocks":[{"text":"Your organization has a Microsoft 365 but doesn't have the Azure AD premium licenses.","data":{},"inlineStyleRanges":[],"key":"aa2i5","depth":0,"entityRanges":[],"type":"unstyled"},{"entityRanges":[],"data":{},"type":"unstyled","key":"kn2b","depth":0,"inlineStyleRanges":[],"text":"Your manager has asked you to configure MFA on John's user account. You need to ensure John has to use MFA for all authentication requests."},{"key":"11aed","inlineStyleRanges":[{"style":"color-rgb(33,37,41)","offset":0,"length":40},{"length":40,"style":"bgcolor-rgb(255,255,255)","offset":0},{"offset":0,"style":"fontsize-16","length":40},{"offset":0,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":40}],"data":{},"depth":0,"type":"unstyled","text":"What should you do to complete the task?","entityRanges":[]}]},"id":"iwmb-b0C2"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/iwmb-b0C2',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
