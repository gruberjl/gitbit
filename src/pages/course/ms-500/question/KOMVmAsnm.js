...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {references: {blocks: [{data: {}, entityRanges: [{offset: 0, length: 128, key: 0}], type: 'unstyled', inlineStyleRanges: [], key: 'ea82g', text: 'https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI', depth: 0}, {key: 'asa84', text: 'https://www.iorad.com/player/1797740/MS-500---Allow-sharing-invitations-to-be-sent-only-to-users-in-an-email-domain', entityRanges: [{key: 1, offset: 0, length: 115}], data: {}, inlineStyleRanges: [], type: 'unstyled', depth: 0}, {type: 'ordered-list-item', inlineStyleRanges: [], depth: 0, data: {}, entityRanges: [], key: '7fj7f', text: 'Open the SharePoint admin center > Policies > Sharing > More external sharing settings > Limit external sharing by domain > Add domains > Allow only specific domains > Set the domain you want to allow > Save.'}], entityMap: {0: {mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI'}, type: 'LINK'}, 1: {mutability: 'MUTABLE', type: 'LINK', data: {url: 'https://www.iorad.com/player/1797740/MS-500---Allow-sharing-invitations-to-be-sent-only-to-users-in-an-email-domain', targetOption: '_blank'}}}}, question: {entityMap: {}, blocks: [{data: {}, text: 'Your manager discovers that users are sharing Microsoft SharePoint files and content with external people.', inlineStyleRanges: [], type: 'unstyled', key: '8ljgq', depth: 0, entityRanges: []}, {type: 'unstyled', text: 'He has asked you to block sharing invitations to any external users except users from gitbit.org.', entityRanges: [], key: '7lh6a', depth: 0, data: {}, inlineStyleRanges: []}, {entityRanges: [], key: 'al911', text: 'How do you complete the task?', data: {}, inlineStyleRanges: [{style: 'color-rgb(33,37,41)', offset: 0, length: 29}, {style: 'bgcolor-rgb(255,255,255)', length: 29, offset: 0}, {style: 'fontsize-16', offset: 0, length: 29}, {style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji', length: 29, offset: 0}], type: 'unstyled', depth: 0}]}, answers: [{isCorrectAnswer: true, value: 'From the SharePoint admin center > Policies > Sharing > Select More external sharing settings'}, {value: 'From the Microsoft 365 admin center > Policies > Sharing > Select More external sharing settings', isCorrectAnswer: false}, {value: 'From the Azure AD admin center > Sharing > Select More external sharing settings', isCorrectAnswer: false}], id: 'KOMVmAsnm'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
