...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"KOMVmAsnm","references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"url":"https://www.iorad.com/player/1797740/MS-500---Allow-sharing-invitations-to-be-sent-only-to-users-in-an-email-domain","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"type":"unstyled","key":"ea82g","entityRanges":[{"length":128,"offset":0,"key":0}],"inlineStyleRanges":[],"data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI"},{"depth":0,"type":"unstyled","entityRanges":[{"length":115,"key":1,"offset":0}],"text":"https://www.iorad.com/player/1797740/MS-500---Allow-sharing-invitations-to-be-sent-only-to-users-in-an-email-domain","inlineStyleRanges":[],"key":"asa84","data":{}},{"depth":0,"inlineStyleRanges":[],"text":"Open the SharePoint admin center > Policies > Sharing > More external sharing settings > Limit external sharing by domain > Add domains > Allow only specific domains > Set the domain you want to allow > Save.","entityRanges":[],"type":"ordered-list-item","data":{},"key":"7fj7f"}]},"question":{"entityMap":{},"blocks":[{"text":"Your manager discovers that users are sharing Microsoft SharePoint files and content with external people.","depth":0,"type":"unstyled","data":{},"key":"8ljgq","entityRanges":[],"inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"He has asked you to block sharing invitations to any external users except users from gitbit.org.","type":"unstyled","key":"7lh6a","depth":0,"entityRanges":[],"data":{}},{"key":"al911","inlineStyleRanges":[{"length":29,"offset":0,"style":"color-rgb(33,37,41)"},{"offset":0,"style":"bgcolor-rgb(255,255,255)","length":29},{"offset":0,"style":"fontsize-16","length":29},{"offset":0,"length":29,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"type":"unstyled","data":{},"entityRanges":[],"text":"How do you complete the task?","depth":0}]},"answers":[{"isCorrectAnswer":true,"value":"From the SharePoint admin center > Policies > Sharing > Select More external sharing settings"},{"isCorrectAnswer":false,"value":"From the Microsoft 365 admin center > Policies > Sharing > Select More external sharing settings"},{"value":"From the Azure AD admin center > Sharing > Select More external sharing settings","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/KOMVmAsnm',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
