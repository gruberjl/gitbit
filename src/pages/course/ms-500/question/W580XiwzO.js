...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"key":"3mim0","text":"\"Admins need to be informed when the Security administrator role is activated\" is located under the Roles section.","depth":0,"type":"unstyled","data":{}},{"entityRanges":[],"data":{},"inlineStyleRanges":[{"offset":0,"style":"color-rgb(33,37,41)","length":114},{"style":"bgcolor-rgb(255,255,255)","length":114,"offset":0},{"offset":0,"style":"fontsize-16","length":114},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":114,"offset":0}],"key":"2or5v","text":"\"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days\" is located in the Access reviews section.","type":"unstyled","depth":0},{"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"key":0,"length":94,"offset":0}],"key":"57ek3","depth":0,"data":{}},{"inlineStyleRanges":[],"entityRanges":[{"key":1,"offset":0,"length":137}],"depth":0,"data":{},"type":"unstyled","text":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-configure-security-alerts?tabs=new","key":"75s50"},{"key":"5pn4h","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[{"length":135,"key":2,"offset":0}],"text":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-change-default-settings?tabs=new","type":"unstyled"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"}},"1":{"data":{"url":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-configure-security-alerts?tabs=new","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"2":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/bs-latn-ba/azure/active-directory/privileged-identity-management/pim-how-to-change-default-settings?tabs=new"}}}},"question":{"blocks":[{"key":"dpurb","data":{},"inlineStyleRanges":[],"type":"unstyled","text":"Your organization has a Microsoft 365 tenant.","entityRanges":[],"depth":0},{"data":{},"text":"Your manager has asked you to re-configure the Microsoft 365 tenant to meet the following security requirements:","inlineStyleRanges":[],"type":"unstyled","key":"f4ag1","depth":0,"entityRanges":[]},{"data":{},"depth":0,"key":"5sdi4","text":"Admins need to be informed when the Security administrator role is activated.","type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[]},{"key":"a2d7n","inlineStyleRanges":[],"type":"unordered-list-item","entityRanges":[],"depth":0,"data":{},"text":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days."},{"depth":0,"data":{},"key":"s219","text":"Which Azure AD PIM setting should you re-configure to meet the security requirements.","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{}},"id":"W580XiwzO","answers":[{"isCorrectAnswer":false,"value":"Admins need to be informed when the Security administrator role is activated: Alerts"},{"value":"Admins need to be informed when the Security administrator role is activated: Roles","isCorrectAnswer":true},{"value":"Admins need to be informed when the Security administrator role is activated: Access reviews","isCorrectAnswer":false},{"value":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days: Alerts","isCorrectAnswer":false},{"value":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days: Roles","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Users assigned the Security Administrator role need to be automatically removed if they don't log in for 30 days: Access reviews"}]},
      previousQuestionId: '',
      nextQuestionId: '',
