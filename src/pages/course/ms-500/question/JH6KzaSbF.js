...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {id: 'JH6KzaSbF', references: {blocks: [{key: '9rpkj', entityRanges: [{length: 116, key: 0, offset: 0}], inlineStyleRanges: [], type: 'unstyled', depth: 0, data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/Locking-down-your-Microsoft-365-tenant-from-Microsoft-engineers-FldNualGC'}, {entityRanges: [], key: 'b5ukr', text: 'Lockbox requests will appear in the Microsoft 365 admin center in the Customer lockbox requests section.', data: {}, depth: 0, inlineStyleRanges: [], type: 'unstyled'}], entityMap: {0: {type: 'LINK', mutability: 'MUTABLE', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Locking-down-your-Microsoft-365-tenant-from-Microsoft-engineers-FldNualGC', targetOption: '_blank'}}}}, answers: [{isCorrectAnswer: false, value: 'The Supervision section in the Microsoft Defender admin center'}, {isCorrectAnswer: true, value: 'The Customer lockbox requests section in the Microsoft 365 admin center'}, {value: 'The Security & privacy section in the Microsoft 365 admin center', isCorrectAnswer: false}, {value: 'The Data subject requests in the Microsoft Compliance admin center', isCorrectAnswer: false}], question: {entityMap: {}, blocks: [{key: '6u0kf', depth: 0, text: 'Where can you go to approve Customer Lockbox requests?', inlineStyleRanges: [], entityRanges: [], data: {}, type: 'unstyled'}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
