...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: true, value: 'Configure security extensions from the Microsoft Defender for Cloud Apps admin center.'}, {isCorrectAnswer: false, value: 'Configure app connectors from the Microsoft Defender for Cloud Apps admin center.'}, {isCorrectAnswer: false, value: 'Configure log collectors from the Microsoft Defender for Cloud Apps admin center.'}, {isCorrectAnswer: false, value: 'Add and configure a data connector from the Microsoft 365 compliance center.'}], canonical: 'https://www.gitbit.org/course/ms-500/test/auditing-sign-ins-and-microsoft-sentinel-g8uabkfyn/question/manage-incidents-based-on-5lehjwztz', id: 's5U75TtHC', question: {blocks: [{data: {'text-align': 'start'}, depth: 0, entityRanges: [], inlineStyleRanges: [{length: 68, offset: 0, style: 'color-rgb(33,37,41)'}, {length: 68, offset: 0, style: 'bgcolor-rgb(255,255,255)'}, {length: 68, offset: 0, style: 'fontsize-16'}, {length: 68, offset: 0, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}], key: 'eo99v', text: 'You have a Microsoft 365 tenant with a Microsoft Sentinel workspace.', type: 'unstyled'}, {data: {'text-align': 'start'}, depth: 0, entityRanges: [], inlineStyleRanges: [{length: 147, offset: 0, style: 'color-rgb(33,37,41)'}, {length: 147, offset: 0, style: 'bgcolor-rgb(255,255,255)'}, {length: 147, offset: 0, style: 'fontsize-16'}, {length: 147, offset: 0, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}], key: '395he', text: 'You\'ve been asked by your manager to configure Microsoft 365 so you can manage incidents based on alerts generated by Microsoft Cloud App Security. ', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '9qkfk', text: 'What do you need to do first?', type: 'unstyled'}], entityMap: {}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'am0mr', text: 'If you need to manage incidents based on alerts generated by Microsoft Cloud App Security we\'ll need to create a security extension in Microsoft Defender for the Cloud Apps admin center.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 136, offset: 0}], inlineStyleRanges: [], key: '511vb', text: 'https://www.gitbit.org/course/ms-500/learn/Collect-detect-investigate-and-respond-to-security-threats-using-Microsoft-Sentinel-LEyZMWBSt', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 65, offset: 0}], inlineStyleRanges: [], key: '9iipa', text: 'https://docs.microsoft.com/en-us/cloud-app-security/siem-sentinel', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Collect-detect-investigate-and-respond-to-security-threats-using-Microsoft-Sentinel-LEyZMWBSt'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/cloud-app-security/siem-sentinel'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
