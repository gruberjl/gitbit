...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'Security & Compliance permissions'}, {isCorrectAnswer: true, value: 'Microsoft Azure Active Directory (Azure AD) Privileged Identity Management'}, {isCorrectAnswer: false, value: 'Microsoft Azure AD group management'}, {isCorrectAnswer: false, value: 'Microsoft Office 365 user management'}], canonical: 'https://www.gitbit.orghttp://localhost:8000/course/ms-500/test/configure-and-manage-multi-factor-authentication-mfa-yjeapbng4/question/ensure-that-users-who-are-x7lqlgfgm', id: 'cBoGrr-cI', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'a4cb5', text: 'You have a Microsoft 365 E5 subscription.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'dpks2', text: 'You need to ensure that users who are assigned the Exchange administrator role have time-limited permissions and must use multi-factor authentication (MFA) to request the permissions.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'a87ai', text: 'What should you use to achieve the goal?', type: 'unstyled'}], entityMap: {}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '9tu95', text: 'Microsoft Azure Active Directory (Azure AD) Privileged Identity Management is where you set up time-limited permissions.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 124, offset: 0}], inlineStyleRanges: [], key: 'duvjh', text: 'https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
