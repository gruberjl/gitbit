...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"text":"Microsoft Azure Active Directory (Azure AD) Privileged Identity Management is where you set up time-limited permissions.","key":"9tu95","entityRanges":[],"depth":0,"inlineStyleRanges":[],"type":"unstyled","data":{}},{"text":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s","data":{},"inlineStyleRanges":[],"type":"unstyled","key":"duvjh","depth":0,"entityRanges":[{"key":0,"length":124,"offset":0}]}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Just-in-time-approval-and-notification-for-admin-roles-in-Microsoft-365-RHW1API2s"},"mutability":"MUTABLE"}}},"answers":[{"isCorrectAnswer":false,"value":"Security & Compliance permissions"},{"isCorrectAnswer":true,"value":"Microsoft Azure Active Directory (Azure AD) Privileged Identity Management"},{"value":"Microsoft Azure AD group management","isCorrectAnswer":false},{"value":"Microsoft Office 365 user management","isCorrectAnswer":false}],"question":{"blocks":[{"depth":0,"data":{},"key":"a4cb5","text":"You have a Microsoft 365 E5 subscription.","type":"unstyled","entityRanges":[],"inlineStyleRanges":[]},{"data":{},"depth":0,"inlineStyleRanges":[],"key":"dpks2","entityRanges":[],"text":"You need to ensure that users who are assigned the Exchange administrator role have time-limited permissions and must use multi-factor authentication (MFA) to request the permissions.","type":"unstyled"},{"type":"unstyled","key":"a87ai","text":"What should you use to achieve the goal?","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}},"id":"cBoGrr-cI"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
      questionText: `You have a Microsoft 365 E5 subscription. You need to ensure that users who are assigned the Exchange administrator role have time-limited permissions and must use multi-factor authentication (MFA) to request the permissions. What should you use to achieve the goal?`,
      referencesHtml: `<p>Microsoft Azure Active Directory (Azure AD) Privileged Identity Management is where you set up time-limited permissions.</p>
