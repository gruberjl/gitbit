...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {id: 'InQ53ABi0', references: {blocks: [{entityRanges: [], type: 'unstyled', text: 'To delegate permissions to a set of devices in Defender for Endpoint you need to do 3 things:', depth: 0, key: '18lg0', data: {}, inlineStyleRanges: []}, {entityRanges: [], inlineStyleRanges: [], text: 'Create a device group to specify the devices that will be delegated.', data: {}, depth: 0, key: 'fkce2', type: 'unordered-list-item'}, {inlineStyleRanges: [], type: 'unordered-list-item', data: {}, key: '62cah', entityRanges: [], depth: 0, text: 'Create a user group to specify who can manage the devices.'}, {type: 'unordered-list-item', entityRanges: [], depth: 0, inlineStyleRanges: [], text: 'Create a role to specify what the users can do.', key: '31ir5', data: {}}, {text: 'https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T', entityRanges: [{offset: 0, key: 0, length: 129}], key: '7sh1n', data: {}, depth: 0, inlineStyleRanges: [], type: 'unstyled'}], entityMap: {0: {data: {url: 'https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T', targetOption: '_blank'}, type: 'LINK', mutability: 'MUTABLE'}}}, answers: [{value: 'Go to the Microsoft Azure admin center and create an Azure AD group. Go to the Microsoft Defender admin center and create a role. Then configure the permissions for DeviceGroupA.', isCorrectAnswer: true}, {isCorrectAnswer: false, value: 'Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Defender Security center and configure the permissions for DeviceGroupA. Go to the Microsoft Azure AD admin center and create an Azure AD group.'}, {isCorrectAnswer: false, value: 'Go to the Microsoft Defender Security center and create a role. Go to the Microsoft Azure AD admin center and create an Azure AD group. Go to the Microsoft Defender admin center and configure the permissions for DeviceGroupA.'}], question: {entityMap: {}, blocks: [{depth: 0, entityRanges: [], inlineStyleRanges: [], type: 'unstyled', data: {}, text: 'Your organization has a Microsoft 365 tenant with all computers running Windows 10 and are onboarded to Microsoft Defender for Endpoint.', key: '5b1fh'}, {type: 'unstyled', inlineStyleRanges: [], text: 'Your organization has a device group named DeviceGroupA.', key: '72tpa', depth: 0, data: {}, entityRanges: []}, {text: 'Your manager has asked you to enable delegation for the security settings of the devices in DeviceGroupA.', depth: 0, type: 'unstyled', key: '8lp0l', entityRanges: [], data: {}, inlineStyleRanges: [{length: 12, offset: 92, style: 'color-rgb(33,37,41)'}, {style: 'bgcolor-rgb(255,255,255)', length: 12, offset: 92}, {length: 12, offset: 92, style: 'fontsize-16'}, {style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji', length: 12, offset: 92}]}, {type: 'unstyled', text: 'What do you need to do?', data: {}, inlineStyleRanges: [], entityRanges: [], key: '4v18a', depth: 0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
