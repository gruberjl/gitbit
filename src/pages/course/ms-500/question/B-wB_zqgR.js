...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{value: 'Synchronization Service Manager', isCorrectAnswer: true}, {value: 'Azure AD Connect wizard', isCorrectAnswer: false}, {isCorrectAnswer: false, value: 'Synchronization Rules Editor'}, {value: 'IdFix', isCorrectAnswer: false}], question: {entityMap: {}, blocks: [{depth: 0, entityRanges: [], inlineStyleRanges: [], text: 'The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.', key: '4ufo4', type: 'unstyled', data: {}}, {text: 'The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.', inlineStyleRanges: [], key: 'c4img', entityRanges: [], data: {}, type: 'unstyled', depth: 0}, {text: 'GitBit identifies the following issues:', data: {}, type: 'unstyled', key: '45i9j', entityRanges: [], depth: 0, inlineStyleRanges: []}, {entityRanges: [], depth: 0, inlineStyleRanges: [], key: 'fe0i', text: 'Since last Friday, the IT team has been receiving automated email messages that contain "Unhealthy Identity Synchronization Notification" in the subject line.', data: {}, type: 'unordered-list-item'}, {inlineStyleRanges: [], type: 'unordered-list-item', depth: 0, key: 'aa9gq', entityRanges: [], data: {}, text: 'Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.'}, {data: {}, entityRanges: [], text: 'You need to resolve the issue that generates the automated email messages to the IT team.', type: 'unstyled', key: '8ofra', depth: 0, inlineStyleRanges: []}, {key: '96grf', inlineStyleRanges: [], type: 'unstyled', text: 'Which tool should you run first?', depth: 0, entityRanges: [], data: {}}]}, id: 'B-wB_zqgR', references: {blocks: [{key: '7fdiu', inlineStyleRanges: [], data: {}, entityRanges: [], type: 'unstyled', text: 'To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you\'ll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.', depth: 0}, {key: '1sh5q', type: 'unstyled', text: 'https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P', inlineStyleRanges: [], entityRanges: [{offset: 0, key: 0, length: 69}], data: {}, depth: 0}], entityMap: {0: {mutability: 'MUTABLE', type: 'LINK', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P', targetOption: '_blank'}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
