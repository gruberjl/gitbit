...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Synchronization Service Manager","isCorrectAnswer":true},{"value":"Azure AD Connect wizard","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Synchronization Rules Editor"},{"isCorrectAnswer":false,"value":"IdFix"}],"id":"B-wB_zqgR","question":{"blocks":[{"inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{},"entityRanges":[],"text":"The network contains an Active Directory forest named gitbit.org. GitBit has a hybrid Microsoft Azure Active Directory (Azure AD) environment.","key":"4ufo4"},{"inlineStyleRanges":[],"text":"The company maintains some on-premises servers for specific applications, but most end-user applications are provided by a Microsoft 365 E5 subscription.","entityRanges":[],"depth":0,"key":"c4img","data":{},"type":"unstyled"},{"depth":0,"entityRanges":[],"type":"unstyled","text":"GitBit identifies the following issues:","inlineStyleRanges":[],"data":{},"key":"45i9j"},{"entityRanges":[],"text":"Since last Friday, the IT team has been receiving automated email messages that contain \"Unhealthy Identity Synchronization Notification\" in the subject line.","data":{},"type":"unordered-list-item","depth":0,"key":"fe0i","inlineStyleRanges":[]},{"entityRanges":[],"text":"Several users recently opened email attachments that contained malware. The process to remove the malware was time-consuming.","key":"aa9gq","depth":0,"data":{},"type":"unordered-list-item","inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"You need to resolve the issue that generates the automated email messages to the IT team.","data":{},"depth":0,"entityRanges":[],"type":"unstyled","key":"8ofra"},{"text":"Which tool should you run first?","depth":0,"type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[],"key":"96grf"}],"entityMap":{}},"references":{"blocks":[{"inlineStyleRanges":[],"data":{},"entityRanges":[],"depth":0,"key":"7fdiu","text":"To review the error in more detail log on to the server that has the AD Connect service running then open the Synchronization Service Manager application. From there you'll see one of the profiles with a status of Completed-export-error. Click on it. Then click the error (in the bottom right corner. Click Detail. You can also click the CN=GUID to view the account that changed and what attributes have changed.","type":"unstyled"},{"type":"unstyled","depth":0,"key":"1sh5q","data":{},"inlineStyleRanges":[],"entityRanges":[{"length":69,"offset":0,"key":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/B-wB_zqgR',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
