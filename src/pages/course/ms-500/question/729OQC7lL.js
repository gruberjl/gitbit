...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Security & Compliance admin center, create a label policy","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From Exchange Online PowerShell, run Start-RetentionAutoTagLearning"},{"value":"From Exchange Online PowerShell, run Start-ManagedFolderAssistant","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Security & Compliance admin center, create a data loss prevention (DLP) policy"}],"question":{"blocks":[{"text":"You have a Microsoft 365 subscription.","depth":0,"inlineStyleRanges":[],"key":"63nes","data":{},"type":"unstyled","entityRanges":[]},{"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"key":"670mu","depth":0,"data":{},"text":"Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes."},{"key":"3jhv4","data":{},"text":"You need to ensure that the labels will be available for manual assignment as soon as possible.","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0},{"data":{},"type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"4qe14","text":"What should you do?"}],"entityMap":{}},"id":"729OQC7lL","references":{"blocks":[{"data":{},"depth":0,"text":"Run the following PowerShell Command: \"Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike \"DiscoverySearchMailbox*\"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }\"","type":"unstyled","key":"cug0","inlineStyleRanges":[],"entityRanges":[]},{"text":"Note: If you only need to publish the labels to one user immediately you can use \"Start-ManagedFolderAssistant UPN\" and replace UPN with the user's sign-in name","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"key":"4ce7u","depth":0},{"entityRanges":[{"key":0,"length":114,"offset":0}],"type":"unstyled","data":{},"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","key":"63al3","depth":0},{"data":{},"inlineStyleRanges":[],"key":"9t9k7","text":"https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps","depth":0,"type":"unstyled","entityRanges":[{"offset":0,"key":1,"length":105}]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '729OQC7lL',
      questionIdx: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/729OQC7lL',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
