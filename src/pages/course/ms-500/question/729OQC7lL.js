...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {id: '729OQC7lL', question: {blocks: [{text: 'You have a Microsoft 365 subscription.', key: '63nes', type: 'unstyled', entityRanges: [], depth: 0, data: {}, inlineStyleRanges: []}, {data: {}, entityRanges: [], key: '670mu', depth: 0, type: 'unstyled', text: 'Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes.', inlineStyleRanges: []}, {text: 'You need to ensure that the labels will be available for manual assignment as soon as possible.', entityRanges: [], type: 'unstyled', key: '3jhv4', data: {}, inlineStyleRanges: [], depth: 0}, {data: {}, inlineStyleRanges: [], key: '4qe14', text: 'What should you do?', type: 'unstyled', entityRanges: [], depth: 0}], entityMap: {}}, references: {entityMap: {0: {mutability: 'MUTABLE', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f', targetOption: '_blank'}, type: 'LINK'}, 1: {mutability: 'MUTABLE', type: 'LINK', data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp'}}}, blocks: [{data: {}, text: 'Run the following PowerShell Command: "Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike "DiscoverySearchMailbox*"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }"', key: 'cug0', type: 'unstyled', depth: 0, entityRanges: [], inlineStyleRanges: []}, {data: {}, text: 'Note: If you only need to publish the labels to one user immediately you can use "Start-ManagedFolderAssistant UPN" and replace UPN with the user\'s sign-in name', depth: 0, inlineStyleRanges: [], type: 'unstyled', key: '4ce7u', entityRanges: []}, {data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f', depth: 0, entityRanges: [{key: 0, offset: 0, length: 114}], type: 'unstyled', key: '63al3', inlineStyleRanges: []}, {key: '9t9k7', entityRanges: [{key: 1, length: 105, offset: 0}], depth: 0, inlineStyleRanges: [], type: 'unstyled', data: {}, text: 'https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps'}]}, answers: [{isCorrectAnswer: false, value: 'From the Security & Compliance admin center, create a label policy'}, {isCorrectAnswer: false, value: 'From Exchange Online PowerShell, run Start-RetentionAutoTagLearning'}, {isCorrectAnswer: true, value: 'From Exchange Online PowerShell, run Start-ManagedFolderAssistant'}, {value: 'From the Security & Compliance admin center, create a data loss prevention (DLP) policy', isCorrectAnswer: false}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
