...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {id: '729OQC7lL', answers: [{value: 'From the Security & Compliance admin center, create a label policy', isCorrectAnswer: false}, {value: 'From Exchange Online PowerShell, run Start-RetentionAutoTagLearning', isCorrectAnswer: false}, {value: 'From Exchange Online PowerShell, run Start-ManagedFolderAssistant', isCorrectAnswer: true}, {value: 'From the Security & Compliance admin center, create a data loss prevention (DLP) policy', isCorrectAnswer: false}], question: {blocks: [{entityRanges: [], data: {}, type: 'unstyled', inlineStyleRanges: [], depth: 0, text: 'You have a Microsoft 365 subscription.', key: '63nes'}, {type: 'unstyled', depth: 0, data: {}, entityRanges: [], inlineStyleRanges: [], text: 'Yesterday, you created retention labels and published the labels to Microsoft Exchange Online mailboxes.', key: '670mu'}, {entityRanges: [], key: '3jhv4', type: 'unstyled', text: 'You need to ensure that the labels will be available for manual assignment as soon as possible.', inlineStyleRanges: [], data: {}, depth: 0}, {data: {}, type: 'unstyled', inlineStyleRanges: [], key: '4qe14', text: 'What should you do?', depth: 0, entityRanges: []}], entityMap: {}}, references: {blocks: [{text: 'Run the following PowerShell Command: "Get-Mailbox -ResultSize unlimited | ?{$_.Name -notlike "DiscoverySearchMailbox*"} | %{ Start-ManagedFolderAssistant $_.UserPrincipalName }"', key: 'cug0', entityRanges: [], data: {}, inlineStyleRanges: [], depth: 0, type: 'unstyled'}, {key: '4ce7u', inlineStyleRanges: [], text: 'Note: If you only need to publish the labels to one user immediately you can use "Start-ManagedFolderAssistant UPN" and replace UPN with the user\'s sign-in name', data: {}, type: 'unstyled', depth: 0, entityRanges: []}, {key: '63al3', data: {}, type: 'unstyled', text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f', inlineStyleRanges: [], entityRanges: [{length: 114, key: 0, offset: 0}], depth: 0}, {entityRanges: [{offset: 0, key: 1, length: 105}], data: {}, key: '9t9k7', text: 'https://docs.microsoft.com/en-us/powershell/module/exchange/start-managedfolderassistant?view=exchange-ps', inlineStyleRanges: [], type: 'unstyled', depth: 0}], entityMap: {0: {type: 'LINK', mutability: 'MUTABLE', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f', targetOption: '_blank'}}, 1: {mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/office365/securitycompliance/set-up-a-custom-blocked-urls-list-wtih-atp'}, type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
