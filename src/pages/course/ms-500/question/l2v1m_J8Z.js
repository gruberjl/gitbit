...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {references: {entityMap: {0: {mutability: 'MUTABLE', type: 'LINK', data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w'}}}, blocks: [{entityRanges: [], text: 'All of them will match Rule2 because it is the most restrictive.', type: 'unstyled', inlineStyleRanges: [], data: {}, key: '5t3am', depth: 0}, {entityRanges: [{length: 116, key: 0, offset: 0}], depth: 0, data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w', inlineStyleRanges: [], key: 'eu9vf', type: 'unstyled'}]}, answers: [{value: 'External users will be able to open and read File1', isCorrectAnswer: false}, {isCorrectAnswer: false, value: 'Any user in your organization can open and read File2'}, {value: 'External users will be able to open and read File3', isCorrectAnswer: false}], question: {blocks: [{depth: 0, entityRanges: [], key: '50gpj', data: {}, text: 'Your organization has a Microsoft 365 tenant with the primary domain of gitbit.org', type: 'unstyled', inlineStyleRanges: []}, {inlineStyleRanges: [], text: 'OneDrive contains the following files that are shared externally.', key: '260nn', entityRanges: [], depth: 0, type: 'unstyled', data: {}}, {depth: 0, inlineStyleRanges: [], text: ' ', entityRanges: [{length: 1, offset: 0, key: 0}], data: {}, type: 'atomic', key: 'euhdj'}, {depth: 0, text: 'You create a data loss prevention (DLP) policy and apply it to OneDrive. You configure the DLP policy with the following rules', inlineStyleRanges: [], key: 'a6paf', type: 'unstyled', data: {}, entityRanges: []}, {text: 'Rule 1:', key: '6vh9m', data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [{style: 'BOLD', length: 6, offset: 0}], type: 'unstyled'}, {entityRanges: [], key: 'bgdm7', text: 'Applies when content is marked with Label1 and shared with people outside my organization', data: {}, inlineStyleRanges: [], depth: 0, type: 'unordered-list-item'}, {entityRanges: [], key: 'e369v', inlineStyleRanges: [], data: {}, depth: 0, text: 'Restrict access by blocking people outside your organization.', type: 'unordered-list-item'}, {inlineStyleRanges: [], depth: 0, key: '7are6', entityRanges: [], type: 'unordered-list-item', data: {}, text: 'Notify the user who shared or last modified the content.'}, {text: 'Allow overrides from Microsoft 365 services.', inlineStyleRanges: [], entityRanges: [], type: 'unordered-list-item', key: 'df6nh', depth: 0, data: {}}, {entityRanges: [], type: 'unordered-list-item', data: {}, key: 'av8gm', depth: 0, inlineStyleRanges: [], text: 'Priority: 0'}, {data: {}, depth: 0, inlineStyleRanges: [{length: 5, style: 'BOLD', offset: 0}], entityRanges: [], text: 'Rule2:', type: 'unstyled', key: 'og34'}, {data: {}, depth: 0, type: 'unordered-list-item', text: 'Applies when content is marked with Label1 or Label2', inlineStyleRanges: [{length: 42, style: 'color-rgb(33,37,41)', offset: 0}, {offset: 0, length: 42, style: 'bgcolor-rgb(255,255,255)'}, {length: 42, style: 'fontsize-16', offset: 0}, {length: 42, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji', offset: 0}], key: 'cjeds', entityRanges: []}, {depth: 0, text: 'Block everyone from accessing the content excluding the owner and last modifier', type: 'unordered-list-item', inlineStyleRanges: [], key: '854sf', entityRanges: [], data: {}}, {entityRanges: [], inlineStyleRanges: [], data: {}, type: 'unordered-list-item', depth: 0, key: '3s1li', text: 'Priority: 1'}, {entityRanges: [], type: 'unstyled', text: 'Rule3:', key: '5ujn5', depth: 0, inlineStyleRanges: [{length: 5, style: 'BOLD', offset: 0}], data: {}}, {depth: 0, inlineStyleRanges: [], type: 'unordered-list-item', data: {}, entityRanges: [], key: 'f2jcf', text: 'Applies when content is marked with Label2 and shared with people outside my organization'}, {text: 'Restrict access by blocking people outside your organization. ', type: 'unordered-list-item', depth: 0, data: {'margin-left': '1.5em'}, entityRanges: [], inlineStyleRanges: [{style: 'color-rgb(33,37,41)', length: 61, offset: 0}, {offset: 0, length: 61, style: 'bgcolor-rgb(255,255,255)'}, {length: 61, offset: 0, style: 'fontsize-16'}, {style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji', offset: 0, length: 61}], key: '4rk5n'}, {key: '6lr8c', depth: 0, data: {'margin-left': '1.5em'}, text: 'Notify the user who shared or last modified the content. ', entityRanges: [], inlineStyleRanges: [{style: 'color-rgb(33,37,41)', length: 56, offset: 0}, {offset: 0, style: 'bgcolor-rgb(255,255,255)', length: 56}, {length: 56, style: 'fontsize-16', offset: 0}, {offset: 0, length: 56, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}], type: 'unordered-list-item'}, {text: 'Allow overrides from Microsoft 365 services. ', entityRanges: [], inlineStyleRanges: [{offset: 0, style: 'color-rgb(33,37,41)', length: 44}, {style: 'bgcolor-rgb(255,255,255)', length: 44, offset: 0}, {style: 'fontsize-16', offset: 0, length: 44}, {length: 44, offset: 0, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}], data: {'margin-left': '1.5em'}, key: '7iado', depth: 0, type: 'unordered-list-item'}, {data: {}, inlineStyleRanges: [], key: '1mk1m', text: 'Priority: 2', depth: 0, entityRanges: [], type: 'unordered-list-item'}, {depth: 0, key: '4p8lg', type: 'unstyled', data: {}, entityRanges: [], text: 'Check the box next to each true statement', inlineStyleRanges: []}], entityMap: {0: {type: 'IMAGE', data: {alignment: 'left', width: 'auto', height: 'auto', alt: 'Files and labels chart', src: 'https://i.ibb.co/rMYDH1g/file-labels.png'}, mutability: 'MUTABLE'}}}, id: 'l2v1m_J8Z'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
