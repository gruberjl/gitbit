...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"C29rzn6aM","answers":[{"value":"ADGroup1: User1","isCorrectAnswer":true},{"value":"ADGroup1: User2","isCorrectAnswer":true},{"isCorrectAnswer":true,"value":"ADGroup1: User3"},{"value":"ADGroup1: User4","isCorrectAnswer":true},{"isCorrectAnswer":true,"value":"ADGroup2: User1"},{"isCorrectAnswer":true,"value":"ADGroup2: User2"},{"value":"ADGroup2: User3","isCorrectAnswer":true},{"value":"ADGroup2: User4","isCorrectAnswer":true}],"question":{"blocks":[{"data":{},"entityRanges":[],"depth":0,"text":"You organization has a Microsoft 365 tenant with the following users.","key":"eb6b1","inlineStyleRanges":[],"type":"unstyled"},{"data":{},"inlineStyleRanges":[],"depth":0,"key":"b36r0","text":" ","entityRanges":[{"length":1,"key":0,"offset":0}],"type":"atomic"},{"depth":0,"data":{},"entityRanges":[],"key":"4s9rt","text":"The Microsoft 365 tenant contains the following dynamic groups.","type":"unstyled","inlineStyleRanges":[]},{"data":{},"entityRanges":[{"offset":0,"key":1,"length":1}],"inlineStyleRanges":[],"text":" ","depth":0,"type":"atomic","key":"635cj"},{"inlineStyleRanges":[],"key":"60b80","data":{},"type":"unstyled","entityRanges":[],"depth":0,"text":"Which users are members of ADGroup1 and ADGroup2?"}],"entityMap":{"0":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Users chart","alignment":"left","src":"https://i.ibb.co/r5zkJWT/Users-chart.png","height":"auto","width":"auto"}},"1":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","width":"auto","height":"auto","src":"https://i.ibb.co/R91f09F/group-membership-chart.png","alt":"Dynamic group chart"}}}},"references":{"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/enterprise-users/groups-dynamic-membership","targetOption":"_blank"}}},"blocks":[{"depth":0,"key":"b95ee","type":"unstyled","data":{},"entityRanges":[],"text":"The membership rule \"contains\" isn't case-sensitive. It matches any city that contains the chars \"sea\" so users 1 - 4 are all added.","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"data":{},"text":"The membership rule \"match\" isn't case-sensitive. It matches any city that starts with \"sea\" so users 1 - 4 are all added.","type":"unstyled","key":"7cppa","inlineStyleRanges":[]},{"type":"unstyled","entityRanges":[{"key":0,"length":95,"offset":0}],"key":"48apm","inlineStyleRanges":[],"depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV"},{"data":{},"entityRanges":[{"key":1,"offset":0,"length":98}],"key":"5k4cn","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/enterprise-users/groups-dynamic-membership","type":"unstyled","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/C29rzn6aM',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
