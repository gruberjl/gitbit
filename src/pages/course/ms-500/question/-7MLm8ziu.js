...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {question: {blocks: [{key: '3l77q', text: 'Your network contains an on-premises Active Directory domain that syncs to Azure Active Directory (Azure AD) as shown in the following exhibit.', data: {}, entityRanges: [], type: 'unstyled', inlineStyleRanges: [], depth: 0}, {data: {}, inlineStyleRanges: [], entityRanges: [{offset: 0, key: 0, length: 1}], text: ' ', depth: 0, key: '4tnb1', type: 'atomic'}, {data: {}, text: 'The synchronization schedule is configured as shown in the following exhibit.', key: 'dv9ht', inlineStyleRanges: [], type: 'unstyled', entityRanges: [], depth: 0}, {inlineStyleRanges: [], depth: 0, data: {}, key: 'bm5re', entityRanges: [{length: 1, key: 1, offset: 0}], type: 'atomic', text: ' '}, {key: 'f2iao', inlineStyleRanges: [{style: 'color-rgb(80,80,80)', length: 51, offset: 0}, {style: 'bgcolor-rgb(255,255,255)', length: 51, offset: 0}, {style: 'fontsize-16', length: 51, offset: 0}, {length: 51, style: 'fontfamily-Roboto Condensed", sans-serif', offset: 0}], data: {}, type: 'unstyled', depth: 0, text: 'Which employees can authenticate by using Azure AD?', entityRanges: []}, {depth: 0, entityRanges: [], inlineStyleRanges: [], type: 'unstyled', key: '7q87t', data: {}, text: 'What should you do to remove the warning for pass-through authentication?'}], entityMap: {0: {mutability: 'MUTABLE', data: {height: 'auto', alt: 'AD Connect Setup', width: 'auto', src: 'https://i.ibb.co/VpsjVFh/ad-connect-setup.png', alignment: 'left'}, type: 'IMAGE'}, 1: {mutability: 'MUTABLE', data: {height: 'auto', width: 'auto', alignment: 'left', src: 'https://i.ibb.co/CWcS1NP/ad-connect-status.png', alt: 'AD Connect Scheduler status'}, type: 'IMAGE'}}}, references: {entityMap: {0: {mutability: 'MUTABLE', type: 'LINK', data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P'}}}, blocks: [{type: 'unstyled', entityRanges: [], data: {}, inlineStyleRanges: [], key: 'fdm35', text: 'Users that have an Azure AD user account or a synced on-premises account can both authenticate. (Pass-through authentication does not affect cloud-only accounts)', depth: 0}, {depth: 0, entityRanges: [], key: '88p1k', data: {}, inlineStyleRanges: [], type: 'unstyled', text: 'The yellow exclamation mark is Microsoft warning you that you should have at least 2 pass-through authentication agents (in case one server fails).'}, {text: 'There\'s also an issue with the synchronization server because the last sync time is 4 hours. A sync should run every 30 minutes.', depth: 0, data: {}, inlineStyleRanges: [], key: 'ftho5', type: 'unstyled', entityRanges: []}, {key: 'e66bb', inlineStyleRanges: [], depth: 0, text: 'https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P', type: 'unstyled', entityRanges: [{key: 0, length: 69, offset: 0}], data: {}}]}, id: '-7MLm8ziu', answers: [{isCorrectAnswer: false, value: 'Only employees who have an Azure AD user account'}, {value: 'Employees who have an Azure AD user account or a synced on-premises account', isCorrectAnswer: true}, {value: 'Only employees who have a synced on-premises account', isCorrectAnswer: false}, {value: 'Fix the synchronization server and install Azure AD Connect in staging mode', isCorrectAnswer: false}, {isCorrectAnswer: true, value: 'Fix the synchronization server and install an additional authentication agent'}, {isCorrectAnswer: false, value: 'Install an additional authentication agent and run the Start-ADSyncSyncCycle cmdlet'}, {isCorrectAnswer: false, value: 'Install Azure AD Connect in staging mode and run the Start-ADSyncSyncCycle cmdlet'}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
