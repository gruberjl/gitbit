...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {question: {blocks: [{key: 'dbiq', inlineStyleRanges: [], depth: 0, entityRanges: [], data: {}, type: 'unstyled', text: 'Your network contains an on-premises Active Directory domain named contoso.com. The domain contains the groups shown in the following table.'}, {inlineStyleRanges: [], entityRanges: [{key: 0, length: 1, offset: 0}], text: ' ', data: {}, key: 'ud99', depth: 0, type: 'atomic'}, {key: '5p4qs', text: 'The domain is synced to a Microsoft Azure Active Directory (Azure AD) tenant that contains the groups shown in the following table.', data: {}, depth: 0, type: 'unstyled', entityRanges: [], inlineStyleRanges: []}, {entityRanges: [{offset: 0, key: 1, length: 1}], inlineStyleRanges: [], type: 'atomic', key: 'bvvi5', depth: 0, data: {}, text: ' '}, {entityRanges: [], data: {}, text: 'You create an Information Protection label policy named Policy1.', depth: 0, type: 'unstyled', key: 'akqei', inlineStyleRanges: []}, {depth: 0, type: 'unstyled', inlineStyleRanges: [], key: 'bmrsk', text: 'You need to apply Policy1.', entityRanges: [], data: {}}, {key: '5jrsu', data: {}, text: 'To which groups can you apply Policy1?', entityRanges: [], type: 'unstyled', depth: 0, inlineStyleRanges: []}], entityMap: {0: {mutability: 'MUTABLE', type: 'IMAGE', data: {width: 'auto', alt: 'Group Type Chart', height: 'auto', src: 'https://i.ibb.co/K9qMwTt/group-type-chart.png', alignment: 'left'}}, 1: {mutability: 'MUTABLE', type: 'IMAGE', data: {width: 'auto', alt: 'Group Type chart', src: 'https://i.ibb.co/T27s5tb/group-type-assignment-chart.png', alignment: 'left', height: 'auto'}}}}, answers: [{isCorrectAnswer: true, value: 'Group1'}, {value: 'Group2', isCorrectAnswer: false}, {isCorrectAnswer: false, value: 'Group3'}, {value: 'Group4', isCorrectAnswer: true}, {value: 'Group11', isCorrectAnswer: false}, {isCorrectAnswer: false, value: 'Group12'}, {value: 'Group13', isCorrectAnswer: true}, {value: 'Group14', isCorrectAnswer: true}], references: {blocks: [{data: {}, text: 'Labels can be applied to any group that has an email address.', key: 'fcm5p', type: 'unstyled', depth: 0, inlineStyleRanges: [], entityRanges: []}, {key: 'a5cnr', depth: 0, data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf', type: 'unstyled', inlineStyleRanges: [], entityRanges: [{key: 0, length: 103, offset: 0}]}, {entityRanges: [{offset: 0, key: 1, length: 69}], depth: 0, key: '12ibg', text: 'https://docs.microsoft.com/en-us/azure/information-protection/prepare', type: 'unstyled', data: {}, inlineStyleRanges: []}], entityMap: {0: {data: {url: 'https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf', targetOption: '_blank'}, type: 'LINK', mutability: 'MUTABLE'}, 1: {type: 'LINK', mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/azure/information-protection/prepare'}}}}, id: 'ztPrHQ9d8'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
