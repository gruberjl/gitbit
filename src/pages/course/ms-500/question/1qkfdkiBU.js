...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {"answers":[{"isCorrectAnswer":true,"value":"Privileged role administrator"},{"isCorrectAnswer":false,"value":"Compliance administrator"},{"isCorrectAnswer":false,"value":"Security administrator"},{"isCorrectAnswer":false,"value":"Global administrator"}],"canonical":"https://www.gitbit.org/course/ms-500/test/control-permissions-and-access-through-admin-roles-j9ggabtua/question/grant-ability-to-enable-a-jijxpu8ei","id":"1qkfdkiBU","question":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[{"length":75,"offset":142,"style":"color-rgb(33,37,41)"},{"length":75,"offset":142,"style":"bgcolor-rgb(255,255,255)"},{"length":75,"offset":142,"style":"fontsize-16"},{"length":75,"offset":142,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"key":"571u","text":"Your organization has hired a new admin named John Gruber. Your manager has asked you to give John Gruber the ability to enable and configure Azure AD Privileged Identity Management. Your organization adhere's to the principle of least privilege","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"543ar","text":"What role should you assign to John Gruber","type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"33tk7","text":"Privileged role administrators can enable, configure, and manage the Azure AD Privileged Identity Management. Global admins can also but using the global admin roles would break the principle of least privilege.","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[{"key":0,"length":95,"offset":0}],"inlineStyleRanges":[],"key":"f2o0a","text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU ","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[{"key":1,"length":100,"offset":0}],"inlineStyleRanges":[],"key":"2sgfr","text":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure ","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[{"key":2,"length":133,"offset":0}],"inlineStyleRanges":[],"key":"du7c","text":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator ","type":"unstyled"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/privileged-identity-management/pim-configure"},"mutability":"MUTABLE","type":"LINK"},"2":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/roles/permissions-reference?view=o365-worldwide#privileged-role-administrator"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
