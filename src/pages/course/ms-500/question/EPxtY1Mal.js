...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: true, value: 'Must change their password: User1 only'}, {isCorrectAnswer: false, value: 'Must change their password: User2 only'}, {isCorrectAnswer: false, value: 'Must change their password: Both User1 and User2'}, {isCorrectAnswer: false, value: 'Must change their password: Neither User1 nor User2'}, {isCorrectAnswer: false, value: 'Prompted for MFA: User1 only'}, {isCorrectAnswer: true, value: 'Prompted for MFA: User2 only'}, {isCorrectAnswer: false, value: 'Prompted for MFA: Both User1 and User2'}, {isCorrectAnswer: false, value: 'Prompted for MFA: Neither User1 nor User2'}], canonical: 'https://www.gitbit.org/course/ms-500/test/lockbox-risk-policies-access-review-and-jit-8awhclygp/question/what-occurs-when-user1-an-ru52ojpin', id: 'EPxtY1Mal', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'c9a3h', text: 'You have a Microsoft Azure Active Directory (Azure AD) tenant named contoso.com that contains the users shown in the following table.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: '83o7o', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'biqrr', text: 'You create and enforce an Azure AD Identity Protection user risk policy that has the following settings:', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '350er', text: 'Assignments: Include Group1, Exclude Group2', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '9unnq', text: 'Conditions: Sign-in risk of Low and above', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'g8gt', text: 'Access: Allow access, Require password change', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '90j', text: 'You need to identify how the policy affects User1 and User2.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '950ob', text: 'What occurs when User1 and User2 sign in from an unfamiliar location?', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'User, group, MFA status chart', height: 'auto', src: 'https://i.ibb.co/ctNx9tq/Chart3.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'chcdi', text: 'Unfamiliar location sign-in is considered a low risk so the user risk policy would initiate. Group1 is assigned in the user risk policy and Group2 is excluded so only User1 is affected by the policy so only User1 will be required to change their password.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'da7a5', text: 'User1 isn\'t configured for MFA but User2 is so only User2 will be prompted for MFA.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 123, offset: 0}], inlineStyleRanges: [], key: 'b542b', text: 'https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 128, offset: 0}], inlineStyleRanges: [], key: 'ag5bh', text: 'https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk ', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 2, length: 114, offset: 0}], inlineStyleRanges: [], key: 'f3bq1', text: 'https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk'}, mutability: 'MUTABLE', type: 'LINK'}, 2: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/concept-conditional-access-users-groups'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
