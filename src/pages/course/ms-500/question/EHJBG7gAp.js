...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"text":"Your organization is using Microsoft 365 and has 500 computers. You need to protect all the computers using Microsoft Defender for Endpoint. Ten of the devices are used by executives.","key":"318uf","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"data":{}},{"depth":0,"entityRanges":[],"key":"2emgs","inlineStyleRanges":[],"type":"unstyled","data":{},"text":"Your manager explains the requirements to you as follows:"},{"key":"3csrt","data":{},"inlineStyleRanges":[],"type":"unordered-list-item","text":"Administrators must manually approve all remediation for any of the executives.","entityRanges":[],"depth":0},{"entityRanges":[],"key":"92bbm","text":"All other users must have remediation performed automatically.","data":{},"inlineStyleRanges":[],"depth":0,"type":"unordered-list-item"},{"entityRanges":[],"data":{},"type":"unstyled","key":"4qvot","depth":0,"inlineStyleRanges":[],"text":"What should you recommend?"}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-atp/machine-groups-windows-defender-advanced-threat-protection","targetOption":"_blank"}}},"blocks":[{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"data":{},"text":"You'll need two machine groups. One for the automated remediation and the other for manual approval.","key":"agnug","depth":0},{"type":"unstyled","inlineStyleRanges":[],"key":"3270o","entityRanges":[{"offset":0,"key":0,"length":129}],"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T","depth":0,"data":{}},{"type":"unstyled","depth":0,"inlineStyleRanges":[],"data":{},"key":"46q9a","entityRanges":[{"key":1,"offset":0,"length":147}],"text":"https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-atp/machine-groups-windows-defender-advanced-threat-protection"}]},"answers":[{"value":"Configure 10 device exclusions on the automation lists.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Create two alert notification policies."},{"isCorrectAnswer":false,"value":"Download and run the offboarding package for the executives' computers."},{"isCorrectAnswer":true,"value":"Create two machine groups in Microsoft Defender admin center."}],"id":"EHJBG7gAp"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/EHJBG7gAp',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
