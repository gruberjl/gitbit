...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'Configure 10 device exclusions on the automation lists.'}, {value: 'Create two alert notification policies.', isCorrectAnswer: false}, {isCorrectAnswer: false, value: 'Download and run the offboarding package for the executives\' computers.'}, {value: 'Create two machine groups in Microsoft Defender admin center.', isCorrectAnswer: true}], references: {entityMap: {0: {mutability: 'MUTABLE', type: 'LINK', data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T'}}, 1: {type: 'LINK', mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-atp/machine-groups-windows-defender-advanced-threat-protection'}}}, blocks: [{text: 'You\'ll need two machine groups. One for the automated remediation and the other for manual approval.', entityRanges: [], key: 'agnug', data: {}, inlineStyleRanges: [], type: 'unstyled', depth: 0}, {entityRanges: [{length: 129, key: 0, offset: 0}], depth: 0, data: {}, key: '3270o', text: 'https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T', inlineStyleRanges: [], type: 'unstyled'}, {text: 'https://docs.microsoft.com/en-us/windows/security/threat-protection/windows-defender-atp/machine-groups-windows-defender-advanced-threat-protection', depth: 0, key: '46q9a', type: 'unstyled', inlineStyleRanges: [], entityRanges: [{length: 147, offset: 0, key: 1}], data: {}}]}, question: {entityMap: {}, blocks: [{type: 'unstyled', entityRanges: [], key: '318uf', depth: 0, data: {}, inlineStyleRanges: [], text: 'Your organization is using Microsoft 365 and has 500 computers. You need to protect all the computers using Microsoft Defender for Endpoint. Ten of the devices are used by executives.'}, {data: {}, text: 'Your manager explains the requirements to you as follows:', type: 'unstyled', depth: 0, inlineStyleRanges: [], entityRanges: [], key: '2emgs'}, {entityRanges: [], data: {}, key: '3csrt', text: 'Administrators must manually approve all remediation for any of the executives.', depth: 0, type: 'unordered-list-item', inlineStyleRanges: []}, {data: {}, type: 'unordered-list-item', inlineStyleRanges: [], entityRanges: [], text: 'All other users must have remediation performed automatically.', key: '92bbm', depth: 0}, {text: 'What should you recommend?', entityRanges: [], data: {}, depth: 0, key: '4qvot', type: 'unstyled', inlineStyleRanges: []}]}, id: 'EHJBG7gAp'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
