...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {"answers":[{"isCorrectAnswer":false,"value":"Directory Service event logs"},{"isCorrectAnswer":false,"value":"Security event log"},{"isCorrectAnswer":true,"value":"Application event log"},{"isCorrectAnswer":false,"value":"System event log"}],"canonical":"https://www.gitbit.org/course/ms-500/test/adconnect-lg2mr5_z0/question/what-location-can-you-use-tots2lcqv","id":"4ZOQ3D2xd","question":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"24ut7","text":"Your organization has an Active Directory domain named gitbit.org. You've installed Azure AD Connect on ServerA which is a server running Windows 2016.","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"43e0t","text":"There's an error syncing user accounts from your on-premises AD to Microsoft 365.","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"4f9bd","text":"You've been tasked with resolving the error. To start, you RDP to ServerA and open the Directory Service event logs.","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"6rnh3","text":"What location can you use to troubleshoot the AD Connect sync errors?","type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[{"length":87,"offset":56,"style":"color-rgb(33,37,41)"},{"length":87,"offset":56,"style":"bgcolor-rgb(255,255,255)"},{"length":87,"offset":56,"style":"fontsize-16"},{"length":87,"offset":56,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji"}],"key":"cj3ba","text":"Troubleshooting AD Connect cannot be performed from the Directory Service event logs. You'll need to access the Windows Application event logs.","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[{"key":0,"length":69,"offset":0}],"inlineStyleRanges":[],"key":"fq0pe","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[{"key":1,"length":93,"offset":0}],"inlineStyleRanges":[],"key":"c5fh0","text":"https://support.pingidentity.com/s/article/PingOne-How-to-troubleshoot-an-AD-Connect-Instance","type":"unstyled"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
