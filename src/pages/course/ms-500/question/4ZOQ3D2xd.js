...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"4ZOQ3D2xd","answers":[{"isCorrectAnswer":false,"value":"Directory Service event logs"},{"value":"Security event log","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Application event log"},{"isCorrectAnswer":false,"value":"System event log"}],"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off"}}},"blocks":[{"data":{},"inlineStyleRanges":[{"offset":56,"style":"color-rgb(33,37,41)","length":87},{"length":87,"style":"bgcolor-rgb(255,255,255)","offset":56},{"style":"fontsize-16","length":87,"offset":56},{"length":87,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":56}],"type":"unstyled","entityRanges":[],"key":"cj3ba","depth":0,"text":"Troubleshooting AD Connect cannot be performed from the Directory Service event logs. You'll need to access the Windows Application event logs."},{"key":"fq0pe","data":{},"entityRanges":[{"key":0,"length":69,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"inlineStyleRanges":[],"text":"https://support.pingidentity.com/s/article/PingOne-How-to-troubleshoot-an-AD-Connect-Instance","data":{},"entityRanges":[{"key":1,"length":93,"offset":0}],"key":"c5fh0","type":"unstyled","depth":0}]},"question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"key":"24ut7","data":{},"text":"Your organization has an Active Directory domain named gitbit.org. You've installed Azure AD Connect on ServerA which is a server running Windows 2016."},{"inlineStyleRanges":[],"data":{},"key":"43e0t","text":"There's an error syncing user accounts from your on-premises AD to Microsoft 365.","type":"unstyled","depth":0,"entityRanges":[]},{"data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"You've been tasked with resolving the error. To start, you RDP to ServerA and open the Directory Service event logs.","key":"4f9bd"},{"key":"6rnh3","data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"What location can you use to troubleshoot the AD Connect sync errors?","type":"unstyled","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '4ZOQ3D2xd',
      questionIdx: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/4ZOQ3D2xd',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
