...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'Only Device1, and Device2.'}, {isCorrectAnswer: false, value: 'Only Device1'}, {isCorrectAnswer: false, value: 'Only Device1, and Device3'}, {isCorrectAnswer: true, value: 'All three devices: Device1, Device2 and Device3'}], canonical: 'https://www.gitbit.org/course/ms-500/test/microsoft-defender-1hidrpsrl/question/you-plan-to-evaluate-the--aovbxdcsk', id: 'Omm8e1L_Q', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '9cg9', text: 'You have a Microsoft 365 tenant that\'s licensed for Microsoft Defender for Endpoint.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '8osik', text: 'You have the following devices enrolled in Microsoft Endpoint Manager.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: '4narm', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2ns91', text: 'You\'ve integrated Endpoint Manager and Microsoft Defender for Endpoint.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '4qdk2', text: 'You plan to evaluate the risk level for all the devices listed above.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '3dlb2', text: 'Which devices can be evaluated?', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'Device platform chart', height: 'auto', src: 'https://i.ibb.co/XVRnnsz/device-platform.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'a7o7a', text: 'Windows, macOS, Android, iOS, and iPad OS devices can all be evaluated for their risk levels.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'a2h0b', text: 'Reference:', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 129, offset: 0}], inlineStyleRanges: [], key: '4i1hk', text: 'https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Protecting-Windows-10-and-other-devices-with-Microsoft-Defender-for-Endpoint-z0qPG6v4T'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/evaluation-lab'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
