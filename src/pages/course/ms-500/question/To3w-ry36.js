...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"To3w-ry36","answers":[{"value":"Azure Active Directory admin center","isCorrectAnswer":true},{"value":"Cloud App Security admin center","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Security & Compliance admin center"},{"isCorrectAnswer":true,"value":"Microsoft 365 admin center"}],"references":{"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators"}}},"blocks":[{"entityRanges":[],"data":{},"depth":0,"text":"The best place to view the rights of an admin role is Azure Active Directory but some of the details can also be found in the Microsoft 365 admin center","inlineStyleRanges":[],"key":"7etnr","type":"unstyled"},{"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","data":{},"key":"2ct22","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[{"length":95,"key":0,"offset":0}]},{"data":{},"text":"https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators > click on a role.","key":"dk8qi","depth":0,"type":"unstyled","inlineStyleRanges":[],"entityRanges":[{"key":1,"offset":0,"length":101}]}]},"question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"key":"7c56s","data":{},"type":"unstyled","text":"Your organization is using a Microsoft 365 tenant. From the Microsoft 365 admin center, you create a new user named John Gruber. You were requested to assign the User Administrator role to John Gruber but before you do your boss wants to know everything the role will give John access to.","entityRanges":[],"depth":0},{"data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","key":"aphun","text":"Which admin centers could you use to view the permissions of an administrator role?","entityRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
