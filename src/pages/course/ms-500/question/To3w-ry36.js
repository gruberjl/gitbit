...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: true, value: 'Azure Active Directory admin center'}, {isCorrectAnswer: false, value: 'Cloud App Security admin center'}, {isCorrectAnswer: false, value: 'Security & Compliance admin center'}, {isCorrectAnswer: true, value: 'Microsoft 365 admin center'}], question: {entityMap: {}, blocks: [{inlineStyleRanges: [], entityRanges: [], key: '7c56s', data: {}, depth: 0, text: 'Your organization is using a Microsoft 365 tenant. From the Microsoft 365 admin center, you create a new user named John Gruber. You were requested to assign the User Administrator role to John Gruber but before you do your boss wants to know everything the role will give John access to.', type: 'unstyled'}, {data: {}, inlineStyleRanges: [], key: 'aphun', depth: 0, type: 'unstyled', entityRanges: [], text: 'Which admin centers could you use to view the permissions of an administrator role?'}]}, id: 'To3w-ry36', references: {entityMap: {0: {data: {url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU', targetOption: '_blank'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {url: 'https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators', targetOption: '_blank'}, mutability: 'MUTABLE', type: 'LINK'}}, blocks: [{entityRanges: [], depth: 0, type: 'unstyled', text: 'The best place to view the rights of an admin role is Azure Active Directory but some of the details can also be found in the Microsoft 365 admin center', inlineStyleRanges: [], key: '7etnr', data: {}}, {type: 'unstyled', key: '2ct22', text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU', entityRanges: [{offset: 0, key: 0, length: 95}], depth: 0, inlineStyleRanges: [], data: {}}, {key: 'dk8qi', depth: 0, data: {}, type: 'unstyled', inlineStyleRanges: [], entityRanges: [{key: 1, offset: 0, length: 101}], text: 'https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators > click on a role.'}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
