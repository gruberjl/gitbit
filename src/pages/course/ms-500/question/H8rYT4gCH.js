...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"H8rYT4gCH","question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"depth":0,"data":{},"key":"4t5vp","type":"unstyled","entityRanges":[],"text":"You need to ensure that a user named Joe Gruber receives incident reports when email messages that contain data covered by the U.K. Data Protection Act are sent outside of your organization."},{"type":"unstyled","depth":0,"entityRanges":[],"key":"43bu","text":"What steps should you take to complete the task?","data":{},"inlineStyleRanges":[{"style":"color-rgb(33,37,41)","length":48,"offset":0},{"style":"bgcolor-rgb(255,255,255)","length":48,"offset":0},{"length":48,"offset":0,"style":"fontsize-16"},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":48,"offset":0}]}]},"answers":[{"value":"From the Microsoft 365 compliance center create a new Data loss prevention policy with a customized alert notification","isCorrectAnswer":true},{"value":"From the Microsoft 365 admin center edit the default Data loss prevention policy with custom notification to Joe Gruber","isCorrectAnswer":false},{"value":"From the Azure AD admin center > Sharing > Block sharing > Customize alert notifications.","isCorrectAnswer":false}],"references":{"blocks":[{"key":"7ofpi","text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w ","entityRanges":[{"key":0,"length":116,"offset":0}],"type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{}},{"key":"a70lu","data":{},"entityRanges":[{"offset":0,"key":1,"length":127}],"depth":0,"inlineStyleRanges":[],"type":"unstyled","text":"https://www.iorad.com/player/1802115/MS-500---ensure-that-a-user-named-Joe-Gruber-receives-incident-reports-when-email-messages"},{"type":"ordered-list-item","key":"esne0","entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{},"text":"Open the Microsoft 365 compliance center."},{"text":"Go to Policies > Data loss prevention > Policies > Create policy.","type":"ordered-list-item","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"86orm"},{"data":{},"inlineStyleRanges":[],"type":"ordered-list-item","depth":0,"entityRanges":[],"key":"11ml6","text":"Select the U.K. Data Protection Act."},{"data":{},"key":"8cgea","inlineStyleRanges":[],"text":"Unselect every location except Exchange email.","depth":0,"type":"ordered-list-item","entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"type":"ordered-list-item","text":"Customize the alert configuration > add Joe Gruber and remove John Gruber.","entityRanges":[],"data":{},"key":"cg844"},{"text":"Save the changes.","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"ultc","type":"ordered-list-item"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1802115/MS-500---ensure-that-a-user-named-Joe-Gruber-receives-incident-reports-when-email-messages"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/H8rYT4gCH',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
