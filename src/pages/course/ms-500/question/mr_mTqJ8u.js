...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"isCorrectAnswer":true,"value":"Connect to the Security & Compliance admin center using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Go to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file"},{"isCorrectAnswer":false,"value":"Connect to the Security & Compliance admin center by using PowerShell > Export the current rules as a JSON file > Modify the file > Upload the file"},{"value":"Go to the Security & Compliance admin center > Export the current rules as a JSON file > Modify the file > Upload the file","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"text":"Your organization has a Microsoft 365 tenant.","entityRanges":[],"depth":0,"data":{},"type":"unstyled","key":"3ik3u","inlineStyleRanges":[]},{"depth":0,"key":"crflb","data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"text":"You need to include a sensitive information type in Data Subject Request cases."},{"entityRanges":[],"type":"unstyled","depth":0,"data":{},"inlineStyleRanges":[],"text":"Which four actions should you perform in sequence?","key":"e3rai"}]},"references":{"blocks":[{"key":"dkobb","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"text":"1. Connect to the Security & Compliance admin center using PowerShell. The command is \"Connect-IPPSSession\""},{"data":{},"inlineStyleRanges":[],"text":"2. Export the current rules as an XML file. The command is \"Get-DlpSensitiveInformationTypeRulePackage | Export-Clixml .\\rules.xml\"","type":"unstyled","depth":0,"key":"bhkqv","entityRanges":[]},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"text":"3. Modify the file making the changes you desire","key":"64qbf","type":"unstyled"},{"data":{},"depth":0,"inlineStyleRanges":[],"key":"ds3ee","text":"4. Upload the file. The command is \"New-DlpSensitiveInformationTypeRulePackage -FileData ([System.IO.File]::ReadAllBytes('PathToXml.xml'))\"","type":"unstyled","entityRanges":[]},{"entityRanges":[{"length":116,"offset":0,"key":0}],"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","data":{},"depth":0,"type":"unstyled","key":"46fov"},{"type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","entityRanges":[{"key":1,"offset":0,"length":125}],"inlineStyleRanges":[],"key":"ejiq","data":{}}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}},"id":"mr_mTqJ8u"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/mr_mTqJ8u',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
