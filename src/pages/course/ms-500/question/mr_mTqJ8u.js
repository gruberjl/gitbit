...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {references: {entityMap: {0: {mutability: 'MUTABLE', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w', targetOption: '_blank'}, type: 'LINK'}, 1: {type: 'LINK', data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide'}, mutability: 'MUTABLE'}}, blocks: [{data: {}, key: 'dkobb', type: 'unstyled', entityRanges: [], depth: 0, inlineStyleRanges: [], text: '1. Connect to the Security & Compliance admin center using PowerShell. The command is "Connect-IPPSSession"'}, {entityRanges: [], key: 'bhkqv', depth: 0, type: 'unstyled', inlineStyleRanges: [], data: {}, text: '2. Export the current rules as an XML file. The command is "Get-DlpSensitiveInformationTypeRulePackage | Export-Clixml .\\rules.xml"'}, {type: 'unstyled', key: '64qbf', data: {}, entityRanges: [], depth: 0, text: '3. Modify the file making the changes you desire', inlineStyleRanges: []}, {entityRanges: [], text: '4. Upload the file. The command is "New-DlpSensitiveInformationTypeRulePackage -FileData ([System.IO.File]::ReadAllBytes(\'PathToXml.xml\'))"', inlineStyleRanges: [], data: {}, depth: 0, type: 'unstyled', key: 'ds3ee'}, {data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w', depth: 0, type: 'unstyled', key: '46fov', entityRanges: [{offset: 0, length: 116, key: 0}], inlineStyleRanges: []}, {inlineStyleRanges: [], text: 'https://docs.microsoft.com/en-us/microsoft-365/compliance/customize-a-built-in-sensitive-information-type?view=o365-worldwide', entityRanges: [{key: 1, length: 125, offset: 0}], key: 'ejiq', data: {}, depth: 0, type: 'unstyled'}]}, question: {blocks: [{depth: 0, data: {}, type: 'unstyled', key: '3ik3u', inlineStyleRanges: [], text: 'Your organization has a Microsoft 365 tenant.', entityRanges: []}, {entityRanges: [], type: 'unstyled', depth: 0, key: 'crflb', data: {}, text: 'You need to include a sensitive information type in Data Subject Request cases.', inlineStyleRanges: []}, {data: {}, depth: 0, inlineStyleRanges: [], type: 'unstyled', key: 'e3rai', entityRanges: [], text: 'Which four actions should you perform in sequence?'}], entityMap: {}}, answers: [{isCorrectAnswer: true, value: 'Connect to the Security & Compliance admin center using PowerShell > Export the current rules as an XML file > Modify the file > Upload the file'}, {value: 'Go to the Security & Compliance admin center > Export the current rules as an XML file > Modify the file > Upload the file', isCorrectAnswer: false}, {value: 'Connect to the Security & Compliance admin center by using PowerShell > Export the current rules as a JSON file > Modify the file > Upload the file', isCorrectAnswer: false}, {isCorrectAnswer: false, value: 'Go to the Security & Compliance admin center > Export the current rules as a JSON file > Modify the file > Upload the file'}], id: 'mr_mTqJ8u'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
