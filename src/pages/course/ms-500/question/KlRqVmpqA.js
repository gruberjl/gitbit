...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"text":"You have a Microsoft 365 tenant with the following devices enrolled in Intune.","key":"ap89k","data":{},"depth":0,"type":"unstyled"},{"type":"atomic","text":" ","key":"8jmrd","entityRanges":[{"length":1,"offset":0,"key":0}],"data":{},"inlineStyleRanges":[],"depth":0},{"text":"You've configured the following compliance policies in Intune including the groups they are assigned to:","key":"5o7ps","inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"depth":0,"data":{}},{"inlineStyleRanges":[],"entityRanges":[{"length":1,"offset":0,"key":1}],"type":"atomic","depth":0,"data":{},"key":"avhph","text":" "},{"data":{},"text":"What policies will apply to which devices?","depth":0,"key":"6onik","inlineStyleRanges":[],"type":"unstyled","entityRanges":[]}],"entityMap":{"0":{"data":{"height":"auto","src":"https://i.ibb.co/zNwz1nM/Device-Group-Membership.png","alignment":"left","width":"auto","alt":"Devices and group memberships"},"type":"IMAGE","mutability":"MUTABLE"},"1":{"type":"IMAGE","mutability":"MUTABLE","data":{"alt":"Policy assignments","alignment":"left","src":"https://i.ibb.co/LQ99dsG/Policy-assignments.png","height":"auto","width":"auto"}},"2":{"type":"IMAGE","data":{"alignment":"left","height":"auto","src":"https://i.ibb.co/FsvMcnQ/Device-Policy-Assignments.png","width":"auto","alt":"Device policy assignments"},"mutability":"MUTABLE"}}},"id":"KlRqVmpqA","answers":[{"isCorrectAnswer":false,"value":"PolicyA will not apply to any devices"},{"isCorrectAnswer":false,"value":"PolicyA will apply to DeviceA"},{"value":"PolicyA will apply to DeviceC","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"PolicyA will apply to Device2 and Device3"},{"value":"PolicyB will apply to Device1 and Device3","isCorrectAnswer":true},{"value":"PolicyB will apply to Device1, Device2, Device3","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"PolicyB will not apply to any devices"},{"value":"PolicyB will apply to Device4 only","isCorrectAnswer":true},{"value":"PolicyB will apply to Device2 and Device4","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"PolicyB will apply to Device2, Device3, and Device4"}],"references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","targetOption":"_blank"},"type":"LINK"}},"blocks":[{"inlineStyleRanges":[],"data":{},"text":"PolicyA includes Group3 and only affects Android devices so it only affects DeviceA and DeviceC.","entityRanges":[],"type":"unstyled","key":"9tmbm","depth":0},{"type":"unstyled","depth":0,"data":{},"entityRanges":[],"text":"PolicyB includes Group2 and excludes Group3 and only affects Windows 10 devices so it only affects DeviceD.","key":"1bj1c","inlineStyleRanges":[]},{"entityRanges":[{"offset":0,"key":0,"length":87}],"inlineStyleRanges":[],"data":{},"type":"unstyled","key":"5pp2f","text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","depth":0}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/KlRqVmpqA',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
