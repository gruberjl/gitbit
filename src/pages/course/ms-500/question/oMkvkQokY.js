...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"key":"ffg0d","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"Sign-in risk policies are used to protect authentication from suspicious activity.","type":"unstyled","data":{}},{"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Implementing-intelligent-security-using-risk-policies-in-Microsoft-365-NFQ6rYFeQ","key":"4r2ff","data":{},"type":"unstyled","entityRanges":[{"length":123,"key":0,"offset":0}],"depth":0},{"inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/azure/active-directory/identity-protection/howto-user-risk-policy","data":{},"entityRanges":[{"key":1,"length":98,"offset":0}],"key":"vujr"}]},"answers":[{"isCorrectAnswer":false,"value":"A device compliance policy"},{"isCorrectAnswer":false,"value":"An access review"},{"isCorrectAnswer":false,"value":"A user risk policy"},{"value":"A sign-in risk policy","isCorrectAnswer":true}],"id":"oMkvkQokY","question":{"entityMap":{},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"text":"Your organization has a Microsoft 365 tenant. You've been tasked with updating the security requirements of the tenant. If an authentication attempt is suspicious, your manager wants MFA to be required regardless of the user's location.","depth":0,"key":"fl2fs","data":{}},{"inlineStyleRanges":[],"text":"What policy do you need to update to meet the security requirements?","key":"34cn4","type":"unstyled","entityRanges":[],"depth":0,"data":{}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/oMkvkQokY',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
