...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"}}},"blocks":[{"depth":0,"type":"unstyled","text":"In the anti-spam policies > Anti-spam inbound policy (default). The actions section will tell Microsoft 365 what to do when it finds a message that's spam, phishing, or bulk email. For example, you may want the email to go to the user's junk email folder or you may want the email to go to the quarantine. The actions section is where you'll find the retain spam in quarantine for this many days setting.","inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"4pqn4"},{"depth":0,"key":"9udm8","text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","entityRanges":[{"offset":0,"length":105,"key":0}],"data":{},"inlineStyleRanges":[],"type":"unstyled"}]},"answers":[{"isCorrectAnswer":false,"value":" ATP anti-phishing"},{"isCorrectAnswer":false,"value":"DKIM"},{"value":"Anti-spam","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Anti-malware"}],"id":"AajbeBaEy","question":{"entityMap":{},"blocks":[{"data":{},"type":"unstyled","key":"3934o","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Your organization has a Microsoft 365 tenant and you've already created a Microsoft Defender Safe Attachments policy. You've configured the policy to quarantine malware."},{"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"key":"7cpeu","text":"You've been asked to change the retention duration for the attachments that end up in the quarantine.","data":{}},{"text":"Which threat management policy should you update from the Microsoft Defender admin center?","type":"unstyled","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"key":"bfn55"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: 'AajbeBaEy',
      questionIdx: '',
      questionHtml: `<p>Your organization has a Microsoft 365 tenant and you've already created a Microsoft Defender Safe Attachments policy. You've configured the policy to quarantine malware.</p>
