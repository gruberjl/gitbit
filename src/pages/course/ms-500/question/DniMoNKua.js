...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"text":"This question/answer is only relevant if you deploy Microsoft Defender for Identity standalone sensors instead of Defender for Identity sensors.","key":"44nvj","depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{}},{"key":"4njpg","type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"In short, you need to configure port mirroring on each server to be monitored. Then install a standalone sensor. Finally, configure an event collection/subscription on the server that can connect to the internet.","depth":0}],"entityMap":{}},"id":"DniMoNKua","answers":[{"isCorrectAnswer":false,"value":"Install the Microsoft Defender for Identity Sensor on ServerA"},{"value":"Install the Microsoft Defender for Identity standalone sensor on ServerA","isCorrectAnswer":false},{"value":"Configure an event subscription on ServerA","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Configure a port mirroring source on ServerA"},{"value":"Install the Microsoft Defender for Identity standalone sensor on ServerB","isCorrectAnswer":true},{"value":"Configure an event subscription on ServerB","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Configure a port mirroring source on ServerB"},{"isCorrectAnswer":false,"value":"Install the Microsoft Defender for Identity Sensor on ServerB"}],"question":{"blocks":[{"entityRanges":[],"depth":0,"key":"edouc","data":{},"text":"You have an on-premises infrastructure that contains the following:","inlineStyleRanges":[],"type":"unstyled"},{"type":"unordered-list-item","entityRanges":[],"depth":0,"text":"An Active Directory domain with a domain controller named ServerA.","key":"cr7cr","data":{},"inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"A server named ServerB that's not a domain controller.","entityRanges":[],"depth":0,"key":"7ldf3","data":{},"type":"unordered-list-item"},{"key":"2l4a6","depth":0,"text":"A security policy is configured that prevents ServerA from connecting to the Internet. ServerB can connect to the Internet.","entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","text":"You've been tasked with implementing Microsoft Defender for Identity to monitor ServerA.","key":"677vd","depth":0,"data":{}},{"text":"How should you configure the servers?","depth":0,"data":{},"entityRanges":[],"key":"7tgns","inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/DniMoNKua',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
