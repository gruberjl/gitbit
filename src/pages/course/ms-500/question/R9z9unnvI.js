...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {references: {blocks: [{entityRanges: [], inlineStyleRanges: [], data: {}, text: '1. Go to Azure Active Directory admin center > Azure Active Directory > Groups > Expiration.', key: '941t8', depth: 0, type: 'unstyled'}, {text: '2. Set the Group lifetime (in days) > an email for groups with no owners > enable expiration to All. Click Save.', data: {}, inlineStyleRanges: [], type: 'unstyled', depth: 0, key: '9h1cm', entityRanges: []}, {inlineStyleRanges: [], type: 'unstyled', depth: 0, text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV', key: 'bh5mf', data: {}, entityRanges: [{offset: 0, key: 0, length: 95}]}, {data: {}, key: '325bg', entityRanges: [{offset: 0, key: 1, length: 116}], depth: 0, inlineStyleRanges: [], type: 'unstyled', text: 'https://www.iorad.com/player/1796067/MS-500---Ensure-that-group-owners-renew-their-Office-365-groups-every-180-days-'}], entityMap: {0: {mutability: 'MUTABLE', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV', targetOption: '_blank'}, type: 'LINK'}, 1: {mutability: 'MUTABLE', type: 'LINK', data: {targetOption: '_blank', url: 'https://www.iorad.com/player/1796067/MS-500---Ensure-that-group-owners-renew-their-Office-365-groups-every-180-days-'}}}}, answers: [{value: 'Go to the Microsoft 365 admin center > Groups > Active Groups > Click a group > Group settings', isCorrectAnswer: false}, {isCorrectAnswer: true, value: 'Go to the Azure Active Directory admin center > Azure Active Directory > Groups > Expiration'}, {value: 'Go to the Azure Active Directory admin center > Azure Active Directory > Groups > Groups Settings', isCorrectAnswer: false}], question: {entityMap: {}, blocks: [{key: 'fptda', data: {}, type: 'unstyled', depth: 0, text: 'You\'ve been tasked with configuring groups so they expire unless the group owners renew the group.', inlineStyleRanges: [{offset: 0, length: 98, style: 'color-rgb(80,80,80)'}, {length: 98, offset: 0, style: 'bgcolor-rgb(255,255,255)'}, {style: 'fontsize-16', length: 98, offset: 0}, {style: 'fontfamily-Roboto Condensed", sans-serif', length: 98, offset: 0}], entityRanges: []}, {text: 'Where do you go to configure group expiration?', depth: 0, data: {}, entityRanges: [], type: 'unstyled', inlineStyleRanges: [{length: 46, offset: 0, style: 'color-rgb(33,37,41)'}, {style: 'bgcolor-rgb(255,255,255)', offset: 0, length: 46}, {length: 46, style: 'fontsize-16', offset: 0}, {length: 46, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji', offset: 0}], key: '8rc1'}]}, id: 'R9z9unnvI'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
