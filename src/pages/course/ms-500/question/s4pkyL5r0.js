...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"s4pkyL5r0","question":{"blocks":[{"data":{},"key":"cc7cl","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"You need to ensure that unmanaged mobile devices are quarantined when the devices attempt to connect to Exchange Online.","type":"unstyled"},{"entityRanges":[],"key":"79hqh","inlineStyleRanges":[{"offset":0,"length":48,"style":"color-rgb(33,37,41)"},{"style":"bgcolor-rgb(255,255,255)","length":48,"offset":0},{"offset":0,"style":"fontsize-16","length":48},{"offset":0,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":48}],"depth":0,"text":"What steps should you take to complete the task?","type":"unstyled","data":{}}],"entityMap":{}},"answers":[{"value":"Open Azure Active Directory Admin Center > Devices > Manage Devices","isCorrectAnswer":false},{"value":"Open Exchange Admin Center > Mobile > Edit > Select options","isCorrectAnswer":true},{"value":"Open Microsoft 365 Admin Center > Mobile > Edit > Select options","isCorrectAnswer":false}],"references":{"blocks":[{"key":"f9d2a","data":{},"inlineStyleRanges":[],"type":"unstyled","text":"https://www.iorad.com/player/1796090/MS-500---Ensure-that-unmanaged-mobile-devices-are-quarantined-when-the-devices-attempt-to-connect-to ","entityRanges":[{"key":0,"offset":0,"length":137}],"depth":0},{"data":{},"inlineStyleRanges":[],"text":"You need to configure the Exchange ActiveSync Access Settings.","key":"4im1d","entityRanges":[],"depth":0,"type":"unstyled"},{"text":"Go to the Exchange admin center.","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"ordered-list-item","key":"jnrn"},{"type":"ordered-list-item","entityRanges":[],"data":{},"key":"29jo5","text":"Click on Mobile in the left navigation pane.","depth":0,"inlineStyleRanges":[]},{"key":"8f6v5","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"On the Mobile Device Access page, click the Edit button in the Exchange ActiveSync Access Settings area.","type":"ordered-list-item","data":{}},{"inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"key":"crv1m","text":"Select the Quarantine option under When a mobile device that isn't managed by a rule or personal exemption connects to Exchange.","type":"ordered-list-item"},{"entityRanges":[],"key":"7fd0k","text":"Optionally, you can configure notifications to be sent to administrators and a message to be sent to the mobile device user when a device is quarantined.","type":"ordered-list-item","depth":0,"inlineStyleRanges":[],"data":{}},{"key":"2q57v","data":{},"text":"Click Save to save the changes.","type":"ordered-list-item","entityRanges":[],"inlineStyleRanges":[],"depth":0},{"key":"h6vu","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","type":"unstyled","depth":0,"data":{},"entityRanges":[{"key":1,"length":86,"offset":0}]}],"entityMap":{"0":{"type":"LINK","data":{"url":"https://www.iorad.com/player/1796090/MS-500---Ensure-that-unmanaged-mobile-devices-are-quarantined-when-the-devices-attempt-to-connect-to","targetOption":"_blank"},"mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Understanding-compliance-policies-qDRA4jjoN","targetOption":"_blank"},"mutability":"MUTABLE"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/s4pkyL5r0',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
