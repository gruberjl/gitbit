...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"data":{},"inlineStyleRanges":[],"depth":0,"key":"4b2ct","text":"Troubleshooting AD Connect can be a bit complicated Because there are four places that you may need to check to view the errors (although the data is usually redundant)","type":"unstyled","entityRanges":[]},{"key":"9hcj3","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"type":"unordered-list-item","text":"Directory Sync status in the Microsoft 365 admin center."},{"key":"7b51j","entityRanges":[],"depth":0,"inlineStyleRanges":[],"data":{},"text":"Sync errors in the Azure AD admin center (found under Azure Active Directory Connect health)","type":"unordered-list-item"},{"type":"unordered-list-item","key":"2q5rk","depth":0,"data":{},"inlineStyleRanges":[],"text":"The synchronization service app on the AD Connect server","entityRanges":[]},{"entityRanges":[],"depth":0,"inlineStyleRanges":[],"key":"41ns8","data":{},"text":"The application event logs on the AD Connect server","type":"unordered-list-item"},{"depth":0,"data":{},"entityRanges":[{"length":69,"offset":0,"key":0}],"key":"f9c6l","inlineStyleRanges":[],"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P"},{"inlineStyleRanges":[],"entityRanges":[{"key":1,"length":93,"offset":0}],"data":{},"text":"https://support.pingidentity.com/s/article/PingOne-How-to-troubleshoot-an-AD-Connect-Instance","type":"unstyled","key":"352q2","depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"},"type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://support.pingidentity.com/s/article/PingOne-How-to-troubleshoot-an-AD-Connect-Instance"}}}},"question":{"entityMap":{},"blocks":[{"key":"amujj","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Your organization has an on-premises Active Directory domain named gitbit.org","type":"unstyled","data":{}},{"data":{},"key":"7lpjg","text":"Your organization has installed Azure AD Connect on a server to sync your on-premises AD to Microsoft 365.","type":"unstyled","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"key":"ehi8s","depth":0,"text":"There's an error in the sync. You've been tasked with finding and resolving the error. You need to view Azure AD Connect events.","type":"unstyled","inlineStyleRanges":[],"entityRanges":[],"data":{}},{"depth":0,"entityRanges":[],"data":{},"text":"What event logs do you use?","inlineStyleRanges":[],"type":"unstyled","key":"a5bre"}]},"answers":[{"isCorrectAnswer":true,"value":"Application"},{"value":"System","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Security"},{"value":"Application and Services Logs/Microsoft/Windows/Security-Adminless","isCorrectAnswer":false}],"id":"kNEGzjhMv"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/kNEGzjhMv',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
