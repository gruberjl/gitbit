...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'User1 can sign in without MFA'}, {isCorrectAnswer: false, value: 'User1 has completed the MFA registration'}, {isCorrectAnswer: true, value: 'User1 will be prompted to complete the MFA registration at the next sign-in'}, {isCorrectAnswer: false, value: 'User2 can sign in without MFA'}, {isCorrectAnswer: true, value: 'User2 will be required to use app passwords for any apps that don\'t support MFA'}, {isCorrectAnswer: false, value: 'User2 will be required to use their app password to sign into Microsoft 365 apps'}], canonical: 'https://www.gitbit.org/course/ms-500/test/configure-and-manage-multi-factor-authentication-mfa-yjeapbng4/question/what-will-happen-when-use-ebxhgli1o', id: '-T7jiUFfR', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2h8s2', text: 'Your organization has a Microsoft 365 tenant with the domain name gitbit.org.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2t9f1', text: 'The MFA configuration is shown below.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: '2317e', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'ccd7r', text: 'Your Microsoft 365 tenant has the following users.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 1, offset: 0}], inlineStyleRanges: [], key: 'lvbg', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '4b9b1', text: 'What will happen when User1 and User2 log in?', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'Multi-Factor Authentication', height: 'auto', src: 'https://i.ibb.co/pQps3R2/MFA.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}, 1: {data: {alignment: 'left', alt: 'User chart showing 3 users', height: 'auto', src: 'https://i.ibb.co/bmTyW56/user-chart.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '5mu1d', text: 'The MFA Status Enabled means the user must set up MFA during the next login.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'd3ojg', text: 'Since "Allow users to create app passwords to sign in to non-browser apps" is checked that means a user can use the app password to log in when MFA is not an available option.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 128, offset: 0}], inlineStyleRanges: [], key: '9clot', text: 'https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 91, offset: 0}], inlineStyleRanges: [], key: 'dnvn8', text: 'https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-userstates'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
