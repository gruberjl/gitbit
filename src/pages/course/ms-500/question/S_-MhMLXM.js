...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx"}}},"blocks":[{"type":"unstyled","data":{},"entityRanges":[],"key":"dj4p2","inlineStyleRanges":[],"depth":0,"text":"App protection policies that apply to Microsoft 365 apps, for example, Power BI, will protect apps even if the user is on an unmanaged device."},{"key":"ngqi","text":"https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx","type":"unstyled","data":{},"inlineStyleRanges":[],"depth":0,"entityRanges":[{"length":98,"offset":0,"key":0}]}]},"id":"S_-MhMLXM","answers":[{"value":"A conditional access policy in Microsoft Azure Active Directory (Azure AD) that has a device state condition","isCorrectAnswer":false},{"value":"An app protection policy in Microsoft Endpoint Manager","isCorrectAnswer":true},{"value":"A conditional access policy in Microsoft Azure Active Directory (Azure AD) that has a client apps condition","isCorrectAnswer":false},{"value":"A device compliance policy in Microsoft Endpoint Manager","isCorrectAnswer":false}],"question":{"blocks":[{"key":"3em5r","data":{},"depth":0,"text":"Your company has a Microsoft 365 subscription.","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled"},{"text":"The company does not permit users to enroll personal devices in mobile device management (MDM).","entityRanges":[],"data":{},"type":"unstyled","key":"6lq4i","inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"text":"Users in the sales department have personal iOS devices.","data":{},"depth":0,"type":"unstyled","key":"28f3s","entityRanges":[]},{"type":"unstyled","data":{},"key":"dg7ah","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"You need to ensure that the sales department users can use the Microsoft Power BI app from iOS devices to access the Power BI data in your tenant."},{"key":"11f59","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","data":{},"depth":0,"text":"The users must be prevented from backing up the app data to iCloud."},{"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"What should you create?","entityRanges":[],"key":"5dvm3","depth":0}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/S_-MhMLXM',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
