...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'A conditional access policy in Microsoft Azure Active Directory (Azure AD) that has a device state condition'}, {isCorrectAnswer: true, value: 'An app protection policy in Microsoft Endpoint Manager'}, {isCorrectAnswer: false, value: 'A conditional access policy in Microsoft Azure Active Directory (Azure AD) that has a client apps condition'}, {isCorrectAnswer: false, value: 'A device compliance policy in Microsoft Endpoint Manager'}], canonical: 'https://www.gitbit.org/course/ms-500/test/protecting-user-devices-using-intune-bzzocmdmd/question/users-must-be-prevented-f-mb1zd0h2m', id: 'S_-MhMLXM', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '3em5r', text: 'Your company has a Microsoft 365 subscription.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '6lq4i', text: 'The company does not permit users to enroll personal devices in mobile device management (MDM).', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '28f3s', text: 'Users in the sales department have personal iOS devices.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'dg7ah', text: 'You need to ensure that the sales department users can use the Microsoft Power BI app from iOS devices to access the Power BI data in your tenant.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '11f59', text: 'The users must be prevented from backing up the app data to iCloud.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '5dvm3', text: 'What should you create?', type: 'unstyled'}], entityMap: {}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'dj4p2', text: 'App protection policies that apply to Microsoft 365 apps, for example, Power BI, will protect apps even if the user is on an unmanaged device.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 98, offset: 0}], inlineStyleRanges: [], key: 'ngqi', text: 'https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
