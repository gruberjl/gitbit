...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'Set the frequency to One time'}, {isCorrectAnswer: true, value: 'Set the frequency to Weekly'}, {isCorrectAnswer: false, value: 'Set the frequency to Monthly'}, {isCorrectAnswer: true, value: 'To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings'}, {isCorrectAnswer: false, value: 'To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings'}, {isCorrectAnswer: false, value: 'To ensure that access is removed if an administrator fails to respond, configure the: Programs'}, {isCorrectAnswer: false, value: 'To ensure that access is removed if an administrator fails to respond, configure the: Reviewers'}], canonical: 'https://www.gitbit.org/course/ms-500/test/configure-and-manage-multi-factor-authentication-mfa-yjeapbng4/question/configure-an-access-revie-y9pr4iv9e', id: 'HHipoVYNs', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [{length: 23, offset: 0, style: 'BOLD'}], key: '312gb', text: 'Security Requirements: GitBit identifies the following security requirements:', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'c0t0v', text: 'Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '4kl8j', text: 'Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '7n342', text: 'Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '4v2gu', text: 'Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'c5gnj', text: 'Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'cmhvm', text: 'The location of the user administrators must be audited when the administrators authenticate to Azure AD', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'ad81j', text: 'Email messages that include attachments containing malware must be delivered without the attachment', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '3v1so', text: 'The principle of least privilege must be used whenever possible', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'f6ml2', text: 'You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '8jjma', text: 'Which other settings should you configure? To answer, select the appropriate options in the answer area.', type: 'unstyled'}], entityMap: {}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'ao1ti', text: 'Setting the frequency to weekly allows you to review the roles every 7 days.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'a38rm', text: 'You set the access to be removed under "Upon completion settings"', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 94, offset: 0}], inlineStyleRanges: [], key: 'beg9g', text: 'https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
