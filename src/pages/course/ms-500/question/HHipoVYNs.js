...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"Set the frequency to One time","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Set the frequency to Weekly"},{"isCorrectAnswer":false,"value":"Set the frequency to Monthly"},{"isCorrectAnswer":true,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Upon completion settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Advanced settings"},{"isCorrectAnswer":false,"value":"To ensure that access is removed if an administrator fails to respond, configure the: Programs"},{"value":"To ensure that access is removed if an administrator fails to respond, configure the: Reviewers","isCorrectAnswer":false}],"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"}}},"blocks":[{"data":{},"inlineStyleRanges":[],"type":"unstyled","depth":0,"entityRanges":[],"text":"Setting the frequency to weekly allows you to review the roles every 7 days.","key":"ao1ti"},{"data":{},"text":"You set the access to be removed under \"Upon completion settings\"","type":"unstyled","key":"a38rm","inlineStyleRanges":[],"entityRanges":[],"depth":0},{"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","key":"beg9g","data":{},"entityRanges":[{"key":0,"length":94,"offset":0}],"depth":0,"type":"unstyled","inlineStyleRanges":[]}]},"question":{"blocks":[{"text":"Security Requirements: GitBit identifies the following security requirements:","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[{"offset":0,"length":23,"style":"BOLD"}],"type":"unstyled","key":"312gb"},{"key":"c0t0v","data":{},"inlineStyleRanges":[],"text":"Access to the Azure Active Directory admin center by the user administrators must be reviewed every seven days. If an administrator fails to respond to an access request within three days, access must be removed","type":"unordered-list-item","depth":0,"entityRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Users who manage Microsoft 365 workloads must only be allowed to perform administrative tasks for up to three hours at a time. Global administrators must be exempt from this requirement","data":{},"key":"4kl8j","type":"unordered-list-item"},{"data":{},"text":"Users must be prevented from inviting external users to view company data. Only global administrators and a user named User1 must be able to send invitations","type":"unordered-list-item","key":"7n342","depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"key":"4v2gu","text":"Azure Advanced Threat Protection (ATP) must capture security group modifications for sensitive groups, such as Domain Admins in Active Directory","entityRanges":[],"data":{},"depth":0,"type":"unordered-list-item","inlineStyleRanges":[]},{"type":"unordered-list-item","text":"Workload administrators must use multi-factor authentication (MFA) when signing in from an anonymous or an unfamiliar location","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[],"key":"c5gnj"},{"type":"unordered-list-item","inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"cmhvm","depth":0,"text":"The location of the user administrators must be audited when the administrators authenticate to Azure AD"},{"data":{},"type":"unordered-list-item","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Email messages that include attachments containing malware must be delivered without the attachment","key":"ad81j"},{"entityRanges":[],"type":"unordered-list-item","inlineStyleRanges":[],"text":"The principle of least privilege must be used whenever possible","data":{},"depth":0,"key":"3v1so"},{"entityRanges":[],"type":"unstyled","key":"f6ml2","data":{},"inlineStyleRanges":[],"depth":0,"text":"You plan to configure an access review to meet the security requirements for the workload administrators. You create an access review policy and specify the scope and a group."},{"depth":0,"inlineStyleRanges":[],"text":"Which other settings should you configure? To answer, select the appropriate options in the answer area.","data":{},"key":"8jjma","type":"unstyled","entityRanges":[]}],"entityMap":{}},"id":"HHipoVYNs"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/HHipoVYNs',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
