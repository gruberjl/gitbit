...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{value: 'An Azure Active Directory Authentication Library (ADAL) token.', isCorrectAnswer: false}, {value: 'The public key.', isCorrectAnswer: false}, {value: 'The Username and password for a global admin account.', isCorrectAnswer: false}, {value: 'The URL of the Microsoft Defender for Identity admin center.', isCorrectAnswer: true}], references: {blocks: [{entityRanges: [], inlineStyleRanges: [], text: 'The URL is specific to every tenant so the admin will need the URL: https://*instancename*.atp.azure.com. The admin will also need the installation files and the access key but both of which can be downloaded from the Microsoft Defender for Identity admin center.', key: '67e5s', type: 'unstyled', data: {}, depth: 0}, {text: 'https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA', data: {}, depth: 0, type: 'unstyled', entityRanges: [{length: 90, key: 0, offset: 0}], inlineStyleRanges: [], key: 'bb6us'}, {key: '951j7', depth: 0, entityRanges: [{key: 1, length: 82, offset: 0}], type: 'unstyled', text: 'https://docs.microsoft.com/en-us/azure-advanced-threat-protection/workspace-portal', data: {}, inlineStyleRanges: []}], entityMap: {0: {mutability: 'MUTABLE', data: {targetOption: '_self', url: 'https://www.gitbit.org/course/ms-500/learn/Whats-Microsoft-Defender-for-identity-Kye_yNLxA'}, type: 'LINK'}, 1: {type: 'LINK', mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/azure-advanced-threat-protection/workspace-portal'}}}}, question: {entityMap: {}, blocks: [{depth: 0, inlineStyleRanges: [], data: {}, entityRanges: [], type: 'unstyled', key: 'etukd', text: 'A colleague has been asked to deploy several Microsoft Defender for Identity sensors.'}, {type: 'unstyled', key: '8orth', text: 'He\'s asked you to give him the Azure information required to deploy the sensors.', data: {}, depth: 0, entityRanges: [], inlineStyleRanges: []}, {key: 'aqlp3', entityRanges: [], inlineStyleRanges: [], text: 'What information should you provide?', data: {}, depth: 0, type: 'unstyled'}]}, id: 'Si5gtzjjY'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
