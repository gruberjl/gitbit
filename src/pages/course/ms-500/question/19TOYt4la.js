...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {"answers":[{"isCorrectAnswer":false,"value":"Open Microsoft Azure Active Directory Connect (Azure AD Connect) and configure attribute filtering."},{"isCorrectAnswer":false,"value":"Purchase a Enterprise Mobility + Security E5 license for every user."},{"isCorrectAnswer":false,"value":"Open Microsoft Azure Active Directory Connect (Azure AD Connect) and select Directory extension attribute sync."},{"isCorrectAnswer":true,"value":"Migrate all of the mailboxes hosted on-premises Microsoft 365"}],"canonical":"https://www.gitbit.org/course/ms-500/test/defending-exchange-online-avdet1sxv/question/verify-all-mailboxes-have-lfyrmsyv6","id":"19TOYt4la","question":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"3bsgp","text":"All user users have a Microsoft 365 E5 license. You have a hybrid Microsoft Exchange Server. Some of your user's mailboxes are located in Microsoft 365 while others are located in the on-premises Exchange server","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"69ltf","text":"You are tasked with setting up and configuring Microsoft Defender for Office 365 anti-phishing policy.","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"1o6pn","text":"Management has asked you to enable mailbox intelligence for all users.","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"d4hu7","text":"What do you need to do to verify all mailboxes have mailbox intelligence enabled and working?","type":"unstyled"}],"entityMap":{}},"references":{"blocks":[{"data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"fvnj6","text":"Mailbox intelligence will scan a user's mailbox to see if the user has sent or received emails from the sender of an email before. For mailbox intelligence to scan a mailbox then mailbox must be located in Microsoft 365's Exchange Online","type":"unstyled"},{"data":{},"depth":0,"entityRanges":[{"key":0,"length":94,"offset":0}],"inlineStyleRanges":[],"key":"7qat6","text":"https://www.gitbit.org/course/ms-500/learn/Protecting-email-against-phishing-attacks-GCOOUsSBT ","type":"unstyled"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-email-against-phishing-attacks-GCOOUsSBT"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
