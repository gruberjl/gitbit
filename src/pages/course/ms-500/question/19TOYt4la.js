...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"key":"3bsgp","inlineStyleRanges":[],"data":{},"text":"All user users have a Microsoft 365 E5 license. You have a hybrid Microsoft Exchange Server. Some of your user's mailboxes are located in Microsoft 365 while others are located in the on-premises Exchange server","entityRanges":[],"type":"unstyled","depth":0},{"key":"69ltf","text":"You are tasked with setting up and configuring Microsoft Defender for Office 365 anti-phishing policy.","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}},{"depth":0,"data":{},"text":"Management has asked you to enable mailbox intelligence for all users.","entityRanges":[],"key":"1o6pn","inlineStyleRanges":[],"type":"unstyled"},{"entityRanges":[],"type":"unstyled","key":"d4hu7","inlineStyleRanges":[],"depth":0,"text":"What do you need to do to verify all mailboxes have mailbox intelligence enabled and working?","data":{}}]},"id":"19TOYt4la","answers":[{"value":"Open Microsoft Azure Active Directory Connect (Azure AD Connect) and configure attribute filtering.","isCorrectAnswer":false},{"value":"Purchase a Enterprise Mobility + Security E5 license for every user.","isCorrectAnswer":false},{"value":"Open Microsoft Azure Active Directory Connect (Azure AD Connect) and select Directory extension attribute sync.","isCorrectAnswer":false},{"value":"Migrate all of the mailboxes hosted on-premises Microsoft 365","isCorrectAnswer":true}],"references":{"blocks":[{"inlineStyleRanges":[],"type":"unstyled","entityRanges":[],"data":{},"text":"Mailbox intelligence will scan a user's mailbox to see if the user has sent or received emails from the sender of an email before. For mailbox intelligence to scan a mailbox then mailbox must be located in Microsoft 365's Exchange Online","key":"fvnj6","depth":0},{"key":"7qat6","depth":0,"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Protecting-email-against-phishing-attacks-GCOOUsSBT ","data":{},"type":"unstyled","entityRanges":[{"key":0,"length":94,"offset":0}]}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protecting-email-against-phishing-attacks-GCOOUsSBT"},"mutability":"MUTABLE","type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/19TOYt4la',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
