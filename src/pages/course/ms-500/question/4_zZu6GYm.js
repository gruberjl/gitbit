...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {question: {blocks: [{entityRanges: [], inlineStyleRanges: [], type: 'unstyled', text: 'You need to prevent any emails that contain information covered by the U.K. Data Protection Act from being sent to people outside of your organization unless the messages are sent to an external domain named gitbit.org.', key: '2mndm', depth: 0, data: {}}, {data: {}, text: 'What should you do to set it up?', inlineStyleRanges: [{style: 'color-rgb(33,37,41)', offset: 0, length: 32}, {length: 32, offset: 0, style: 'bgcolor-rgb(255,255,255)'}, {offset: 0, style: 'fontsize-16', length: 32}, {length: 32, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji', offset: 0}], depth: 0, type: 'unstyled', entityRanges: [], key: 'a99n8'}], entityMap: {}}, id: '4_zZu6GYm', references: {entityMap: {0: {type: 'LINK', mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w'}}, 1: {mutability: 'MUTABLE', type: 'LINK', data: {targetOption: '_blank', url: 'https://www.iorad.com/player/1801811/MS-500---Prevent-any-email-messages-that-contain-data-covered-by-the-U-K--Data-Protection-Act'}}}, blocks: [{text: 'A Data loss prevention (DLP) policy would prevent data from leaving the company that is covered under the U.K. Data Protection Act.', inlineStyleRanges: [{length: 5, style: 'color-rgb(33,37,41)', offset: 24}, {offset: 24, length: 5, style: 'bgcolor-rgb(255,255,255)'}, {offset: 24, style: 'fontsize-16', length: 5}, {style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji', length: 5, offset: 24}], key: 'efejo', type: 'unstyled', depth: 0, entityRanges: [], data: {}}, {entityRanges: [{length: 116, offset: 0, key: 0}], data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w ', key: '67ehb', inlineStyleRanges: [], type: 'unstyled', depth: 0}, {inlineStyleRanges: [], data: {}, text: 'https://www.iorad.com/player/1801811/MS-500---Prevent-any-email-messages-that-contain-data-covered-by-the-U-K--Data-Protection-Act', depth: 0, type: 'unstyled', key: '9uen4', entityRanges: [{key: 1, offset: 0, length: 130}]}, {key: '3ekuh', inlineStyleRanges: [], entityRanges: [], text: 'Open the Microsoft 365 Compliance admin center > Policies > Data loss prevention > Policies > Create policy > Privacy > U.K. Data Protection Act > Next > Disable all locations except Exchange email > Create or customize advanced DLP rules > add an exception and block emails from going outbound > Save your new policy.', depth: 0, data: {}, type: 'ordered-list-item'}]}, answers: [{value: 'In the compliance admin center create a Data Loss Prevention Policy that blocks users from sending information covered under the U.K. Data Protection Act with an exception for gitbit.org', isCorrectAnswer: true}, {isCorrectAnswer: false, value: 'In the Exchange Admin center create a mail flow rule to block inbound emails that contain information covered in the U.K. Data Protection Act with an exception for gitbit.org'}, {isCorrectAnswer: false, value: 'In the Azure Active Ad admin center create a label that marks emails that contain information covered in the U.K. Data Protection Actwith an exception for gitbit.org'}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
