...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"inlineStyleRanges":[],"data":{},"depth":0,"text":"Your organization has a Microsoft 365 tenant with Microsoft 365 E5 licenses.","type":"unstyled","entityRanges":[],"key":"57g3g"},{"text":"Your manager has asked you to reconfigure the email filter to deliver any emails that contain malware without the attachment.","inlineStyleRanges":[],"depth":0,"entityRanges":[],"data":{},"type":"unstyled","key":"cv9u9"},{"key":"d7b8i","data":{},"inlineStyleRanges":[],"entityRanges":[],"text":"What two options do you need to configure?","type":"unstyled","depth":0}],"entityMap":{}},"id":"v-e_rx1Nr","references":{"blocks":[{"depth":0,"key":"a4dok","inlineStyleRanges":[],"data":{},"entityRanges":[],"type":"unstyled","text":"You'll need to create a safe attachments policy with the replace option."},{"key":"cb23c","inlineStyleRanges":[],"type":"unstyled","entityRanges":[{"key":0,"length":105,"offset":0}],"data":{},"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","targetOption":"_blank"}}}},"answers":[{"value":"Policy to create: safe attachments","isCorrectAnswer":true},{"value":"Policy to create: Safe Links","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Policy to create: Anti-spam"},{"isCorrectAnswer":false,"value":"Policy to create: Anti-malware"},{"isCorrectAnswer":false,"value":"Option to configure: Block"},{"value":"Option to configure: Replace","isCorrectAnswer":true},{"value":"Option to configure: Dynamic delivery","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Option to configure: Monitor"},{"value":"Option to configure: Off","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
