...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: true, value: 'Group1'}, {isCorrectAnswer: false, value: 'Group2'}, {isCorrectAnswer: false, value: 'Group3'}, {isCorrectAnswer: true, value: 'Group4'}, {isCorrectAnswer: false, value: 'Group11'}, {isCorrectAnswer: false, value: 'Group12'}, {isCorrectAnswer: true, value: 'Group13'}, {isCorrectAnswer: true, value: 'Group14'}], canonical: 'https://www.gitbit.org/course/ms-500/test/classify-data-using-labels-hy190mz8_/question/to-which-groups-can-you-a-hnt9mftfw', id: 'GlZ4QRRz5', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [{length: 140, offset: 106, style: 'color-rgb(33,37,41)'}, {length: 140, offset: 106, style: 'bgcolor-rgb(255,255,255)'}, {length: 140, offset: 106, style: 'fontsize-16'}, {length: 140, offset: 106, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}], key: 'd19n8', text: 'Your organization has a Microsoft 365 tenant and an on-premises Active Directory domain named gitbit.org. Your on-premises domain is synced to Microsoft 365. Your on-premises domain has the following groups that are being synced to Microsoft 365.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: '5r2qb', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '9fvb7', text: 'Your organization has the following cloud-only groups in Azure AD.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 1, offset: 0}], inlineStyleRanges: [], key: 'b3k1q', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '1dj79', text: 'You\'ve been tasked with creating an information protection label named LabelA. You\'ve created the label and now need to publish the label.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'aoue8', text: 'What groups can you publish LabelA to?', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'Group type chart', height: 'auto', src: 'https://i.ibb.co/ysp7Thd/group-type-chart2.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}, 1: {data: {alignment: 'left', alt: 'Group type chart', height: 'auto', src: 'https://i.ibb.co/VgcSY26/group-type-chart2.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [{key: 0, length: 103, offset: 0}], inlineStyleRanges: [], key: 'cg4bf', text: 'https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'esf1l', text: 'The groups must be mail-enabled.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '604a5', text: 'Labels can be published to any specific user or email-enabled group. The group can be a security group, distribution group, or Microsoft 365 group. The group can have assigned or dynamic membership', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 96, offset: 0}], inlineStyleRanges: [], key: 'b9cbo', text: 'https://docs.microsoft.com/en-us/microsoft-365/compliance/sensitivity-labels?view=o365-worldwide', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/microsoft-365/compliance/sensitivity-labels?view=o365-worldwide'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
