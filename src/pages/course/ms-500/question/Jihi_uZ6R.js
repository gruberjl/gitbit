...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"type":"unstyled","text":"To obscure files / telemetry data sent to Microsoft create the following registry dword on each computer:","depth":0,"inlineStyleRanges":[{"offset":20,"length":9,"style":"color-rgb(33,37,41)"},{"offset":20,"length":9,"style":"bgcolor-rgb(255,255,255)"},{"length":9,"style":"fontsize-16","offset":20},{"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", \"Noto Sans\", \"Liberation Sans\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","length":9,"offset":20}],"entityRanges":[],"key":"4udkg","data":{}},{"entityRanges":[],"type":"unstyled","key":"92ndq","inlineStyleRanges":[],"data":{},"depth":0,"text":"Path: HKEY_CURRENT_USER\\Software\\Policies\\Microsoft\\Office\\16.0\\osm"},{"type":"unstyled","data":{},"depth":0,"text":"Value Name: EnableFileObfuscation","entityRanges":[],"key":"799j","inlineStyleRanges":[]},{"key":"abdh6","depth":0,"entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"Value: 00000001","type":"unstyled"},{"inlineStyleRanges":[],"type":"unstyled","text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","key":"do7oj","entityRanges":[{"length":87,"key":0,"offset":0}],"depth":0,"data":{}},{"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/deployoffice/compat/manage-the-privacy-of-data-monitored-by-telemetry-in-office ","entityRanges":[{"key":1,"length":112,"offset":0}],"depth":0,"key":"djdfo","data":{},"type":"unstyled"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/deployoffice/compat/manage-the-privacy-of-data-monitored-by-telemetry-in-office","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}},"id":"Jihi_uZ6R","answers":[{"value":"On ServerA, run readiness-report-creator.exe","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Configure a registry value on ServerA"},{"value":"Configure a registry value on all the computers","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Run tdadm.exe on all the computers, "}],"question":{"entityMap":{},"blocks":[{"depth":0,"entityRanges":[],"key":"8bh71","inlineStyleRanges":[],"type":"unstyled","text":"Your organization has Microsoft 365 tenant configured with a hybrid on-premises Exchange server.","data":{}},{"type":"unstyled","depth":0,"text":"All computers in the organization run Windows 10 Enterprise, are joined to the domain, and use Microsoft Office 365 ProPlus. ","key":"8v7g9","inlineStyleRanges":[],"entityRanges":[],"data":{}},{"entityRanges":[],"inlineStyleRanges":[],"data":{},"text":"You have a server named ServerA that runs Windows Server 2016 and hosts the telemetry database. You've been tasked with preventing private details in the telemetry data from being sent to Microsoft.","type":"unstyled","depth":0,"key":"4gi3g"},{"key":"d5hjs","inlineStyleRanges":[],"text":"What should you do?","depth":0,"type":"unstyled","data":{},"entityRanges":[]}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: 'Jihi_uZ6R',
      questionIdx: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/Jihi_uZ6R',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
