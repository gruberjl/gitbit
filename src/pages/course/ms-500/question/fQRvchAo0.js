...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"inlineStyleRanges":[],"key":"eac8h","depth":0,"type":"unstyled","entityRanges":[],"data":{},"text":"Your organization has a Microsoft Sentinel workspace that has a connector configured to Azure AD and Microsoft Office 365."},{"key":"dl0ge","type":"unstyled","inlineStyleRanges":[],"text":"You need to configure a Fusion rule template to detect multistage attacks where users sign in by using compromised credentials. Then they delete multiple files from Microsoft OneDrive.","data":{},"depth":0,"entityRanges":[]},{"text":"What do you need to do after you create an active rule that has the default settings?","inlineStyleRanges":[],"data":{},"depth":0,"entityRanges":[],"key":"14fko","type":"unstyled"}],"entityMap":{}},"id":"fQRvchAo0","references":{"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Collect-detect-investigate-and-respond-to-security-threats-using-Microsoft-Sentinel-LEyZMWBSt","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"url":"https://docs.microsoft.com/en-gb/azure/azure-monitor/platform/workbooks-overview","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}},"blocks":[{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Collect-detect-investigate-and-respond-to-security-threats-using-Microsoft-Sentinel-LEyZMWBSt","depth":0,"type":"unstyled","entityRanges":[{"offset":0,"length":136,"key":0}],"key":"fhvtv","inlineStyleRanges":[]},{"entityRanges":[{"length":80,"offset":0,"key":1}],"depth":0,"text":"https://docs.microsoft.com/en-gb/azure/azure-monitor/platform/workbooks-overview","key":"6fug3","data":{},"inlineStyleRanges":[],"type":"unstyled"},{"type":"unstyled","key":"aecsj","depth":0,"text":"Workbooks are a way to view the alerts so it would make sense to create one after activating a rule template.","entityRanges":[],"data":{},"inlineStyleRanges":[]}]},"answers":[{"value":"Setup data connectors.","isCorrectAnswer":false},{"value":"Add a workbook.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Setup a playbook."},{"isCorrectAnswer":false,"value":"Add a custom rule template."}]},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/fQRvchAo0',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
