...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {references: {entityMap: {0: {data: {url: 'https://www.gitbit.org/course/ms-500/learn/Simulating-attacks-with-Microsoft-365-GG4cMY8pK', targetOption: '_blank'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {mutability: 'MUTABLE', type: 'LINK', data: {url: 'https://docs.microsoft.com/en-us/office365/securitycompliance/attack-simulator', targetOption: '_blank'}}}, blocks: [{data: {}, type: 'unstyled', key: '214ch', text: 'To setup the attack simulator you need to be part of one of the following roles:', entityRanges: [], depth: 0, inlineStyleRanges: []}, {key: 'bdad', entityRanges: [], depth: 0, data: {}, inlineStyleRanges: [], text: 'Global Administrator', type: 'unordered-list-item'}, {key: '22c3t', entityRanges: [], text: 'Security Administrator', depth: 0, data: {}, inlineStyleRanges: [], type: 'unordered-list-item'}, {inlineStyleRanges: [], key: 'bs5nt', type: 'unordered-list-item', data: {}, text: 'Attack Simulation Administrators', entityRanges: [], depth: 0}, {key: '1jac5', text: 'Attack Payload Author', type: 'unordered-list-item', depth: 0, inlineStyleRanges: [], data: {}, entityRanges: []}, {entityRanges: [{offset: 0, length: 90, key: 0}], data: {}, depth: 0, inlineStyleRanges: [], key: 'bgsqk', type: 'unstyled', text: 'https://www.gitbit.org/course/ms-500/learn/Simulating-attacks-with-Microsoft-365-GG4cMY8pK'}, {depth: 0, inlineStyleRanges: [], type: 'unstyled', text: 'https://docs.microsoft.com/en-us/office365/securitycompliance/attack-simulator', entityRanges: [{key: 1, length: 78, offset: 0}], key: '1uebk', data: {}}]}, answers: [{value: 'Be a member of the global admins role', isCorrectAnswer: true}, {isCorrectAnswer: false, value: 'Configure Office 365 Advanced Threat Protection (ATP)'}, {value: 'Create a Conditional Access App Control policy for accessing Office 365', isCorrectAnswer: false}, {value: 'Integrate Office 365 Threat Intelligence and Microsoft Defender ATP', isCorrectAnswer: false}], question: {entityMap: {}, blocks: [{key: 'c9ri4', type: 'unstyled', text: 'You have a Microsoft 365 Enterprise E5 subscription.', inlineStyleRanges: [], entityRanges: [], depth: 0, data: {}}, {data: {}, entityRanges: [], depth: 0, text: 'You use Microsoft Defender Advanced Threat Protection (Microsoft Defender ATP). You plan to use Microsoft Office 365 Attack simulator.', key: 'jni0', type: 'unstyled', inlineStyleRanges: []}, {type: 'unstyled', inlineStyleRanges: [], entityRanges: [], data: {}, depth: 0, key: '1i915', text: 'What is a prerequisite for running an Attack simulator?'}]}, id: 'M3QKqClsd'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
