...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV","targetOption":"_blank"}}},"blocks":[{"depth":0,"inlineStyleRanges":[],"key":"3gl08","entityRanges":[],"text":"To automatically add users to groups the group type must be dynamic.","data":{},"type":"unstyled"},{"depth":0,"data":{},"entityRanges":[],"key":"7habk","inlineStyleRanges":[],"type":"unstyled","text":"To have owners verify group members' monthly access reviews must be used."},{"key":"ao7qg","depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV","data":{},"entityRanges":[{"length":95,"key":0,"offset":0}],"type":"unstyled","inlineStyleRanges":[]}]},"id":"nqg-OA0M5","answers":[{"isCorrectAnswer":true,"value":"Users should be automatically added to the security group corresponding to their department: dynamic groups"},{"isCorrectAnswer":false,"value":"Users should be automatically added to the security group corresponding to their department: Access packages"},{"value":"Users should be automatically added to the security group corresponding to their department: Conditional access policies","isCorrectAnswer":false},{"value":"Users should be automatically added to the security group corresponding to their department: Assigned groups","isCorrectAnswer":false},{"value":"All group owners must verify their group membership: Access reviews","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"All group owners must verify their group membership: Access packages"},{"isCorrectAnswer":false,"value":"All group owners must verify their group membership: Dynamic groups"},{"isCorrectAnswer":false,"value":"All group owners must verify their group membership: Data loss prevention policies"}],"question":{"entityMap":{},"blocks":[{"data":{},"depth":0,"text":"Your organization has a Microsoft 365 tenant. User accounts are synced from your organization's human resources system to Azure AD.","entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","key":"3v3m9"},{"text":"Your organization has five departments that each have there own Microsoft SharePoint Online site. Every user must be granted access to their own department's site. No users should be able to access a site that is not a member of the site's respective department.","type":"unstyled","key":"62b11","depth":0,"data":{},"entityRanges":[],"inlineStyleRanges":[]},{"text":"Your manager has asked you to configure the security of the SharePoint sites. He's given you the following requirements:","entityRanges":[],"key":"a1nta","data":{},"type":"unstyled","depth":0,"inlineStyleRanges":[]},{"data":{},"text":"Users should be automatically added to the security group corresponding to their department.","type":"unordered-list-item","entityRanges":[],"key":"7l3dd","depth":0,"inlineStyleRanges":[]},{"text":"All group owners must verify their group membership only contains their department's users once a month.","type":"unordered-list-item","depth":0,"inlineStyleRanges":[],"key":"5pl79","data":{},"entityRanges":[]},{"depth":0,"entityRanges":[],"key":"fospn","data":{},"inlineStyleRanges":[],"type":"unstyled","text":"How do you configure Microsoft 365 to meet the security requirements?"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/nqg-OA0M5',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
