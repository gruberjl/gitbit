...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"entityMap":{},"blocks":[{"text":"Your manager has asked you to configure the following in Microsoft 365.","depth":0,"inlineStyleRanges":[],"entityRanges":[],"key":"347i8","data":{},"type":"unstyled"},{"entityRanges":[],"key":"e44co","depth":0,"text":"Set guest access to be reviewed every 30 days.","type":"unordered-list-item","inlineStyleRanges":[],"data":{}},{"type":"unordered-list-item","entityRanges":[],"data":{},"text":"Grant John Gruber the ability to invite guests to the Microsoft 365 tenant.","key":"am7ii","inlineStyleRanges":[],"depth":0},{"text":"Your organization adheres to the principle of least privilege.","inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"9mktc","depth":0,"type":"unstyled"},{"entityRanges":[],"type":"unstyled","data":{},"text":"What should you do?","key":"39v8l","inlineStyleRanges":[],"depth":0}]},"answers":[{"value":"Create an access review policy.","isCorrectAnswer":true},{"value":"Grant John Gruber the global admin role.","isCorrectAnswer":false},{"value":"Grant John Gruber the Guest inviter role.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"In Azure Active Directory admin center modify the external collaboration settings."}],"id":"68uahG_lV","references":{"blocks":[{"type":"unstyled","entityRanges":[],"data":{},"depth":0,"inlineStyleRanges":[],"key":"f88oc","text":"To configure guest access review you must create an access review policy."},{"inlineStyleRanges":[],"key":"89v07","type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":94}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","depth":0},{"inlineStyleRanges":[],"text":"Assigning the Guest invited role to John Gruber will give him the ability to invite guests. Global admins can also invite guests but that would give John Gruber way too many permissions.","entityRanges":[],"data":{},"key":"8osgc","depth":0,"type":"unstyled"},{"entityRanges":[{"key":1,"offset":0,"length":95}],"type":"unstyled","inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","key":"f6dp9","depth":0},{"key":"f8u8p","type":"unstyled","depth":0,"text":"https://docs.microsoft.com/en-us/microsoft-365/solutions/create-secure-guest-sharing-environment?view=o365-worldwide#set-up-guest-access-reviews","inlineStyleRanges":[],"entityRanges":[{"key":2,"offset":0,"length":144}],"data":{}}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2"}},"1":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","targetOption":"_blank"},"type":"LINK"},"2":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/microsoft-365/solutions/create-secure-guest-sharing-environment?view=o365-worldwide#set-up-guest-access-reviews","targetOption":"_blank"},"type":"LINK"}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '68uahG_lV',
      questionIdx: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/68uahG_lV',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
