...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: true, value: 'A sales user who is logging in from the Montreal office will be prompted for MFA.'}, {isCorrectAnswer: true, value: 'A sales user who signs in from home with a public IP address of 193.77.140.140 will be prompted for MFA.'}, {isCorrectAnswer: false, value: 'A sales user who is logging in from the New York office will be prompted for Azure MFA credentials.'}], canonical: 'https://www.gitbit.org/course/ms-500/test/configure-and-manage-multi-factor-authentication-mfa-yjeapbng4/question/you-are-evaluating-which--drh8qcbbu', id: 'PUWxVj7lH', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2qdub', text: 'Your organization has the offices in the following chart. Each office has the following IP addresses.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: '5llr', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'c07p6', text: 'You\'ve configured named locations in Azure AD as below.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 1, offset: 0}], inlineStyleRanges: [], key: 'a8u3o', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [{length: 33, offset: 76, style: 'color-rgb(33,37,41)'}, {length: 33, offset: 76, style: 'bgcolor-rgb(255,255,255)'}, {length: 33, offset: 76, style: 'fontsize-16'}, {length: 33, offset: 76, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}], key: 'c772p', text: 'An address space of 198.35.3.0/24 is defined in the trusted IPs list on the Multi-Factor Authentication page.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '8d983', text: 'MFA is enabled for the users in the sales department.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'bcs2k', text: 'You are evaluating which sales department users will be prompted for MFA.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '99kqm', text: 'Check the box for each true statement.', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'Chart of locations and IP addresses', height: 'auto', src: 'https://i.ibb.co/tBQ9xgK/location-chart.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}, 1: {data: {alignment: 'left', alt: 'Trusted Locations Chart', height: 'auto', src: 'https://i.ibb.co/dJnwkFX/trusted-locations-chart.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '6icl3', text: 'The only trusted IP address is the New York office. So sales users connecting from the New York office will not be prompted for MFA. All other users will be prompted for MFA.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 86, offset: 0}], inlineStyleRanges: [], key: '4236g', text: 'https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 175, offset: 0}], inlineStyleRanges: [], key: '4al6p', text: 'https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
