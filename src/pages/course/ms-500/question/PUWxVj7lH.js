...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{value: 'A sales user who is logging in from the Montreal office will be prompted for MFA.', isCorrectAnswer: true}, {isCorrectAnswer: true, value: 'A sales user who signs in from home with a public IP address of 193.77.140.140 will be prompted for MFA.'}, {isCorrectAnswer: false, value: 'A sales user who is logging in from the New York office will be prompted for Azure MFA credentials.'}], references: {blocks: [{type: 'unstyled', depth: 0, entityRanges: [], text: 'The only trusted IP address is the New York office. So sales users connecting from the New York office will not be prompted for MFA. All other users will be prompted for MFA.', inlineStyleRanges: [], key: '6icl3', data: {}}, {entityRanges: [{offset: 0, key: 0, length: 86}], type: 'unstyled', text: 'https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh', key: '4236g', depth: 0, data: {}, inlineStyleRanges: []}, {type: 'unstyled', key: '4al6p', text: 'https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block', inlineStyleRanges: [], depth: 0, entityRanges: [{offset: 0, key: 1, length: 175}], data: {}}], entityMap: {0: {type: 'LINK', mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Whats-a-conditional-access-policy-V1en9Iugh'}}, 1: {type: 'LINK', mutability: 'MUTABLE', data: {url: 'https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/location-condition#:~:text=and%20IPv6%20addresses.-,Named%20locations,that%20you%20wish%20to%20block', targetOption: '_blank'}}}}, question: {entityMap: {0: {mutability: 'MUTABLE', type: 'IMAGE', data: {width: 'auto', src: 'https://i.ibb.co/tBQ9xgK/location-chart.png', height: 'auto', alignment: 'left', alt: 'Chart of locations and IP addresses'}}, 1: {mutability: 'MUTABLE', data: {width: 'auto', height: 'auto', alt: 'Trusted Locations Chart', alignment: 'left', src: 'https://i.ibb.co/dJnwkFX/trusted-locations-chart.png'}, type: 'IMAGE'}}, blocks: [{entityRanges: [], data: {}, type: 'unstyled', inlineStyleRanges: [], key: '2qdub', depth: 0, text: 'Your organization has the offices in the following chart. Each office has the following IP addresses.'}, {type: 'atomic', key: '5llr', depth: 0, text: ' ', inlineStyleRanges: [], entityRanges: [{key: 0, length: 1, offset: 0}], data: {}}, {type: 'unstyled', data: {}, key: 'c07p6', text: 'You\'ve configured named locations in Azure AD as below.', entityRanges: [], depth: 0, inlineStyleRanges: []}, {entityRanges: [{key: 1, length: 1, offset: 0}], data: {}, inlineStyleRanges: [], key: 'a8u3o', depth: 0, type: 'atomic', text: ' '}, {depth: 0, entityRanges: [], inlineStyleRanges: [{style: 'color-rgb(33,37,41)', length: 33, offset: 76}, {style: 'bgcolor-rgb(255,255,255)', length: 33, offset: 76}, {style: 'fontsize-16', length: 33, offset: 76}, {offset: 76, length: 33, style: 'fontfamily-system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", "Noto Sans", "Liberation Sans", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji'}], key: 'c772p', data: {}, text: 'An address space of 198.35.3.0/24 is defined in the trusted IPs list on the Multi-Factor Authentication page.', type: 'unstyled'}, {key: '8d983', depth: 0, type: 'unstyled', entityRanges: [], data: {}, text: 'MFA is enabled for the users in the sales department.', inlineStyleRanges: []}, {entityRanges: [], text: 'You are evaluating which sales department users will be prompted for MFA.', depth: 0, inlineStyleRanges: [], type: 'unstyled', key: 'bcs2k', data: {}}, {depth: 0, key: '99kqm', type: 'unstyled', inlineStyleRanges: [], entityRanges: [], text: 'Check the box for each true statement.', data: {}}]}, id: 'PUWxVj7lH'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
