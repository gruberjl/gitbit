...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"text":"Your organization has the IP address ranges shown below.","data":{},"depth":0,"entityRanges":[],"type":"unstyled","key":"f01np","inlineStyleRanges":[]},{"inlineStyleRanges":[],"data":{},"key":"9m2gt","text":" ","type":"atomic","depth":0,"entityRanges":[{"key":0,"length":1,"offset":0}]},{"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","data":{},"text":"Users must use MFA unless they are signing in from the internal network of the Chicago office.","depth":0,"key":"dj2i8"},{"entityRanges":[],"text":"Which IP addresses should you configure in the Trusted IP list for MFA?","key":"5rj92","depth":0,"data":{},"inlineStyleRanges":[],"type":"unstyled"}],"entityMap":{"0":{"data":{"width":"auto","height":"auto","alignment":"left","alt":"Location chart","src":"https://i.ibb.co/9rgYK1j/location-chart.png"},"mutability":"MUTABLE","type":"IMAGE"}}},"answers":[{"isCorrectAnswer":true,"value":"131.107.83.0/28"},{"isCorrectAnswer":false,"value":"192.168.16.0/20"},{"isCorrectAnswer":false,"value":"172.16.0.0/24"},{"isCorrectAnswer":false,"value":"192.168.0.0/20"}],"references":{"blocks":[{"entityRanges":[],"data":{},"key":"4eaep","depth":0,"inlineStyleRanges":[],"text":"You'll need to exclude the external network also known as the public IP address.","type":"unstyled"},{"entityRanges":[{"length":128,"offset":0,"key":0}],"data":{},"type":"unstyled","key":"fbnj5","depth":0,"inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"},{"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-mfasettings#trusted-ips","type":"unstyled","key":"a13ld","depth":0,"data":{},"entityRanges":[{"offset":0,"key":1,"length":104}]}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/The-many-ways-to-implement-multi-factor-authentication-MFA-in-Microsoft-365-nAAIvNbtk"}},"1":{"data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/authentication/howto-mfa-mfasettings#trusted-ips","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}},"id":"dvF9bwI9i"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/dvF9bwI9i',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
