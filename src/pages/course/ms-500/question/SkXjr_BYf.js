...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {"question":{"entityMap":{},"blocks":[{"key":"8rhoa","text":"All the devices in the Microsoft 365 tenant are managed by using Microsoft Intune.","data":{},"entityRanges":[],"inlineStyleRanges":[],"depth":0,"type":"unstyled"},{"data":{},"text":"Your organization has purchased an app named AppA.","type":"unstyled","entityRanges":[],"key":"7kn79","depth":0,"inlineStyleRanges":[]},{"depth":0,"text":"AppA that supports Microsoft's session controls.","entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"3feh","type":"unstyled"},{"type":"unstyled","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"bnqig","depth":0,"text":"Your manager asks you to configure AppA so it can be reviewed in real-time."},{"key":"9k3bk","type":"unstyled","inlineStyleRanges":[],"text":"What do you need to do?","entityRanges":[],"data":{},"depth":0}]},"id":"SkXjr_BYf","references":{"blocks":[{"data":{},"depth":0,"text":"You'll need to perform three steps to manage a device:","entityRanges":[],"type":"unstyled","key":"2cg64","inlineStyleRanges":[]},{"inlineStyleRanges":[],"text":"From the Azure AD admin center, register AppA.","entityRanges":[],"key":"dgocv","type":"ordered-list-item","depth":0,"data":{}},{"text":"From the Azure AD admin center, create a conditional access policy.","entityRanges":[],"depth":0,"data":{},"inlineStyleRanges":[],"type":"ordered-list-item","key":"3bh87"},{"data":{},"key":"59ba8","type":"ordered-list-item","depth":0,"inlineStyleRanges":[],"entityRanges":[],"text":"From the Cloud App Security admin center, create an access policy."},{"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","entityRanges":[{"key":0,"offset":0,"length":69}],"key":"16k6h","data":{},"type":"unstyled","depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad"},"type":"LINK"}}},"answers":[{"isCorrectAnswer":true,"value":"From the Azure AD admin center, register AppA. Then create a conditional access policy. From the Cloud App Security admin center, create an access policy."},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, register AppA. Then from the Cloud App Security admin center, create an access policy. Then create an app discovery policy."},{"isCorrectAnswer":false,"value":"From the Cloud App Security admin center, create an access policy. Then from the Endpoint Management admin center, create an app configuration policy. Finally, from the Azure AD admin center, create a conditional access policy."},{"isCorrectAnswer":false,"value":"From the Endpoint Management admin center, add AppA. Then from the Azure AD admin center, create a conditional access policy. Finally from the Endpoint Management admin center, create an app configuration policy."}]},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
