...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"SkXjr_BYf","question":{"entityMap":{},"blocks":[{"key":"8rhoa","type":"unstyled","entityRanges":[],"text":"All the devices in the Microsoft 365 tenant are managed by using Microsoft Intune.","data":{},"depth":0,"inlineStyleRanges":[]},{"key":"7kn79","depth":0,"text":"Your organization has purchased an app named AppA.","type":"unstyled","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"data":{},"key":"3feh","depth":0,"entityRanges":[],"type":"unstyled","text":"AppA that supports Microsoft's session controls.","inlineStyleRanges":[]},{"entityRanges":[],"text":"Your manager asks you to configure AppA so it can be reviewed in real-time.","inlineStyleRanges":[],"data":{},"key":"bnqig","depth":0,"type":"unstyled"},{"inlineStyleRanges":[],"depth":0,"key":"9k3bk","data":{},"text":"What do you need to do?","entityRanges":[],"type":"unstyled"}]},"references":{"blocks":[{"data":{},"depth":0,"type":"unstyled","text":"You'll need to perform three steps to manage a device:","inlineStyleRanges":[],"entityRanges":[],"key":"2cg64"},{"text":"From the Azure AD admin center, register AppA.","inlineStyleRanges":[],"type":"ordered-list-item","depth":0,"entityRanges":[],"data":{},"key":"dgocv"},{"type":"ordered-list-item","data":{},"inlineStyleRanges":[],"entityRanges":[],"key":"3bh87","text":"From the Azure AD admin center, create a conditional access policy.","depth":0},{"entityRanges":[],"depth":0,"data":{},"text":"From the Cloud App Security admin center, create an access policy.","key":"59ba8","inlineStyleRanges":[],"type":"ordered-list-item"},{"entityRanges":[{"offset":0,"key":0,"length":69}],"inlineStyleRanges":[],"key":"16k6h","data":{},"text":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","type":"unstyled","depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/cloud-app-security/access-policy-aad","targetOption":"_blank"},"type":"LINK"}}},"answers":[{"value":"From the Azure AD admin center, register AppA. Then create a conditional access policy. From the Cloud App Security admin center, create an access policy.","isCorrectAnswer":true},{"value":"From the Azure AD admin center, register AppA. Then from the Cloud App Security admin center, create an access policy. Then create an app discovery policy.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Cloud App Security admin center, create an access policy. Then from the Endpoint Management admin center, create an app configuration policy. Finally, from the Azure AD admin center, create a conditional access policy."},{"value":"From the Endpoint Management admin center, add AppA. Then from the Azure AD admin center, create a conditional access policy. Finally from the Endpoint Management admin center, create an app configuration policy.","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/SkXjr_BYf',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
