...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"1t28BBQF2","references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w"}},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/data-loss-prevention-policies","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"key":"2voqv","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"Since \"use notifications to inform your users\" is enabled the user will receive a notification. Since \"Let people who see the tip override the policy\" is enabled the users can still send the email.","type":"unstyled"},{"key":"5dif5","depth":0,"type":"unstyled","entityRanges":[{"key":0,"offset":0,"length":116}],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w","inlineStyleRanges":[]},{"type":"unstyled","entityRanges":[{"offset":0,"length":91,"key":1}],"inlineStyleRanges":[],"key":"5rj2r","data":{},"depth":0,"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/data-loss-prevention-policies"}]},"answers":[{"value":"The user receives a notification and can send the email message","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"The user receives a notification and cannot send the email message"},{"isCorrectAnswer":false,"value":"The email message is sent without a notification"},{"value":"The email message is blocked silently","isCorrectAnswer":false}],"question":{"entityMap":{"0":{"type":"IMAGE","data":{"width":"auto","src":"https://i.ibb.co/yps31hV/DLP.png","height":"auto","alt":"DLP Policy"},"mutability":"MUTABLE"}},"blocks":[{"inlineStyleRanges":[],"key":"56ko9","type":"unstyled","entityRanges":[],"depth":0,"data":{},"text":"You create a data loss prevention (DLP) policy as shown in the following exhibit:"},{"inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[{"length":1,"key":0,"offset":0}],"key":"7l9vs","type":"atomic","text":" "},{"text":"What is the effect of the policy when a user attempts to send an email message that contains sensitive information? ","entityRanges":[],"inlineStyleRanges":[{"style":"color-rgb(80,80,80)","offset":0,"length":115},{"style":"bgcolor-rgb(255,255,255)","length":115,"offset":0},{"style":"fontsize-16","length":115,"offset":0},{"style":"fontfamily-Roboto Condensed\", sans-serif","length":115,"offset":0}],"key":"fn926","data":{},"depth":0,"type":"unstyled"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/1t28BBQF2',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
