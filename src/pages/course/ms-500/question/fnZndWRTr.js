...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"fnZndWRTr","question":{"entityMap":{},"blocks":[{"entityRanges":[],"text":"You have a Microsoft 365 subscription.","inlineStyleRanges":[],"key":"46kh2","depth":0,"type":"unstyled","data":{}},{"text":"The Global administrator role is assigned to your user account. You have a user named Admin1.","type":"unstyled","data":{},"key":"6qs2l","depth":0,"entityRanges":[],"inlineStyleRanges":[]},{"type":"unstyled","data":{},"key":"653k","text":"You create an eDiscovery case named Case1.","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"key":"3avhu","depth":0,"text":"You need to ensure that Admin1 can view the results of Case1.","entityRanges":[],"inlineStyleRanges":[],"data":{},"type":"unstyled"},{"type":"unstyled","text":"What should you do first?","inlineStyleRanges":[],"key":"chmgb","entityRanges":[],"depth":0,"data":{}}]},"references":{"blocks":[{"type":"unstyled","depth":0,"text":"The user will need the eDiscovery Manager role assigned and then be given the permissions to the case.","entityRanges":[],"key":"20j6g","data":{},"inlineStyleRanges":[]},{"data":{},"entityRanges":[],"depth":0,"text":"1. Go to Microsoft Purview admin center > Permissions > Microsoft Purview solutions roles  > eDiscovery Manager. Click Edit next to eDiscovery Manager.","inlineStyleRanges":[],"key":"6f8bi","type":"unstyled"},{"key":"7eq0k","depth":0,"type":"unstyled","entityRanges":[],"text":"2. Click Choose eDisvoery Manager > Add. Click the member you want to grant permissions to. Click Add. Click Done > Save.","data":{},"inlineStyleRanges":[]},{"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","depth":0,"type":"unstyled","entityRanges":[{"length":114,"offset":0,"key":0}],"key":"ch81d","inlineStyleRanges":[]},{"data":{},"entityRanges":[{"offset":0,"key":1,"length":91}],"key":"3uetn","depth":0,"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions","type":"unstyled","inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f","targetOption":"_blank"},"type":"LINK"},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions"},"type":"LINK","mutability":"MUTABLE"}}},"answers":[{"isCorrectAnswer":false,"value":"From the Azure Active Directory admin center, assign a role group to Admin1."},{"value":"From the Microsoft 365 admin center, assign a role to Admin1.","isCorrectAnswer":false},{"value":"From the Microsoft Purview admin center, open the case and go to Settings > Access & permissions","isCorrectAnswer":true}]},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/fnZndWRTr',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
