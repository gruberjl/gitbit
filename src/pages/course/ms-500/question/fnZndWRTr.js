...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'From the Azure Active Directory admin center, assign a role group to Admin1.'}, {isCorrectAnswer: false, value: 'From the Microsoft 365 admin center, assign a role to Admin1.'}, {isCorrectAnswer: true, value: 'From the Microsoft Purview admin center, open the case and go to Settings > Access & permissions'}], canonical: 'https://www.gitbit.org/course/ms-500/test/configuring-and-managing-retention-wuxs_obk8/question/admin1-can-view-the-resul-jhsmnhhwq', id: 'fnZndWRTr', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '46kh2', text: 'You have a Microsoft 365 subscription.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '6qs2l', text: 'The Global administrator role is assigned to your user account. You have a user named Admin1.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '653k', text: 'You create an eDiscovery case named Case1.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '3avhu', text: 'You need to ensure that Admin1 can view the results of Case1.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'chmgb', text: 'What should you do first?', type: 'unstyled'}], entityMap: {}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '20j6g', text: 'The user will need the eDiscovery Manager role assigned and then be given the permissions to the case.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '6f8bi', text: '1. Go to Microsoft Purview admin center > Permissions > Microsoft Purview solutions roles  > eDiscovery Manager. Click Edit next to eDiscovery Manager.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '7eq0k', text: '2. Click Choose eDisvoery Manager > Add. Click the member you want to grant permissions to. Click Add. Click Done > Save.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 114, offset: 0}], inlineStyleRanges: [], key: 'ch81d', text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 91, offset: 0}], inlineStyleRanges: [], key: '3uetn', text: 'https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/office365/securitycompliance/assign-ediscovery-permissions'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
