...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV","targetOption":"_blank"}}},"blocks":[{"type":"unstyled","key":"5v7ud","inlineStyleRanges":[],"entityRanges":[],"data":{},"text":"A security group is required to set permissions in Microsoft 365. A security group can be created in Microsoft 365 admin center or Azure AD admin center (they both create the same groups)","depth":0},{"depth":0,"data":{},"entityRanges":[{"length":95,"key":0,"offset":0}],"key":"2ckp5","type":"unstyled","inlineStyleRanges":[],"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-users-through-groups-S1hQgFOMV"}]},"id":"JLdb6vJCH","answers":[{"value":"An Office 365 group in the Microsoft 365 admin center","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"A security group in the Microsoft 365 admin center"},{"isCorrectAnswer":false,"value":"A distribution list in the Microsoft 365 admin center"},{"isCorrectAnswer":true,"value":"A security group in the Azure AD admin center"}],"question":{"blocks":[{"text":"What are two ways you can create a group that will be used to provide limited access to Windows Analytics?","key":"53jih","entityRanges":[],"depth":0,"data":{},"type":"unstyled","inlineStyleRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/JLdb6vJCH',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
