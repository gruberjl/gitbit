...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"type":"unstyled","depth":0,"text":"You can view the sign-in logs from Azure Active Directory admin center > Enterprise applications > Sign-in logs.","key":"18nsd","entityRanges":[],"data":{},"inlineStyleRanges":[]},{"entityRanges":[{"key":0,"length":105,"offset":0}],"data":{},"depth":0,"type":"unstyled","inlineStyleRanges":[],"key":"7qvcs","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},{"inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins","depth":0,"type":"unstyled","entityRanges":[{"length":91,"offset":0,"key":1}],"data":{},"key":"e7m5a"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},"mutability":"MUTABLE","type":"LINK"},"1":{"type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/azure/active-directory/reports-monitoring/concept-sign-ins"},"mutability":"MUTABLE"}}},"answers":[{"isCorrectAnswer":false,"value":"Go to the Security & Compliance admin center and download a report."},{"isCorrectAnswer":false,"value":"Go to the Azure Log Analytics and query the logs."},{"value":"Go to the Microsoft Defender admin center and perform an audit log search.","isCorrectAnswer":false},{"value":"Go to the Enterprise applications blade of the Azure AD admin center and view the sign-in logs.","isCorrectAnswer":true}],"question":{"blocks":[{"text":"Your organization has a Microsoft 365 tenant. Only some of your users are required to use an MFA to access Microsoft SharePoint Online.","key":"3d6td","data":{},"inlineStyleRanges":[],"depth":0,"type":"unstyled","entityRanges":[]},{"inlineStyleRanges":[],"entityRanges":[],"data":{},"key":"f5jt4","depth":0,"text":"You need to view which users have used MFA to access SharePoint Online.","type":"unstyled"},{"data":{},"depth":0,"inlineStyleRanges":[],"text":"What do you do?","entityRanges":[],"key":"9ses4","type":"unstyled"}],"entityMap":{}},"id":"5ledeExCv"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/5ledeExCv',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
