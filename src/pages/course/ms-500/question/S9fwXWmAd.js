...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: true, value: 'If a user creates a file in Microsoft OneDrive on January 1, 2018, users can access the file on January 15, 2019'}, {isCorrectAnswer: true, value: 'If a user deletes a file in Microsoft OneDrive on January 1, 2018, an administrator can recover the file on April 15, 2019'}, {isCorrectAnswer: false, value: 'If a user creates a file in Microsoft OneDrive on January 1, 2018, an administrator can recover the file on April 15, 2022'}], id: 'S9fwXWmAd', question: {entityMap: {0: {mutability: 'MUTABLE', type: 'IMAGE', data: {width: 'auto', alt: 'Policy locations chart', alignment: 'left', src: 'https://i.ibb.co/VTTN5M2/policy-locations.png', height: 'auto'}}, 1: {mutability: 'MUTABLE', data: {alignment: 'left', alt: 'Policy1 Retention Policy', src: 'https://i.ibb.co/Z825ptq/Policy1-Retention-Policy.png', height: 'auto', width: 'auto'}, type: 'IMAGE'}, 2: {data: {height: 'auto', width: 'auto', src: 'https://i.ibb.co/dKBJVmq/Policy2-Retention-Policy.png', alignment: 'left', alt: 'Policy2 Retention Policy'}, type: 'IMAGE', mutability: 'MUTABLE'}}, blocks: [{text: 'You have a Microsoft 365 subscription. From the Security & Compliance admin center, you create the retention policies shown in the following table.', data: {}, type: 'unstyled', entityRanges: [], depth: 0, inlineStyleRanges: [], key: '4nfs6'}, {entityRanges: [{length: 1, offset: 0, key: 0}], key: '3upt2', type: 'atomic', data: {}, inlineStyleRanges: [], text: ' ', depth: 0}, {text: 'Policy1 is configured as showing in the following exhibit.', type: 'unstyled', entityRanges: [], data: {}, key: 'ds2hq', depth: 0, inlineStyleRanges: []}, {inlineStyleRanges: [], text: ' ', entityRanges: [{length: 1, key: 1, offset: 0}], type: 'atomic', depth: 0, data: {}, key: '1n74n'}, {data: {}, key: '1bram', text: 'Policy2 is configured as shown in the following exhibit.', entityRanges: [], type: 'unstyled', depth: 0, inlineStyleRanges: []}, {data: {}, key: 'fi15k', entityRanges: [{key: 2, length: 1, offset: 0}], type: 'atomic', text: ' ', depth: 0, inlineStyleRanges: []}, {inlineStyleRanges: [], text: 'For each of the following statements, check the box if the statement is true.', type: 'unstyled', depth: 0, entityRanges: [], data: {}, key: '2chn0'}]}, references: {entityMap: {0: {data: {url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f', targetOption: '_blank'}, type: 'LINK', mutability: 'MUTABLE'}, 1: {mutability: 'MUTABLE', data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/office365/securitycompliance/retention-policies?redirectSourcePath=%252fen-us%252farticle%252fOverview-of-retention-'}, type: 'LINK'}}, blocks: [{text: 'Policy2 is in effect because retention wins over deletion. Content won\'t be permanently deleted when it also has retention settings to retain it.', data: {}, inlineStyleRanges: [], type: 'unstyled', entityRanges: [], depth: 0, key: 'dspqb'}, {entityRanges: [{key: 0, length: 114, offset: 0}], key: '4emjm', depth: 0, type: 'unstyled', inlineStyleRanges: [], text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-data-retention-to-conform-to-compliance-NsF7No40f', data: {}}, {inlineStyleRanges: [], key: '326tf', depth: 0, text: 'https://docs.microsoft.com/en-us/office365/securitycompliance/retention-policies?redirectSourcePath=%252fen-us%252farticle%252fOverview-of-retention- policies-5e377752-700d-4870-9b6d-12bfc12d2423#the-principles-of-retention-or-what-takes-precedence ', entityRanges: [{length: 248, key: 1, offset: 0}], type: 'unstyled', data: {}}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
