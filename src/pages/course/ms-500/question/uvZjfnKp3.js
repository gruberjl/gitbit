...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {references: {blocks: [{depth: 0, data: {}, text: 'Under actions you\'ll notice Notify users with email and policy tips is selected but no blocked action is listed.', type: 'unstyled', key: '7go93', inlineStyleRanges: [], entityRanges: []}, {entityRanges: [{length: 116, key: 0, offset: 0}], depth: 0, key: '324t0', data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w', type: 'unstyled', inlineStyleRanges: []}, {type: 'unstyled', key: 'c3u9t', entityRanges: [{key: 1, length: 91, offset: 0}], inlineStyleRanges: [], depth: 0, text: 'https://docs.microsoft.com/en-us/office365/securitycompliance/data-loss-prevention-policies', data: {}}], entityMap: {0: {type: 'LINK', mutability: 'MUTABLE', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Preventing-accidental-and-malicious-data-loss-with-DLP-policies-IsPGsme8w', targetOption: '_blank'}}, 1: {mutability: 'MUTABLE', type: 'LINK', data: {url: 'https://docs.microsoft.com/en-us/office365/securitycompliance/data-loss-prevention-policies', targetOption: '_blank'}}}}, answers: [{value: 'The user can send the email but will be notified.', isCorrectAnswer: true}, {isCorrectAnswer: false, value: 'The user cannot send the email and will be notified.'}, {isCorrectAnswer: false, value: 'The user can send the email and won\'t be notified.'}, {isCorrectAnswer: false, value: 'The user cannot send the email and won\'t be notified.'}], question: {blocks: [{key: 'c9bpl', data: {}, entityRanges: [], type: 'unstyled', text: 'Your organization has the DLP policy shown below.', depth: 0, inlineStyleRanges: [{style: 'color-rgb(80,80,80)', length: 49, offset: 0}, {style: 'bgcolor-rgb(255,255,255)', offset: 0, length: 49}, {length: 49, offset: 0, style: 'fontsize-16'}, {offset: 0, length: 49, style: 'fontfamily-Roboto Condensed", sans-serif'}]}, {key: 'bgjnr', depth: 0, data: {}, type: 'atomic', inlineStyleRanges: [], entityRanges: [{key: 0, length: 1, offset: 0}], text: ' '}, {type: 'unstyled', data: {}, inlineStyleRanges: [{offset: 0, length: 77, style: 'color-rgb(80,80,80)'}, {length: 77, style: 'bgcolor-rgb(255,255,255)', offset: 0}, {style: 'fontsize-16', length: 77, offset: 0}, {length: 77, offset: 0, style: 'fontfamily-Roboto Condensed", sans-serif'}], key: '63v4p', depth: 0, text: 'What will happen if a user sends an email that contains a credit card number?', entityRanges: []}], entityMap: {0: {type: 'IMAGE', mutability: 'MUTABLE', data: {width: 'auto', src: 'https://i.ibb.co/Pj5sngf/DLP-Rules.png', height: 'auto', alignment: 'left', alt: 'DLP Rules'}}}}, id: 'uvZjfnKp3'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
