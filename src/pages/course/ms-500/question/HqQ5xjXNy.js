...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"text":"Your organization has a Microsoft 365 tenant with Microsoft 365 E5 licenses.","key":"f48pv","inlineStyleRanges":[],"data":{},"type":"unstyled","entityRanges":[],"depth":0},{"depth":0,"entityRanges":[],"type":"unstyled","key":"9sjqb","inlineStyleRanges":[],"data":{},"text":"You've just implemented a Defender for Office 365 safe attachments policy for your entire organization."},{"inlineStyleRanges":[],"data":{},"type":"unstyled","entityRanges":[],"key":"c7c6m","text":"Your help desk is getting calls that emails containing attachments are taking a long to be received.","depth":0},{"key":"fj3du","entityRanges":[],"text":"You need to reconfigure the safe attachments policy so emails are received more quickly but the attachments still need to be scanned for malware and any attachments with malware must be blocked.","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[],"text":"How should you reconfigure the safe attachment policy?","key":"4jaft"}],"entityMap":{}},"answers":[{"value":"Set the action to block current and future messages and attachments with detected malware.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Add an exception for emails coming from gitbit.org"},{"isCorrectAnswer":false,"value":"Add a condition"},{"isCorrectAnswer":true,"value":"Set the action to Dynamic Delivery"}],"references":{"blocks":[{"inlineStyleRanges":[],"text":"Sometimes safe attachments cause a delay in email delivery. When you're users complain that there is a delay when receiving emails with attachments then this option may be for you. In short, the email will be delivered automatically to the user's inbox and then after the scanning is complete the attachment will show up.","data":{},"type":"unstyled","entityRanges":[],"depth":0,"key":"aq9gm"},{"depth":0,"data":{},"entityRanges":[{"key":0,"offset":0,"length":105}],"key":"6nn73","text":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL","type":"unstyled","inlineStyleRanges":[]},{"key":"3id4q","type":"unstyled","inlineStyleRanges":[],"data":{},"entityRanges":[{"key":1,"length":93,"offset":0}],"text":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing","depth":0}],"entityMap":{"0":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Protect-your-email-environment-from-malicious-actors-6HUOr7qbL"}},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/office365/securitycompliance/dynamic-delivery-and-previewing","targetOption":"_blank"}}}},"id":"HqQ5xjXNy"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/HqQ5xjXNy',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
