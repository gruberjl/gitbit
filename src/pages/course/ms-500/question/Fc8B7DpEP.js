...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"Fc8B7DpEP","references":{"blocks":[{"depth":0,"key":"5ipu7","data":{},"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured."},{"key":"2hgvf","type":"unstyled","depth":0,"inlineStyleRanges":[],"text":"To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.","entityRanges":[],"data":{}},{"type":"unstyled","entityRanges":[{"key":0,"length":69,"offset":0}],"inlineStyleRanges":[],"depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","key":"ho77"}],"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P","targetOption":"_blank"}}}},"question":{"blocks":[{"text":"Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn't enabled the syncing of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings.","depth":0,"inlineStyleRanges":[],"data":{},"entityRanges":[],"key":"2eoh4","type":"unstyled"},{"inlineStyleRanges":[],"text":"Your manager has asked you to perform the following","data":{},"entityRanges":[],"type":"unstyled","key":"doc92","depth":0},{"data":{},"entityRanges":[],"inlineStyleRanges":[],"text":"Have all domain joined computers registered in Azure AD.","depth":0,"key":"f92hp","type":"unordered-list-item"},{"type":"unordered-list-item","key":"8gce","data":{},"inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"Configure Microsoft 365 to lock out any user that's currently locked out of the on-premises AD."},{"inlineStyleRanges":[],"depth":0,"type":"unstyled","data":{},"text":"What two settings will you need to configure to meet the goals listed above?","entityRanges":[],"key":"51pq4"}],"entityMap":{}},"answers":[{"value":"User sign-in settings: Password Synchronization with single-sign on","isCorrectAnswer":false},{"value":"User sign-in settings: Pass-through authentication with single-sign on","isCorrectAnswer":true},{"value":"User sign-in settings: Federation with Active Directory Federation Services (AD FS)","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"Device options: Hybrid Azure AD Join"},{"isCorrectAnswer":false,"value":"Device options: Enable Device writeback"},{"value":"Device options: Disable Device writeback","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/Fc8B7DpEP',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
