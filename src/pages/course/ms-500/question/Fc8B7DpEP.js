...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'User sign-in settings: Password Synchronization with single-sign on'}, {isCorrectAnswer: true, value: 'User sign-in settings: Pass-through authentication with single-sign on'}, {isCorrectAnswer: false, value: 'User sign-in settings: Federation with Active Directory Federation Services (AD FS)'}, {isCorrectAnswer: true, value: 'Device options: Hybrid Azure AD Join'}, {isCorrectAnswer: false, value: 'Device options: Enable Device writeback'}, {isCorrectAnswer: false, value: 'Device options: Disable Device writeback'}], canonical: 'https://www.gitbit.org/course/ms-500/test/adconnect-lg2mr5_z0/question/what-user-signin-settings-yogt2ep5x', id: 'Fc8B7DpEP', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2eoh4', text: 'Your organization has a Microsoft 365 tenant and an on-premises Active Directory (AD) domain. Your organization has installed AD Connect but hasn\'t enabled the syncing of your on-premises AD to Microsoft 365. Your organization is currently using the default authentication settings.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'doc92', text: 'Your manager has asked you to perform the following', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'f92hp', text: 'Have all domain joined computers registered in Azure AD.', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '8gce', text: 'Configure Microsoft 365 to lock out any user that\'s currently locked out of the on-premises AD.', type: 'unordered-list-item'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '51pq4', text: 'What two settings will you need to configure to meet the goals listed above?', type: 'unstyled'}], entityMap: {}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '5ipu7', text: 'To ensure that all domain-joined computers are registered to Azure AD Hybrid Azure AD Join would need to be configured.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2hgvf', text: 'To prevent users locked out of Active Directory from signing in to Azure AD and Active Directory pass-through authentication would need to be configured.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 69, offset: 0}], inlineStyleRanges: [], key: 'ho77', text: 'https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Whats-AD-Connect-ky5W0Lz5P'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
