...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"entityMap":{"0":{"type":"LINK","mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI"}},"1":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/powershell/module/sharepoint-online/set-spotenant?view=sharepoint-ps"},"mutability":"MUTABLE","type":"LINK"}},"blocks":[{"depth":0,"entityRanges":[],"key":"ds6so","inlineStyleRanges":[],"type":"unstyled","text":"You can use the SharePoint admin center > Access control page or the Set-SPOTenant PowerShell cmdlet to block or limit access to SharePoint and OneDrive content from unmanaged devices.","data":{}},{"data":{},"key":"62ne3","depth":0,"type":"unstyled","entityRanges":[{"key":0,"length":128,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI","inlineStyleRanges":[]},{"data":{},"entityRanges":[{"length":183,"key":1,"offset":0}],"type":"unstyled","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/powershell/module/sharepoint-online/set-spotenant?view=sharepoint-ps https://docs.microsoft.com/en-us/sharepoint/control-access-from-unmanaged-devices","key":"9k50n","depth":0}]},"id":"9GabW0zD3","answers":[{"value":"From the Azure AD admin center, create an Azure AD user risk policy.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, create an Azure AD conditional access policy."},{"isCorrectAnswer":true,"value":"Configure the Access control settings in the SharePoint admin center"},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, create an Azure AD sign-in risk policy."}],"question":{"entityMap":{},"blocks":[{"key":"btii1","data":{},"type":"unstyled","depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"your organization has a Microsoft 365 tenant."},{"text":"Most of your users access Microsoft SharePoint Online from unmanaged personal devices.","key":"f0q3a","data":{},"entityRanges":[],"inlineStyleRanges":[],"type":"unstyled","depth":0},{"text":"You've been tasked with preventing users from downloading, printing, and syncing files to unmanaged devices.","key":"9rcj2","data":{},"depth":0,"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled"},{"key":"705ao","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"depth":0,"text":"What should you do to fulfill the task?"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/9GabW0zD3',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
