...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"entityRanges":[],"key":"33fgs","text":"Your organization has a Microsoft 365 tenant with a primary domain of GitBit.org","data":{},"depth":0,"inlineStyleRanges":[],"type":"unstyled"},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"text":"Your organization works with a partner company named Uber Bikes. Your Microsoft OneDrive settings haven't been changed.","data":{},"key":"9sl95","type":"unstyled"},{"key":"26io4","inlineStyleRanges":[],"entityRanges":[],"depth":0,"text":"You need to allow your users to share files from Microsoft OneDrive to specific users at Uber Bikes but prevent your users from sharing files with anyone else.","data":{},"type":"unstyled"},{"entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"text":"What settings should you change in the SharePoint Online admin center?","key":"8uovg","data":{},"depth":0}],"entityMap":{}},"references":{"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off","targetOption":"_blank"},"mutability":"MUTABLE"}},"blocks":[{"data":{},"depth":0,"inlineStyleRanges":[],"key":"ahbov","type":"unstyled","entityRanges":[],"text":"By default, OneDrive files can be shared with anyone so increasing the permission level doesn't make sense."},{"data":{},"type":"unstyled","depth":0,"key":"4thd2","text":"By default, the link settings are set to \"Anyone with the link\" so they should be set to Specific people.","entityRanges":[],"inlineStyleRanges":[]},{"depth":0,"data":{},"entityRanges":[],"key":"6sb7a","type":"unstyled","inlineStyleRanges":[],"text":"By setting the OneDrive External sharing to the least permissive level users would only be able to share with users that are currently in the GitBit organization so your users wouldn't be able to share with Litware."},{"key":"b8vlr","entityRanges":[],"text":"Decreasing the permission level for OneDrive External sharing would be correct so users cannot share with anyone.","inlineStyleRanges":[],"data":{},"type":"unstyled","depth":0},{"text":"Modifying the device and sync settings wouldn't change who users can share too.","depth":0,"entityRanges":[],"data":{},"inlineStyleRanges":[],"type":"unstyled","key":"237vv"},{"depth":0,"data":{},"type":"unstyled","entityRanges":[{"length":128,"offset":0,"key":0}],"key":"1ne1r","text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI ","inlineStyleRanges":[]},{"inlineStyleRanges":[],"depth":0,"data":{},"text":"https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off ","key":"2e97s","entityRanges":[{"length":75,"offset":0,"key":1}],"type":"unstyled"}]},"id":"40e4R_WgX","answers":[{"value":"Increase the permission level for OneDrive External sharing so your users can share with users at Uber Bikes.","isCorrectAnswer":false},{"value":"Modify the Links settings.","isCorrectAnswer":true},{"value":"Decrease the permissions for OneDrive External sharing so your users can only share with users at Uber Bikes.","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Modify the Device access settings so your users cannot access OneDrive files unless they are on a managed device."},{"isCorrectAnswer":false,"value":"Modify the Sync settings so your users can't sync their files to their devices."}]},
      previousQuestionId: '',
      nextQuestionId: '',
