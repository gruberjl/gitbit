...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {question: {entityMap: {}, blocks: [{text: 'Your organization has a Microsoft 365 tenant with a primary domain of GitBit.org', entityRanges: [], type: 'unstyled', depth: 0, inlineStyleRanges: [], data: {}, key: '33fgs'}, {text: 'Your organization works with a partner company named Uber Bikes. Your Microsoft OneDrive settings haven\'t been changed.', type: 'unstyled', depth: 0, key: '9sl95', inlineStyleRanges: [], entityRanges: [], data: {}}, {data: {}, key: '26io4', text: 'You need to allow your users to share files from Microsoft OneDrive to specific users at Uber Bikes but prevent your users from sharing files with anyone else.', type: 'unstyled', inlineStyleRanges: [], entityRanges: [], depth: 0}, {key: '8uovg', depth: 0, data: {}, text: 'What settings should you change in the SharePoint Online admin center?', inlineStyleRanges: [], entityRanges: [], type: 'unstyled'}]}, id: '40e4R_WgX', answers: [{value: 'Increase the permission level for OneDrive External sharing so your users can share with users at Uber Bikes.', isCorrectAnswer: false}, {isCorrectAnswer: true, value: 'Modify the Links settings.'}, {isCorrectAnswer: true, value: 'Decrease the permissions for OneDrive External sharing so your users can only share with users at Uber Bikes.'}, {isCorrectAnswer: false, value: 'Modify the Device access settings so your users cannot access OneDrive files unless they are on a managed device.'}, {isCorrectAnswer: false, value: 'Modify the Sync settings so your users can\'t sync their files to their devices.'}], references: {entityMap: {0: {data: {url: 'https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI', targetOption: '_blank'}, type: 'LINK', mutability: 'MUTABLE'}, 1: {data: {url: 'https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off', targetOption: '_blank'}, mutability: 'MUTABLE', type: 'LINK'}}, blocks: [{entityRanges: [], data: {}, inlineStyleRanges: [], type: 'unstyled', depth: 0, text: 'By default, OneDrive files can be shared with anyone so increasing the permission level doesn\'t make sense.', key: 'ahbov'}, {text: 'By default, the link settings are set to "Anyone with the link" so they should be set to Specific people.', inlineStyleRanges: [], depth: 0, entityRanges: [], key: '4thd2', type: 'unstyled', data: {}}, {key: '6sb7a', entityRanges: [], depth: 0, inlineStyleRanges: [], type: 'unstyled', data: {}, text: 'By setting the OneDrive External sharing to the least permissive level users would only be able to share with users that are currently in the GitBit organization so your users wouldn\'t be able to share with Litware.'}, {inlineStyleRanges: [], depth: 0, key: 'b8vlr', data: {}, type: 'unstyled', entityRanges: [], text: 'Decreasing the permission level for OneDrive External sharing would be correct so users cannot share with anyone.'}, {entityRanges: [], inlineStyleRanges: [], key: '237vv', text: 'Modifying the device and sync settings wouldn\'t change who users can share too.', data: {}, depth: 0, type: 'unstyled'}, {depth: 0, entityRanges: [{offset: 0, key: 0, length: 128}], type: 'unstyled', inlineStyleRanges: [], text: 'https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI ', key: '1ne1r', data: {}}, {inlineStyleRanges: [], entityRanges: [{offset: 0, key: 1, length: 75}], text: 'https://docs.microsoft.com/en-us/sharepoint/turn-external-sharing-on-or-off ', type: 'unstyled', data: {}, depth: 0, key: '2e97s'}]}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
