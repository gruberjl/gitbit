...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"answers":[{"value":"From the Azure AD admin center, create a conditional access policy and configure the group, the cloud app, and enable app enforced restrictions","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Azure AD admin center, create a conditional access policy and configure the group, the cloud app, and set the conditions settings"},{"value":"From the Azure AD admin center, create a conditional access policy and configure the group, the conditions settings, and enable app enforced restrictions","isCorrectAnswer":false},{"value":"From PowerShell connect to Exchange Online and run New-OwaMailboxPolicy and Set-OwaMailboxPolicy","isCorrectAnswer":true},{"value":"From PowerShell connect to Exchange Online and run New-ClientAccessRule and Test-ClientAccessRule","isCorrectAnswer":false},{"value":"From PowerShell connect to Exchange Online and run Get-CASMailbox and Set-CASMailbox","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"text":"Your organization has a Microsoft 365 tenant. Your manager has asked you to set up app-enforced restrictions for 20 users so they can't download attachments unless they are on a compliant device. From the Azure AD admin center, you create a security group called GroupA.","entityRanges":[],"key":"b9tm7","type":"unstyled","inlineStyleRanges":[],"depth":0,"data":{}},{"data":{},"inlineStyleRanges":[],"depth":0,"key":"4ttei","entityRanges":[],"text":"What are the next two steps you need to take?","type":"unstyled"}]},"id":"C-zTVmrLV","references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx"},"mutability":"MUTABLE","type":"LINK"},"1":{"type":"LINK","mutability":"MUTABLE","data":{"url":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/app-based-conditional-access","targetOption":"_blank"}}},"blocks":[{"depth":0,"data":{},"text":"First, you need to create a conditional access policy that will set app-enforced restrictions in the sessions section. Then create an OWA Mailbox Policy and set the OWA Mailbox Policy. Finally, you assign the OWA Mailbox Policy to users.","inlineStyleRanges":[],"entityRanges":[],"key":"2cl7a","type":"unstyled"},{"entityRanges":[{"length":98,"key":0,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Restricting-and-managing-apps-on-user-devices-62t_7oiZx","type":"unstyled","depth":0,"data":{},"key":"8ravp","inlineStyleRanges":[]},{"entityRanges":[{"key":1,"offset":0,"length":103}],"text":"https://docs.microsoft.com/en-us/azure/active-directory/conditional-access/app-based-conditional-access","depth":0,"type":"unstyled","data":{},"inlineStyleRanges":[],"key":"70gts"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/C-zTVmrLV',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
