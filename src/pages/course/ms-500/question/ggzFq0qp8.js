...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"text":"Your organization has a Microsoft 365 tenant with a primary domain of gitbit.org","inlineStyleRanges":[],"depth":0,"data":{},"entityRanges":[],"type":"unstyled","key":"169ub"},{"inlineStyleRanges":[],"data":{},"depth":0,"key":"2gp80","entityRanges":[],"type":"unstyled","text":"The following Windows 10 devices are joined to Azure AD."},{"data":{},"entityRanges":[{"length":1,"offset":0,"key":0}],"inlineStyleRanges":[],"key":"8nh71","text":" ","type":"atomic","depth":0},{"inlineStyleRanges":[],"key":"2cuqn","depth":0,"text":"What devices can you use BitLocker to Go?","type":"unstyled","entityRanges":[],"data":{}},{"key":"d00jm","entityRanges":[],"depth":0,"inlineStyleRanges":[],"text":"What devices can you turn on auto-unlock?","data":{},"type":"unstyled"}],"entityMap":{"0":{"data":{"height":"auto","alt":"Device security chart","alignment":"left","src":"https://i.ibb.co/1fcDXhY/Device-Security-Chart2.png","width":"auto"},"mutability":"MUTABLE","type":"IMAGE"}}},"references":{"blocks":[{"data":{},"entityRanges":[],"text":"Bitlocker to Go is Bitlocker for removable media. It is possible to encrypt removable media with Intune. You don't even need TPM on the Windows device. In short, you use Intune to protect removable media and then configure Bitlocker to require a passcode.","type":"unstyled","depth":0,"key":"f7cr5","inlineStyleRanges":[]},{"type":"unstyled","entityRanges":[],"key":"bbfpm","depth":0,"data":{},"text":"Bitlocker auto-unlock is also available through Intune. Bitlocker auto-unlock will automatically unlock data drives (for example a D: drive) when the OS drive (for example a C: drive) is unlocked. Bitlocker auto-unlock does not require TPM but it does require the OS drive to be encrypted.","inlineStyleRanges":[]},{"data":{},"entityRanges":[{"length":87,"key":0,"offset":0}],"type":"unstyled","key":"705u","inlineStyleRanges":[],"depth":0,"text":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}},"answers":[{"value":"BitLocker to Go: Device1","isCorrectAnswer":true},{"value":"BitLocker to Go: Device2","isCorrectAnswer":true},{"isCorrectAnswer":true,"value":"BitLocker to Go: Device3"},{"isCorrectAnswer":true,"value":"BitLocker to Go: Device4"},{"value":"Auto-unlock: Device1","isCorrectAnswer":true},{"value":"Auto-unlock: Device2","isCorrectAnswer":false},{"value":"Auto-unlock: Device3","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Auto-unlock: Device4"}],"id":"ggzFq0qp8"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
      questionText: `Your organization has a Microsoft 365 tenant with a primary domain of gitbit.org The following Windows 10 devices are joined to Azure AD. What devices can you use BitLocker to Go? What devices can you turn on auto-unlock?`,
      referencesHtml: `<p>Bitlocker to Go is Bitlocker for removable media. It is possible to encrypt removable media with Intune. You don't even need TPM on the Windows device. In short, you use Intune to protect removable media and then configure Bitlocker to require a passcode.</p>
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/ggzFq0qp8',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
