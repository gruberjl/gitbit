...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: true, value: 'BitLocker to Go: Device1'}, {isCorrectAnswer: true, value: 'BitLocker to Go: Device2'}, {isCorrectAnswer: true, value: 'BitLocker to Go: Device3'}, {isCorrectAnswer: true, value: 'BitLocker to Go: Device4'}, {isCorrectAnswer: true, value: 'Auto-unlock: Device1'}, {isCorrectAnswer: false, value: 'Auto-unlock: Device2'}, {isCorrectAnswer: true, value: 'Auto-unlock: Device3'}, {isCorrectAnswer: false, value: 'Auto-unlock: Device4'}], canonical: 'https://www.gitbit.org/course/ms-500/test/protecting-user-devices-using-intune-bzzocmdmd/question/what-devices-can-you-turn-pwbwlx-fw', id: 'ggzFq0qp8', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '169ub', text: 'Your organization has a Microsoft 365 tenant with a primary domain of gitbit.org', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2gp80', text: 'The following Windows 10 devices are joined to Azure AD.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: '8nh71', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '2cuqn', text: 'What devices can you use BitLocker to Go?', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'd00jm', text: 'What devices can you turn on auto-unlock?', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'Device security chart', height: 'auto', src: 'https://i.ibb.co/1fcDXhY/Device-Security-Chart2.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'f7cr5', text: 'Bitlocker to Go is Bitlocker for removable media. It is possible to encrypt removable media with Intune. You don\'t even need TPM on the Windows device. In short, you use Intune to protect removable media and then configure Bitlocker to require a passcode.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'bbfpm', text: 'Bitlocker auto-unlock is also available through Intune. Bitlocker auto-unlock will automatically unlock data drives (for example a D: drive) when the OS drive (for example a C: drive) is unlocked. Bitlocker auto-unlock does not require TPM but it does require the OS drive to be encrypted.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 87, offset: 0}], inlineStyleRanges: [], key: '705u', text: 'https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/How-to-manage-devices-using-Intune-_LL9VqGZO'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
