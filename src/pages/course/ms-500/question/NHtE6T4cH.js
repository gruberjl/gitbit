...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"entityRanges":[],"inlineStyleRanges":[],"data":{},"key":"e3h3","depth":0,"text":"How to setup a DC to communicate through a member server:","type":"unstyled"},{"entityRanges":[],"data":{},"type":"unstyled","key":"q319","inlineStyleRanges":[],"text":"1. Install the standalone sensor on Server2","depth":0},{"entityRanges":[],"depth":0,"type":"unstyled","data":{},"text":"2. Setup event subscription on Server2","key":"2n2ev","inlineStyleRanges":[]},{"entityRanges":[],"data":{},"depth":0,"type":"unstyled","key":"8v1pn","text":"3. Setup port mirroring on Server1","inlineStyleRanges":[]},{"entityRanges":[{"key":0,"length":90,"offset":0}],"inlineStyleRanges":[],"key":"686d4","text":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-port-mirroring","data":{},"depth":0,"type":"unstyled"}],"entityMap":{"0":{"data":{"url":"https://docs.microsoft.com/en-us/azure-advanced-threat-protection/configure-port-mirroring","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}},"id":"NHtE6T4cH","answers":[{"isCorrectAnswer":false,"value":"Configure port mirroring for Server1."},{"isCorrectAnswer":false,"value":"Install the Microsoft Monitoring Agent on DC1."},{"isCorrectAnswer":false,"value":"Install the Microsoft Monitoring Agent on Server1."},{"value":"Configure port mirroring for DC1.","isCorrectAnswer":true}],"question":{"blocks":[{"depth":0,"text":"Your network contains an on-premises Active Directory domain. The domain contains the servers shown in the following table.","key":"8j6p0","entityRanges":[],"type":"unstyled","inlineStyleRanges":[],"data":{}},{"text":" ","data":{},"inlineStyleRanges":[],"type":"atomic","key":"blh46","depth":0,"entityRanges":[{"length":1,"offset":0,"key":0}]},{"text":"You plan to implement Defender for Identity for the domain.","inlineStyleRanges":[],"key":"b4tpj","entityRanges":[],"depth":0,"data":{},"type":"unstyled"},{"depth":0,"data":{},"key":"9a7i","inlineStyleRanges":[],"entityRanges":[],"text":"You install a Defender for Identity standalone sensor on Server1.","type":"unstyled"},{"inlineStyleRanges":[],"data":{},"key":"aqdev","depth":0,"entityRanges":[],"type":"unstyled","text":"You need to monitor the domain by using Defender for Identity."},{"depth":0,"type":"unstyled","entityRanges":[],"key":"3c5k5","text":"What should you do?","data":{},"inlineStyleRanges":[]}],"entityMap":{"0":{"mutability":"MUTABLE","type":"IMAGE","data":{"alignment":"left","width":"auto","alt":"servers chart","src":"https://i.ibb.co/0y2T0zL/servers.png","height":"auto"}}}}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/NHtE6T4cH',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
