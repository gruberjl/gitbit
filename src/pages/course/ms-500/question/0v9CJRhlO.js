...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"data":{},"entityRanges":[],"key":"7fnl0","inlineStyleRanges":[],"depth":0,"type":"unstyled","text":"A frequency of monthly allows you to set the number of days the user has to respond (between 1-30)"},{"key":"1cf04","depth":0,"data":{},"type":"unstyled","entityRanges":[],"inlineStyleRanges":[],"text":"The upon completion settings allows you to remove the permissions/role from a user if they don't respond in time."},{"text":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","data":{},"inlineStyleRanges":[],"entityRanges":[{"key":0,"offset":0,"length":94}],"depth":0,"key":"8vq2","type":"unstyled"}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/Automating-Access-Review-in-Microsoft-365-rK48f6iM2","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"}}},"question":{"entityMap":{},"blocks":[{"inlineStyleRanges":[],"data":{},"text":"Access to the Azure AD admin center by any user administrators must be reviewed once a month. The user must lose access if they don't respond within 7 days of the access request.","entityRanges":[],"key":"19r1m","type":"unstyled","depth":0},{"inlineStyleRanges":[],"text":"You create an access review policy and specify the scope and a group.","depth":0,"key":"fsnaa","entityRanges":[],"type":"unstyled","data":{}},{"depth":0,"type":"unstyled","entityRanges":[],"key":"2qg2v","data":{},"inlineStyleRanges":[],"text":"What other settings do you need to configure?"}]},"answers":[{"isCorrectAnswer":false,"value":"Set the frequency to one time"},{"isCorrectAnswer":false,"value":"Set the frequency to weekly"},{"value":"Set the frequency to monthly","isCorrectAnswer":true},{"value":"Configure the Upon completion settings to verify access is removed if the admin doesn't respond","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"Configure the Advanced settings to verify access is removed if the admin doesn't respond"},{"value":"Configure the Programs settings to verify access is removed if the admin doesn't respond","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Configure the Reviewers settings to verify access is removed if the admin doesn't respond"}],"id":"0v9CJRhlO"},
      previousQuestionId: '',
      nextQuestionId: '',
      questionId: '0v9CJRhlO',
      questionIdx: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/0v9CJRhlO',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
