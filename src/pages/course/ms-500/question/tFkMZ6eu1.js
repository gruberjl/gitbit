...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"tFkMZ6eu1","answers":[{"value":"Yes","isCorrectAnswer":true},{"value":"No","isCorrectAnswer":false}],"references":{"blocks":[{"text":"We can enable auditing at the mailbox level. We'll be using Exchange Online PowerShell.","type":"unstyled","data":{},"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"74go5"},{"data":{},"depth":0,"type":"unstyled","entityRanges":[],"text":"1. Open PowerShell and connect to Exchange Online using Connect-ExchangeOnline.","key":"2rkv1","inlineStyleRanges":[]},{"depth":0,"entityRanges":[],"inlineStyleRanges":[],"key":"2amie","type":"unstyled","data":{},"text":"2. Run the following command \"Get-Mailbox -ResultSize unlimited | Set-Mailbox -AuditEnabled $true -DefaultAuditSet Admin,Delegate,Owner\" Or for one user we can run the following \"Set-Maibox -Identity \"User1\" -AuditEnabled $true\""},{"type":"unstyled","key":"5dbc0","text":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1","inlineStyleRanges":[],"data":{},"entityRanges":[{"length":105,"key":0,"offset":0}],"depth":0},{"depth":0,"type":"unstyled","key":"f55he","inlineStyleRanges":[],"text":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","data":{},"entityRanges":[{"key":1,"offset":0,"length":88}]}],"entityMap":{"0":{"type":"LINK","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Auditing-sign-ins-and-other-actions-in-Microsoft-365-sH_Ee1DW1"},"mutability":"MUTABLE"},"1":{"type":"LINK","data":{"url":"https://docs.microsoft.com/en-us/powershell/module/exchange/set-mailbox?view=exchange-ps","targetOption":"_blank"},"mutability":"MUTABLE"}}},"question":{"blocks":[{"depth":0,"inlineStyleRanges":[],"data":{},"text":"You have a Microsoft 365 subscription.","key":"c1k37","type":"unstyled","entityRanges":[]},{"data":{},"type":"unstyled","inlineStyleRanges":[],"text":"You have a user named User1. Several users have full access to the mailbox of User1.","depth":0,"entityRanges":[],"key":"4jctk"},{"data":{},"depth":0,"text":"Some email messages sent to User1 appear to have been read and deleted before the user viewed them.","type":"unstyled","key":"3p9vn","entityRanges":[],"inlineStyleRanges":[]},{"entityRanges":[],"data":{},"type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"el88j","text":"When you search the audit log in Security & Compliance to identify who signed in to the mailbox of User1, the results are blank."},{"entityRanges":[],"key":"9pnn8","type":"unstyled","depth":0,"text":"You need to ensure that you can view future sign-ins to the mailbox of User1. You run the Set-Maibox -Identity \"User1\" -AuditEnabled $true command. Does that","inlineStyleRanges":[],"data":{}},{"entityRanges":[],"depth":0,"text":"meet the goal?","inlineStyleRanges":[],"type":"unstyled","data":{},"key":"64b9s"}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
