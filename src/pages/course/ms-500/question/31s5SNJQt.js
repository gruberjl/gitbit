...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"31s5SNJQt","question":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"text":"Your manager has asked you to create a sensitivity label. Where do you go to create the label?","depth":0,"type":"unstyled","key":"8645j","data":{}}],"entityMap":{}},"references":{"blocks":[{"inlineStyleRanges":[],"entityRanges":[],"data":{},"type":"unstyled","depth":0,"text":"You need to go to the Microsoft 365 compliance center > Information Protection > Create label. Configure your label then publish your label","key":"eo9e2"},{"text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","data":{},"depth":0,"type":"unstyled","entityRanges":[{"key":0,"length":103,"offset":0}],"key":"e436e","inlineStyleRanges":[]},{"key":"euq0m","text":"https://ior.ad/7BnF","entityRanges":[{"offset":0,"key":1,"length":19}],"type":"unstyled","data":{},"depth":0,"inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"url":"https://ior.ad/7BnF","targetOption":"_blank"}}}},"answers":[{"isCorrectAnswer":false,"value":"Open Azure AD admin center > Labels > Create a label"},{"value":"Open the Microsoft 365 Compliance admin center > Create Retention Policy Label","isCorrectAnswer":false},{"value":"Open the Microsoft 365 Compliance admin center > Information Protection > Create Label","isCorrectAnswer":true}]},
      previousQuestionId: '',
      nextQuestionId: '',
