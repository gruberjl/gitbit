...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{value: 'Compliance Manager Assessor', isCorrectAnswer: false}, {value: 'Global Administrator', isCorrectAnswer: true}, {value: 'Portal Admin', isCorrectAnswer: false}, {value: 'Compliance Manager Administrator', isCorrectAnswer: false}], question: {entityMap: {}, blocks: [{inlineStyleRanges: [], type: 'unstyled', data: {}, depth: 0, entityRanges: [], text: 'You have a Microsoft 365 subscription that contains a user named User1.', key: '55r32'}, {type: 'unstyled', inlineStyleRanges: [], key: 'cdcn4', data: {}, text: 'You plan to use Compliance Manager.', depth: 0, entityRanges: []}, {depth: 0, data: {}, key: '7dnsm', inlineStyleRanges: [], text: 'You need to ensure that User1 can assign Compliance Manager roles to users. The solution must use the principle of least privilege.', entityRanges: [], type: 'unstyled'}, {key: '6ercr', entityRanges: [], text: 'Which role should you assign to User1?', depth: 0, data: {}, type: 'unstyled', inlineStyleRanges: []}]}, references: {blocks: [{entityRanges: [], type: 'unstyled', inlineStyleRanges: [], data: {}, text: 'Compliance Manager Assessor can Create assessments, implement improvement actions, and update test status for improvement actions but they can\'t assign roles.', key: '52v6e', depth: 0}, {key: '7d54g', data: {}, inlineStyleRanges: [], entityRanges: [], text: 'Portal admin isn\'t a role in Microsoft 365 or the compliance admin center.', type: 'unstyled', depth: 0}, {entityRanges: [], key: 'co4ct', text: 'Compliance Manager administrators can manage template creation and modification but cannot assign roles.', data: {}, inlineStyleRanges: [], depth: 0, type: 'unstyled'}, {entityRanges: [], depth: 0, type: 'unstyled', text: 'Global admin is the only role listed that can assign compliance manager roles.', key: '7iklp', data: {}, inlineStyleRanges: []}, {type: 'unstyled', key: '5d67o', entityRanges: [{length: 95, offset: 0, key: 0}], data: {}, text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU ', depth: 0, inlineStyleRanges: []}, {depth: 0, text: 'https://docs.microsoft.com/en-us/microsoft-365/compliance/working-with-compliance-manager?view=o365-worldwide ', key: 'dq98i', data: {}, inlineStyleRanges: [], entityRanges: [{key: 1, length: 109, offset: 0}], type: 'unstyled'}], entityMap: {0: {type: 'LINK', data: {url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU', targetOption: '_blank'}, mutability: 'MUTABLE'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/microsoft-365/compliance/working-with-compliance-manager?view=o365-worldwide'}, type: 'LINK', mutability: 'MUTABLE'}}}, id: '4bRuCtuTK'},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
