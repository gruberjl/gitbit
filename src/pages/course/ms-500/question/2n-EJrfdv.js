...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"text":"Global admins can perform what the question is asking but wouldn't use the principle of least privilege. Data investigators can perform searches on mailboxes, SharePoint Online sites, and OneDrive for Business locations but they can't place holds on mailboxes.","data":{},"entityRanges":[],"key":"1olit","type":"unstyled","inlineStyleRanges":[],"depth":0},{"inlineStyleRanges":[],"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","entityRanges":[{"offset":0,"length":95,"key":0}],"type":"unstyled","depth":0,"key":"abr"},{"depth":0,"key":"1jdf1","data":{},"inlineStyleRanges":[],"type":"unstyled","entityRanges":[{"key":1,"length":115,"offset":0}],"text":"https://www.iorad.com/player/1801786/MS-500---ensure-that-a-user-can-perform-searches-and-place-holds-on-mailboxes- "},{"data":{},"depth":0,"type":"ordered-list-item","entityRanges":[],"key":"e2k9i","inlineStyleRanges":[],"text":"Open the security and compliance admin center"},{"depth":0,"type":"ordered-list-item","entityRanges":[],"inlineStyleRanges":[],"text":"Click Permissions","key":"6gepr","data":{}},{"type":"ordered-list-item","entityRanges":[],"data":{},"text":"Scroll down to the eDiscovery Manager role and click on it.","key":"2fhrh","inlineStyleRanges":[],"depth":0},{"type":"ordered-list-item","depth":0,"text":"Click Edit next to the eDiscovery Manager role.","entityRanges":[],"inlineStyleRanges":[],"key":"85enr","data":{}},{"depth":0,"inlineStyleRanges":[],"text":"Click Choose eDiscovery Manager.","entityRanges":[],"key":"buq8g","type":"ordered-list-item","data":{}},{"type":"ordered-list-item","text":"Click Add. Add Jo Gruber the role.","data":{},"key":"96amj","entityRanges":[],"depth":0,"inlineStyleRanges":[]},{"depth":0,"inlineStyleRanges":[],"type":"ordered-list-item","text":"Click Done then Save then Close.","entityRanges":[],"data":{},"key":"3s761"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"},"type":"LINK"},"1":{"mutability":"MUTABLE","data":{"targetOption":"_blank","url":"https://www.iorad.com/player/1801786/MS-500---ensure-that-a-user-can-perform-searches-and-place-holds-on-mailboxes-"},"type":"LINK"}}},"id":"2n-EJrfdv","answers":[{"value":"From the Security and compliance admin center grant the user eDiscovery Manager role","isCorrectAnswer":true},{"isCorrectAnswer":false,"value":"From the Security and compliance admin center grant the user Data Investigator role"},{"value":"From the Microsoft 365 admin center grant the user global admin permissions","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"depth":0,"key":"e6u20","entityRanges":[],"text":"You need to ensure that a user named Joe Gruber can perform searches and place holds on mailboxes, SharePoint Online sites, and OneDrive for Business locations. The solution must use the principle of least privilege.","data":{}},{"entityRanges":[],"type":"unstyled","depth":0,"data":{},"key":"vvka","inlineStyleRanges":[{"offset":0,"style":"color-rgb(33,37,41)","length":48},{"length":48,"style":"bgcolor-rgb(255,255,255)","offset":0},{"length":48,"offset":0,"style":"fontsize-16"},{"length":48,"style":"fontfamily-system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji","offset":0}],"text":"What steps should you take to complete the task?"}]}},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/2n-EJrfdv',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
