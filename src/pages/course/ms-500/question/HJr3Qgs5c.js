...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"id":"HJr3Qgs5c","references":{"blocks":[{"key":"nlin","inlineStyleRanges":[],"text":"External users can open emails labeled with encryption and content expiration. The issue is caused by the external sharing settings or assigned permissions.","entityRanges":[],"type":"unstyled","data":{},"depth":0},{"key":"813nb","depth":0,"entityRanges":[{"key":0,"length":103,"offset":0}],"type":"unstyled","data":{},"text":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","inlineStyleRanges":[]}],"entityMap":{"0":{"data":{"url":"https://www.gitbit.org/course/ms-500/learn/How-to-classify-data-using-labels-in-Microsoft-365-vLweLmxZf","targetOption":"_blank"},"mutability":"MUTABLE","type":"LINK"}}},"answers":[{"value":"The encryption settings of the label.","isCorrectAnswer":false},{"isCorrectAnswer":true,"value":"The external sharing settings and the assigned permissions of the label"},{"value":"The content expiration settings of the label.","isCorrectAnswer":false}],"question":{"blocks":[{"data":{},"entityRanges":[],"depth":0,"type":"unstyled","text":"Your organization has a Microsoft 365 tenant. Your tenant has an information protection label named CompanyConfidential in the Microsoft Compliance admin center. Your tenant has CompanyConfidential applied to a global policy.","inlineStyleRanges":[],"key":"545n4"},{"text":"One of your users protects an email using the CompanyConfidential label and sends the email to an external recipient. The external recipient reports that they cannot open the email.","depth":0,"data":{},"inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","key":"7ct7p"},{"key":"a01v5","inlineStyleRanges":[],"type":"unstyled","depth":0,"text":"You've been asked to assist the user so the email can be sent to the external recipient. What should you do?","data":{},"entityRanges":[]}],"entityMap":{}}},
      previousQuestionId: '',
      nextQuestionId: '',
