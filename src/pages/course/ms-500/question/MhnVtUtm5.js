...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"question":{"blocks":[{"text":"Your organization has Microsoft 365 tenant with Microsoft 365 E5 licenses. The tenant contains the following users.","key":"cosd7","inlineStyleRanges":[],"type":"unstyled","data":{},"entityRanges":[],"depth":0},{"type":"atomic","text":" ","key":"377ga","data":{},"inlineStyleRanges":[],"entityRanges":[{"length":1,"offset":0,"key":0}],"depth":0},{"depth":0,"inlineStyleRanges":[],"text":"Your manager has asked you which admins can enable Microsoft Defender for Endpoint roles.","data":{},"key":"186in","type":"unstyled","entityRanges":[]},{"depth":0,"inlineStyleRanges":[],"key":"cb1f","data":{},"entityRanges":[],"text":"Click the check box next to each user that can enable Microsoft Defender for Endpoint roles.","type":"unstyled"}],"entityMap":{"0":{"mutability":"MUTABLE","data":{"alt":"Users Roles Chart","width":"auto","height":"auto","alignment":"left","src":"https://i.ibb.co/6mjYxD7/users-roles.png"},"type":"IMAGE"}}},"references":{"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU"},"type":"LINK","mutability":"MUTABLE"},"1":{"mutability":"MUTABLE","type":"LINK","data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/rbac"}}},"blocks":[{"type":"unstyled","inlineStyleRanges":[],"text":"The security administrator role gives any user assigned the role the ability to manage Microsoft Defender for Endpoint roles.","entityRanges":[],"depth":0,"key":"43u18","data":{}},{"type":"unstyled","depth":0,"data":{},"text":"https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU","entityRanges":[{"key":0,"length":95,"offset":0}],"key":"7j6g","inlineStyleRanges":[]},{"text":"https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/rbac","entityRanges":[{"length":95,"offset":0,"key":1}],"data":{},"inlineStyleRanges":[],"key":"1cv0j","depth":0,"type":"unstyled"}]},"id":"MhnVtUtm5","answers":[{"value":"User1","isCorrectAnswer":false},{"value":"User2","isCorrectAnswer":true},{"value":"User3","isCorrectAnswer":false},{"value":"User4","isCorrectAnswer":false}]},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/MhnVtUtm5',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
