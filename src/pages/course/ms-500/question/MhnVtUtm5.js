...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      question: {answers: [{isCorrectAnswer: false, value: 'User1'}, {isCorrectAnswer: true, value: 'User2'}, {isCorrectAnswer: false, value: 'User3'}, {isCorrectAnswer: false, value: 'User4'}], canonical: 'https://www.gitbit.org/course/ms-500/test/control-permissions-and-access-through-admin-roles-j9ggabtua/question/which-admins-can-enable-m-25rsnfs6i', id: 'MhnVtUtm5', question: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'cosd7', text: 'Your organization has Microsoft 365 tenant with Microsoft 365 E5 licenses. The tenant contains the following users.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 1, offset: 0}], inlineStyleRanges: [], key: '377ga', text: ' ', type: 'atomic'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '186in', text: 'Your manager has asked you which admins can enable Microsoft Defender for Endpoint roles.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: 'cb1f', text: 'Click the check box next to each user that can enable Microsoft Defender for Endpoint roles.', type: 'unstyled'}], entityMap: {0: {data: {alignment: 'left', alt: 'Users Roles Chart', height: 'auto', src: 'https://i.ibb.co/6mjYxD7/users-roles.png', width: 'auto'}, mutability: 'MUTABLE', type: 'IMAGE'}}}, references: {blocks: [{data: {}, depth: 0, entityRanges: [], inlineStyleRanges: [], key: '43u18', text: 'The security administrator role gives any user assigned the role the ability to manage Microsoft Defender for Endpoint roles.', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 0, length: 95, offset: 0}], inlineStyleRanges: [], key: '7j6g', text: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU', type: 'unstyled'}, {data: {}, depth: 0, entityRanges: [{key: 1, length: 95, offset: 0}], inlineStyleRanges: [], key: '1cv0j', text: 'https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/rbac', type: 'unstyled'}], entityMap: {0: {data: {targetOption: '_blank', url: 'https://www.gitbit.org/course/ms-500/learn/Creating-and-managing-admins-through-roles-7CpqFkPZU'}, mutability: 'MUTABLE', type: 'LINK'}, 1: {data: {targetOption: '_blank', url: 'https://docs.microsoft.com/en-us/windows/security/threat-protection/microsoft-defender-atp/rbac'}, mutability: 'MUTABLE', type: 'LINK'}}}},
      previousQuestionId: '',
      nextQuestionId: '',
      questionIdx: 0,
