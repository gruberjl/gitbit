...
class EditQuestionPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      test: {},
      question: {"references":{"blocks":[{"key":"82p5v","data":{},"entityRanges":[],"text":"Connect to Sharepoint Online using PowerShell then run the following command: Set-SPOTenant -ConditionalAccessPolicy AllowLimitedAccess.","type":"unstyled","inlineStyleRanges":[],"depth":0},{"entityRanges":[{"key":0,"length":128,"offset":0}],"text":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI","type":"unstyled","key":"e64f5","depth":0,"data":{},"inlineStyleRanges":[]},{"key":"fsm5k","type":"unstyled","entityRanges":[{"key":1,"offset":0,"length":101}],"text":"https://docs.microsoft.com/en-us/powershell/module/sharepoint-online/set-spotenant?view=sharepoint-ps","depth":0,"data":{},"inlineStyleRanges":[]},{"depth":0,"entityRanges":[{"offset":0,"key":2,"length":81}],"data":{},"text":"https://docs.microsoft.com/en-us/sharepoint/control-access-from-unmanaged-devices","inlineStyleRanges":[],"key":"7n076","type":"unstyled"}],"entityMap":{"0":{"data":{"targetOption":"_blank","url":"https://www.gitbit.org/course/ms-500/learn/Everything-you-need-to-know-about-securing-SharePoint-Online-for-the-MS-500-wv2PbXnhI"},"type":"LINK","mutability":"MUTABLE"},"1":{"data":{"url":"https://docs.microsoft.com/en-us/powershell/module/sharepoint-online/set-spotenant?view=sharepoint-ps","targetOption":"_blank"},"type":"LINK","mutability":"MUTABLE"},"2":{"data":{"targetOption":"_blank","url":"https://docs.microsoft.com/en-us/sharepoint/control-access-from-unmanaged-devices"},"type":"LINK","mutability":"MUTABLE"}}},"answers":[{"isCorrectAnswer":true,"value":"Run the Set-SPOTenant cmdlet and specify the -ConditionalAccessPolicy parameter from the SharePoint Online PowerShell."},{"value":"Open the SharePoint admin center and configure the secure control settings.","isCorrectAnswer":false},{"isCorrectAnswer":false,"value":"Open the Microsoft Azure AD admin center and create an Azure AD Identity Protection sign-in risk policy."},{"value":"Open the Microsoft Azure AD admin center and create an Azure AD Identity Protection user risk policy.","isCorrectAnswer":false}],"question":{"entityMap":{},"blocks":[{"entityRanges":[],"key":"4l16","type":"unstyled","inlineStyleRanges":[],"data":{},"text":"Your organization has a Microsoft 365 tenant. Some users access Microsoft SharePoint Online from unmanaged personal devices.","depth":0},{"type":"unstyled","entityRanges":[],"data":{},"key":"c9bo6","text":"Your manager has asked you to prevent the users from downloading, printing, and syncing files from their unmanaged personal devices.","depth":0,"inlineStyleRanges":[]},{"text":"What do you need to do?","inlineStyleRanges":[],"entityRanges":[],"type":"unstyled","depth":0,"key":"9cofa","data":{}}]},"id":"i_VGw0WJG"},
      previousQuestionId: '',
      nextQuestionId: '',
...
`,
    ...
    if (this.state.question.answers) {
      this.state.jsonLd.mainEntity.acceptedAnswer = {
        ...
        url: 'https://www.gitbit.org/course/ms-500/question/i_VGw0WJG',
        author: {
          type: 'Person',
          name: 'John Gruber',
          url: 'https://medium.com/@gruberjl'
