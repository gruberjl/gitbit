        ...
        <div style={secondaryLanding}>
          <Container>
            ...
            <Grid container rowSpacing={2}>
              ...
              <Grid item md={6} container className='margin12 flex'><Grid item xs={1}><Check color="success" fontSize="large"/></Grid><Grid item xs={11}><Typography variant="h5" component="h3">How to classify data using labele.</Typography></Grid></Grid>
