...
const IndexPage = () => {
  ...
  return (
    <Page jsonLdType={'Course'} jsonLd={jsonLd} image={certImg} canonical={'https://www.gitbit.org'} title={'Training for Microsoft 365 Security Administration certificate (MS-500)'} description={'Get Certified in MS-500 Microsoft 365 Security Administration'} footerMargin='0px'>
      <main>
        ...
        <div style={secondaryLanding}>
          <Container style={margin100}>
            ...
            <Grid container rowSpacing={2}>
              ...
              <Grid item md={6} container className='margin12 flex'><Grid item xs={1}><Check color="success" fontSize="large" /></Grid><Grid item xs={11}><Typography variant="h5" component="h3">Creating and managing admin roles including time-limited admin roles.</Typography></Grid></Grid>
